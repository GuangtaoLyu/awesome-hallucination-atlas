...
>
> Taxonomy is auto-labeled from the **full arXiv abstract text** (1487/2054 papers), not just title keywords.

<p align='center'>
  <img src='https://img.shields.io/badge/Papers-2054-blue' />
  <img src='https://img.shields.io/badge/Abstract--based-1487-9cf' />
...
<a id="sec-overview"></a>
## 📊 Data Overview
- **Total papers**：`2054` (deduplicated)
- **With paper link**：`2051` · **With abstract**：`1487` · **With code**：`1109` · **Published at venue**：`1007`
...
|----------|------|------|
| **VLM** | Vision-Language Model (LVLM; also covers works that call themselves MLLM but handle only image/video + text) | 781 |
| **MLLM(Omni)** | Omni / full-modal model (audio / speech / any-to-any) | 58 |
| **LLM** | Pure text-based LLM | 1215 |
...
|----------|------|------|
| **Training-free** | Training-free (decoding intervention / attention calibration / representation guidance, etc.) | 1791 |
| **Training-based** | Training-based (preference optimization / fine-tuning / RL, etc.) | 263 |
...
| TNNLS | 1 | `░░░░░░░░░░░░░░░░░░░░` 0.0%
| Other | 233 | `██░░░░░░░░░░░░░░░░░░` 11.3%
| arXiv (preprint) | 1017 | `██████████░░░░░░░░░░` 49.5%
| Unlabeled | 12 | `░░░░░░░░░░░░░░░░░░░░` 0.6%

<details>
<summary>“Other” details (159 venues, 233 papers — click to expand)</summary>
...
- **Agentic AI / Multi-Agent** — 127 papers tagged `Agent`.
- **RAG / Faithfulness** — 168 papers tagged `RAG`.
- **Reasoning Models** — 392 papers tagged `Reasoning`.
...
- **📋 [HoloCount: A Holistic Visual Counting Benchmark for MLLMs](https://arxiv.org/abs/2607.06420)** · arXiv · VLM · Training-free · 💻[code](https://github.com/MM-MVR/HoloCount)
...
- **📋 [Rethinking Evaluation for LLM Hallucination Detection: A Desiderata, A New RAG-based Benchmark, New Insights](https://aclanthology.org/2026.acl-long.680/)** · ACL 2026 · LLM · Training-free · 💻[code](https://github.com/Wenbo11/TriviaPlus)
- **📋 [PROBE: PROcess-Based BEnchmark for Hallucination Detection](https://aclanthology.org/2026.findings-acl.2099/)** · ACL 2026 · LLM · Training-free · 💻[code](https://github.com/probe-rs/probe-rs)
- **📋 [INFACT: A Diagnostic Benchmark for Induced Faithfulness and Factuality Hallucinations in Video-LLMs](https://aclanthology.org/2026.acl-long.2062/)** · ACL 2026 · VLM · Training-free · 💻[code](https://github.com/yangjunqi1217/INFACT)
...
- **📋 [Born Pragmatic, Trained to Hallucinate? Quantifying the Origins of Contextual Bias in LLMs via the PaCE Benchmark](https://doi.org/10.18653/v1/2026.findings-acl.959)** · ACL 2026 · LLM · Training-based · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **📋 [How Far Can You Get Without a GPU? A Systematic Benchmark of Lightweight Hallucination Detection Across Question Answering, Dialogue, and Summarisation](https://arxiv.org/abs/2606.29809)** · arXiv · LLM · Training-free · 💻[code](https://github.com/fkriti/hallucination-detection-nli)
...
- **📋 [HALAS: A Human-Annotated Dataset of Hallucinations of Modern ASR Systems](https://arxiv.org/abs/2606.23048)** · arXiv · MLLM(Omni) · Training-free · 💻[code](https://github.com/DSP-AGH/HALAS)
- **📋 [SAGE: An Expert-Annotated South Asian GI Endoscopy Dataset for Multimodal Learning and Hallucination Analysis](https://arxiv.org/abs/2606.22144)** · arXiv · VLM · Training-free · 💻[code](https://github.com/roots/sage)
- **📋 [MedHal-Loc: Are "Explainable-by-Architecture" Medical Hallucination Detectors Faithful Localizers? A Localization Benchmark](https://arxiv.org/abs/2606.21517)** · arXiv · LLM · Training-free · 💻[code](https://github.com/green-leo-1/MedHal-Loc)
- **📋 [ClinHallu: A Benchmark for Diagnosing Stage-Wise Hallucinations in Medical MLLM Reasoning](https://arxiv.org/abs/2606.14697)** · arXiv · VLM · Training-free · 💻[code](https://github.com/alibaba-damo-academy/ClinHallu)
...
- **📋 [ReactBench: A Cause-Driven Benchmark for Multimodal Hallucination via Systematic Evaluation](https://arxiv.org/abs/2605.29579)** · arXiv · VLM · Training-free · 💻[code](https://github.com/millionco/reactbench)
- **📋 [HalluWorld: A Controlled Benchmark for Hallucination via Reference World Models](https://arxiv.org/abs/2605.19341)** · arXiv · LLM · Training-free · 💻[code](https://github.com/DegenAI-Labs/HalluWorld)
- **📋 [PARALLAX: Separating Genuine Hallucination Detection from Benchmark Construction Artifacts](https://arxiv.org/abs/2605.17028)** · arXiv · LLM · Training-free · 💻[code](https://github.com/wagerfield/parallax)
- **📋 [HalluScore: Large Language Model Hallucination Question Answering Benchmark](https://arxiv.org/abs/2605.17007)** · arXiv · LLM · Training-free · 💻[code](https://github.com/aishaalansari57/HalluScore)
...
- **📋 [Delulu: A Verified Multi-Lingual Benchmark for Code Hallucination Detection in Fill-in-the-Middle Tasks](https://arxiv.org/abs/2605.07024)** · arXiv · LLM · Training-free · 💻[code](https://github.com/microsoft/delulu)
...
- **📋 [A multilingual hallucination benchmark: MultiWikiQHalluA](https://arxiv.org/abs/2605.02504)** · arXiv · LLM · Training-based
...
- **📋 [DHEval: A Dynamic Hallucination Evaluation Protocol Robust to Data Contamination](https://doi.org/10.1109/icassp55912.2026.11462032)** · ICASSP 2026 · LLM · Training-free · 💻[code](https://github.com/spmede/DHEval)
- **📋 [FREAK: A Fine-grained Hallucination Evaluation Benchmark for Advanced MLLMs](https://arxiv.org/abs/2603.19765)** · arXiv · VLM · Training-free · 💻[code](https://github.com/kikohs/freak)
- **📋 [HalDec-Bench: Benchmarking Hallucination Detector in Image Captioning](https://arxiv.org/abs/2603.15253)** · arXiv · VLM · Training-free · 💻[code](https://github.com/dahlian00/HalDec-Bench-Page)
- **📋 [FinReflectKG -- HalluBench: GraphRAG Hallucination Benchmark for Financial Question Answering Systems](https://arxiv.org/abs/2603.20252)** · arXiv · LLM · Training-based
- **📋 [Multi-Hall-SA: A Cross-lingual Benchmark for Multi-Type Hallucination Detection in Low-Resource South African Languages](https://doi.org/10.18653/v1/2026.findings-eacl.330)** · EACL 2026 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **📋 [KGHaluBench: A Knowledge Graph-Based Hallucination Benchmark for Evaluating the Breadth and Depth of LLM Knowledge](https://doi.org/10.18653/v1/2026.findings-eacl.206)** · EACL 2026 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **📋 [GHOST: Getting to the Bottom of Hallucinations with A Multi-round Consistency Benchmark](https://doi.org/10.1109/WACV61042.2026.00596)** · WACV 2026 · LLM · Training-free · 💻[code](https://github.com/TryGhost/Ghost)
- **📋 [FFE-Hallu: Hallucinations in Fixed Figurative Expressions: A Benchmark of Idioms and Proverbs in the Persian Language](https://doi.org/10.18653/v1/2026.eacl-long.241)** · EACL 2026 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **📋 [Constructing a Dataset for Hallucination Detection in Japanese Summarization with Fine-grained Faithfulness Labels](https://doi.org/10.18653/v1/2026.eacl-srw.15)** · EACL 2026 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **📋 [ManiBench: A Benchmark for Testing Visual-Logic Drift and Syntactic Hallucinations in Manim Code Generation](https://arxiv.org/abs/2603.13251)** · arXiv · VLM · Training-free · 💻[code](https://github.com/nabin2004/ManiBench)
...
- **📋 [HalluHard: A Hard Multi-Turn Hallucination Benchmark](https://arxiv.org/abs/2602.01031)** · arXiv · LLM · Training-free · 💻[code](https://github.com/fan1dy/halluhard)
...
- **📋 [SHALE: A Scalable Benchmark for Fine-grained Hallucination Evaluation in LVLMs](https://doi.org/10.1145/3746027.3758308)** · ACM MM 2025 · VLM · Training-free · 💻[code](https://github.com/kgiszczak/shale)
- **📋 [MIHBench: Benchmarking and Mitigating Multi-Image Hallucinations in Multimodal Large Language Models](https://doi.org/10.1145/3746027.3754993)** · ACM MM 2025 · VLM · Training-free · 💻[code](https://github.com/dhzhang41-tech/MIHBench-DAB-reproduction)
...
- **📋 [MIRAGE-Bench: LLM Agent is Hallucinating and Where to Find Them](https://arxiv.org/abs/2507.21017)** · arXiv · LLM · Training-free · 💻[code](https://github.com/sunblaze-ucb/mirage-bench)
- **📋 [TreeCut: A Synthetic Unanswerable Math Word Problem Dataset for LLM Hallucination Evaluation](https://doi.org/10.18653/v1/2025.acl-short.84)** · ACL 2025 · LLM · Training-free · 💻[code](https://github.com/j-bagel/treecut-math)
- **📋 [Reefknot: A Comprehensive Benchmark for Relation Hallucination Evaluation, Analysis and Mitigation in Multimodal Large Language Models](https://doi.org/10.18653/v1/2025.findings-acl.322)** · ACL 2025 · VLM · Training-free · 💻[code](https://github.com/JackChen-seu/Reefknot)
- **📋 [HalluLens: LLM Hallucination Benchmark](https://doi.org/10.18653/v1/2025.acl-long.1176)** · ACL 2025 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **📋 [CCHall: A Novel Benchmark for Joint Cross-Lingual and Cross-Modal Hallucinations Detection in Large Language Models](https://doi.org/10.18653/v1/2025.acl-long.1485)** · ACL 2025 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **📋 [PhD: A ChatGPT-Prompted Visual Hallucination Evaluation Dataset](https://openaccess.thecvf.com/content/CVPR2025/html/Liu_PhD_A_ChatGPT-Prompted_Visual_Hallucination_Evaluation_Dataset_CVPR_2025_paper.html)** · CVPR 2025 · VLM · Training-free · 💻[code](https://github.com/GoogleCloudPlatform/tensorflow-without-a-phd)
- **📋 [How LLMs React to Industrial Spatio-Temporal Data? Assessing Hallucination with a Novel Traffic Incident Benchmark Dataset](https://doi.org/10.18653/v1/2025.naacl-industry.4)** · NAACL 2025 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
...
- **📋 [MultiHal: Multilingual Dataset for Knowledge-Graph Grounded Evaluation of LLM Hallucinations](https://arxiv.org/abs/2505.14101)** · arXiv · LLM · Training-free · 💻[code](https://github.com/ernlavr/multihal)
- **📋 [HalluMix: A Task-Agnostic, Multi-Domain Benchmark for Real-World Hallucination Detection](https://arxiv.org/abs/2505.00506)** · arXiv · LLM · Training-free · 💻[code](https://github.com/intoexistence/RAG-Hallumix)
...
- **📋 [MedHal: An Evaluation Dataset for Medical Hallucination Detection](https://arxiv.org/abs/2504.08596)** · arXiv · LLM · Training-free · 💻[code](https://github.com/green-leo-1/MedHal-Loc)
- **📋 [How to Detect and Defeat Molecular Mirage: A Metric-Driven Benchmark for Hallucination in LLM-based Molecular Comprehension](https://arxiv.org/abs/2504.12314)** · arXiv · LLM · Training-free · 💻[code](https://github.com/XuzhaoLi/ro-arxiv-daily)
...
- **📋 [AVHBench: A Cross-Modal Hallucination Benchmark for Audio-Visual Large Language Models](https://openreview.net/forum?id=jTEKTdI3K9)** · ICLR 2025 · MLLM(Omni) · Training-free · 💻[code](https://github.com/kaist-ami/AVHBench)
...
- **📋 [MedHallTune: An Instruction-Tuning Benchmark for Mitigating Medical Hallucination in Vision-Language Models](https://doi.org/10.1109/tmi.2026.3719326)** · Other · VLM · Training-free · 💻[code](https://github.com/russellyq/MedHallTune)
...
- **📋 [C-FAITH: A Chinese Fine-Grained Benchmark for Automated Hallucination Evaluation](https://doi.org/10.1145/3746252.3761604)** · CIKM 2025 · LLM · Training-free · 💻[code](https://github.com/liuliu115621/Test-for-data-loss)
- **📋 [The HalluRAG Dataset: Detecting Closed-Domain Hallucinations in RAG Applications Using an LLM's Internal States](https://arxiv.org/abs/2412.17056)** · arXiv · LLM · Training-based · 💻[code](https://github.com/F4biian/HalluRAG)
...
- **📋 [ViBe: A Text-to-Video Benchmark for Evaluating Hallucination in Large Multimodal Models](https://arxiv.org/abs/2411.10867)** · arXiv · VLM · Training-free · 💻[code](https://github.com/mkocabas/VIBE)
- **📋 [DAHL: Domain-specific Automated Hallucination Evaluation of Long-Form Text through a Benchmark Dataset in Biomedicine](https://arxiv.org/abs/2411.09255)** · arXiv · LLM · Training-free · 💻[code](https://github.com/rldv1/dahl)
...
- **📋 [Collu-Bench: A Benchmark for Predicting Language Model Hallucinations in Code](https://arxiv.org/abs/2410.09997)** · arXiv · VLM · Training-free · 💻[code](https://github.com/PavlovaElina/collu-bench_pipeline)
- **📋 [HaloQuest: A Visual Hallucination Dataset for Advancing Multimodal Reasoning](https://doi.org/10.1007/978-3-031-72980-5_17)** · ECCV 2024 · VLM · Training-free · 💻[code](https://github.com/ZhecanJamesWang/HaloQuest)
- **📋 [Order Matters in Hallucination: Reasoning Order as Benchmark and Reflexive Prompting for Large-Language-Models](https://arxiv.org/abs/2408.05093)** · arXiv · LLM · Training-free · 💻[code](https://github.com/XieZikai/ReflexivePrompting)
- **📋 [DefAn: Definitive Answer Dataset for LLMs Hallucination Evaluation](https://arxiv.org/abs/2406.09155)** · arXiv · LLM · Training-free · 💻[code](https://github.com/ashikiut/DefAn)
- **📋 [HalluDial: A Large-Scale Benchmark for Automatic Dialogue-Level Hallucination Evaluation](https://arxiv.org/abs/2406.07070)** · arXiv · LLM · Training-free · 💻[code](https://github.com/FlagOpen/HalluDial)
- **📋 [THRONE: An Object-Based Hallucination Benchmark for the Free-Form Generations of Large Vision-Language Models](https://doi.org/10.1109/CVPR52733.2024.02571)** · CVPR 2024 · VLM · Training-free · 💻[code](https://github.com/throneproj/Throne)
- **📋 [RefChecker: Reference-based Fine-grained Hallucination Checker and Benchmark for Large Language Models](https://arxiv.org/abs/2405.14486)** · arXiv · LLM · Training-free · 💻[code](https://github.com/amazon-science/RefChecker)
...
- **📋 [HypoTermQA: Hypothetical Terms Dataset for Benchmarking Hallucination Tendency of LLMs](https://doi.org/10.18653/v1/2024.eacl-srw.9)** · EACL 2024 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
...
## 📚 Surveys
> 35 survey / review / taxonomy papers are listed separately (also kept in the main list below, marked 📚).

<details open>
<summary>📚 Survey List (35 papers — click to collapse / expand)</summary>
...
- **📚 [Hallucination Detection, Verification, and Correction in Generative AI: A Comprehensive Survey](https://doi.org/10.1016/j.nlp.2026.100231)** · Other · LLM · Training-free
...
- **📚 [Mitigating Hallucination in Large Language Models (LLMs): An Application-Oriented Survey on RAG, Reasoning, and Agentic Systems](https://arxiv.org/abs/2510.24476)** · arXiv · LLM · Training-free · 💻[code](https://github.com/ovxncdev/llm-hallucination-normalization)
- **📚 [Review of Hallucination Understanding in Large Language and Vision Models](https://arxiv.org/abs/2510.00034)** · arXiv · VLM · Training-free
- **📚 [LLM-based Agents Suffer from Hallucinations: A Survey of Taxonomy, Methods, and Directions](https://arxiv.org/abs/2509.18970)** · arXiv · LLM · Training-free · 💻[code](https://github.com/nans6/agent-evals)
- **📚 [A comprehensive taxonomy of hallucinations in Large Language Models](https://arxiv.org/abs/2508.01781)** · arXiv · VLM · Training-free
...
- **📚 [Hallucination Detection in Foundation Models for Decision-Making: A Flexible Definition and Review of the State of the Art](https://doi.org/10.1145/3716846)** · ACM Comput. Surv. 2025 · LLM · Training-based
...
- **📚 [A Survey of Hallucination in Large Visual Language Models](https://arxiv.org/abs/2410.15359)** · arXiv · VLM · Training-free · 💻[code](https://github.com/rolandosegundo/tv2)
...
- **📚 [Hallucination of Multimodal Large Language Models: A Survey](https://arxiv.org/abs/2404.18930)** · arXiv · VLM · Training-free · 💻[code](https://github.com/showlab/Awesome-MLLM-Hallucination)
- **📚 [A Survey of Automatic Hallucination Evaluation on Natural Language Generation](https://arxiv.org/abs/2404.12041)** · arXiv · LLM · Training-free · 💻[code](https://github.com/KNZLink/KNZLink)
...
<details>
<summary>📅 2026 · 478 papers</summary>

- **📋 [LexAgentHallu: A Hierarchical Benchmark for Profiling Hallucinations in Legal Agents](https://arxiv.org/abs/2609.09754)** · EMNLP 2026 · LLM · Training-free · 💻[code](https://github.com/TOM-ZHOUch/LexAgentHallu)
- **[Closed-World Resolution Against Tool Hallucination in LLM Agents](https://arxiv.org/abs/2609.19425)** · arXiv · LLM · Training-free
- **[Attention Dispersion as a Diagnostic Signal for Hallucination in Large Language Models](https://arxiv.org/abs/2609.18320)** · arXiv · LLM · Training-free
...
- **[NeuroActiSep: Detecting Factual Hallucinations from Feed-Forward Neurons in a Single Pass](https://arxiv.org/abs/2609.14448)** · arXiv · LLM · Training-based · 💻[code](https://github.com/alidrgr/NeuroActiSep)
...
- **[When Rubrics Fail: Hallucinations Reveal Blind Spots in Medical AI Evaluation](https://arxiv.org/abs/2609.12718)** · arXiv · LLM · Training-free · 💻[code](https://github.com/FJFehr/when-rubrics-fail)
...
- **[Leveraging Low-Level Symbolic Competences for Unsupervised Grounding in Hallucination Detection](https://arxiv.org/abs/2609.05025)** · arXiv · LLM · Training-free · 💻[code](https://github.com/getquoteonline/SkyhighParts.com-Premier-Aviation-NSN-Component-Supplier)
...
- **[Mixture-of-Expert Blocks Contain Strong Hallucination Detection Signals](https://arxiv.org/abs/2608.17687)** · arXiv · LLM · Training-based · 💻[code](https://github.com/joaopfonseca/InnerExpert-Hallucination-Detection)
...
- **[AutoResearch: Insight In, Hallucination Out](https://arxiv.org/abs/2608.17906)** · arXiv · LLM · Training-free · 💻[code](https://github.com/leo-lilinxiao/codex-autoresearch)
- **[HalluTracer: Hallucination Detection via Depth-Averaging Truth Signals](https://arxiv.org/abs/2608.16353)** · arXiv · LLM · Training-free · 💻[code](https://github.com/liutaocode/TTS-arxiv-daily)
- **[Hallucination Span Detection with Input-Side Evidence Alignment](https://arxiv.org/abs/2608.15804)** · arXiv · LLM · Training-free · 💻[code](https://github.com/miyu-y/HalluSpan_EviAlign)
...
- **[Do LLM Recommenders Know When They're Hallucinating? Auditing Confidence Calibration in Catalog Faithfulness](https://arxiv.org/abs/2608.10008)** · arXiv · LLM · Training-free
...
- **[Eliciting Intrinsic Hallucinations in LLMs via Semantically Equivalent Adversarial Attacks](https://arxiv.org/abs/2608.04286)** · arXiv · LLM · Training-based · 💻[code](https://github.com/atriviveksharma/intrinsic_hall)
...
- **[Confidently Wrong: Detecting Hallucinations in Financial Question Answering from LLM Internal States](https://arxiv.org/abs/2607.11414)** · arXiv · LLM · Training-based · 💻[code](https://github.com/liuzhen9320/zstar)
- **[To Answer or to Abstain: Mitigating Search-Agent Hallucinations via Abstention-Aware Reinforcement Learning](https://arxiv.org/abs/2607.10738)** · arXiv · LLM · Training-based · 💻[code](https://github.com/zfj1998/AWA-RL)
...
- **[The Reasoning Trap: How Enhancing LLM Reasoning Amplifies Tool Hallucination](https://aclanthology.org/2026.acl-long.376/)** · ACL 2026 · LLM · Training-free · 💻[code](https://github.com/albert-y1n/Reasoning_Trap)
...
- **[Stable-RAG: Mitigating Retrieval-Permutation-Induced Hallucinations in Retrieval-Augmented Generation](https://aclanthology.org/2026.acl-long.1188/)** · ACL 2026 · LLM · Training-free · 💻[code](https://github.com/zqc1023/Stable-RAG)
...
- **[ReFL: Reflective Feedback Learning for Hallucination Detection of Large Language Models](https://aclanthology.org/2026.acl-long.899/)** · ACL 2026 · LLM · Training-free · 💻[code](https://github.com/veselink1/refl-cpp)
- **[RLSeek: Evidence-Grounded Reasoning for RAG Hallucination Detection](https://aclanthology.org/2026.acl-long.1492/)** · ACL 2026 · LLM · Training-based · 💻[code](https://github.com/WaldenRUC/RLSeek)
...
- **[PretrainRL: Alleviating Factuality Hallucination of Large Language Models at the Beginning](https://aclanthology.org/2026.findings-acl.910/)** · ACL 2026 · LLM · Training-based · 💻[code](https://github.com/SalesforceAIResearch/PretrainRL-pipeline)
- **📋 [PROBE: PROcess-Based BEnchmark for Hallucination Detection](https://aclanthology.org/2026.findings-acl.2099/)** · ACL 2026 · LLM · Training-free · 💻[code](https://github.com/probe-rs/probe-rs)
- **[PRISM: Probing Reasoning, Instruction, and Source Memory in LLM Hallucinations](https://aclanthology.org/2026.acl-long.1551/)** · ACL 2026 · LLM · Training-free · 💻[code](https://github.com/PrismJS/prism)
...
- **📚 [Model stability and hallucination under the data-knowledge dual-drive paradigm: a survey](https://doi.org/10.1117/12.3110427)** · ICML 2026 · LLM · Training-free
- **[Mitigating Legal Hallucinations via Symbolic Constraints and Analogical Precedents](https://aclanthology.org/2026.acl-long.633/)** · ACL 2026 · LLM · Training-free · 💻[code](https://github.com/theSleepyPig/AALawyer)
- **[MeasHalu: Mitigation of Scientific Measurement Hallucinations for Large Language Models with Enhanced Reasoning](https://aclanthology.org/2026.findings-acl.1386/)** · ACL 2026 · LLM · Training-free · 💻[code](https://github.com/CAS-SIAT-XinHai/MeasHalu)
- **[MARCH: Multi-Agent Reinforced Check for Hallucination](https://aclanthology.org/2026.acl-long.1828/)** · ACL 2026 · LLM · Training-based · 💻[code](https://github.com/Qwen-Applications/MARCH)
...
- **[Logical Consistency as a Bridge: Improving LLM Hallucination Detection via Label Constraint Modeling between Responses and Self-Judgments](https://aclanthology.org/2026.acl-long.286/)** · ACL 2026 · LLM · Training-free · 💻[code](https://github.com/ICTMCG/LaaB)
...
- **[LAFaCT: Attribution-based Localization and Focused Sequential Analysis of Fact-Critical Tokens for Hallucination Detection](https://aclanthology.org/2026.acl-long.312/)** · ACL 2026 · LLM · Training-free · 💻[code](https://github.com/Malta-Lab/LaFaCt)
...
- **[JointCQ: Improving Factual Hallucination Detection with Joint Claim and Query Generation](https://aclanthology.org/2026.findings-acl.58/)** · ACL 2026 · LLM · Training-free · 💻[code](https://github.com/pku0xff/JointCQ)
...
- **[FaithLens: Detecting and Explaining Faithfulness Hallucination](https://aclanthology.org/2026.findings-acl.689/)** · ACL 2026 · LLM · Training-based · 💻[code](https://github.com/S1s-Z/FaithLens)
...
- **[Enhancing Hallucination Detection via Future Context](https://aclanthology.org/2026.findings-acl.35/)** · ACL 2026 · LLM · Training-free · 💻[code](https://github.com/rungjoo/hallucination_detection_future_context)
- **[Efficient Hallucination Detection in Automatic Code Generation](https://aclanthology.org/2026.findings-acl.2143/)** · ACL 2026 · LLM · Training-based · 💻[code](https://github.com/datapaf/CodeHallucinationDetection)
- **[Efficient Hallucination Detection for LLMs Using Uncertainty-Aware Attention Heads](https://arxiv.org/abs/2505.20045)** · ICML 2026 · LLM · Training-free · 💻[code](https://github.com/mbzuai-nlp/rauq-hallucination-detection)
- **[Dynamic PMI-Guided Contrastive Decoding Reduces Hallucination in Large Language Models: A Unified Framework of Fine-Grained Input Transformations](https://aclanthology.org/2026.findings-acl.1212/)** · ACL 2026 · LLM · Training-based
- **[Detecting Hallucinations in Retrieval-Augmented Generation via Semantic-level Internal Reasoning Graph](https://aclanthology.org/2026.findings-acl.1385/)** · ACL 2026 · LLM · Training-free · 💻[code](https://github.com/hk-hp/SIRG)
- **[CoDA: Restoring Contextual Dominance via Copy-Encouraged Attention Intervention for Mitigating RAG Hallucinations](https://aclanthology.org/2026.findings-acl.576/)** · ACL 2026 · LLM · Training-free · 💻[code](https://github.com/BladeCoda/Tencent2017_Final_Coda_Allegro)
...
- **[CSMAD: Hallucination Detection via Multi-Agent Debate with NLI-Verified Contradictory Statements](https://doi.org/10.1145/3805712.3808508)** · SIGIR 2026 · LLM · Training-free · 💻[code](https://github.com/EEEEdward-0/CSMAD)
- **📋 [Born Pragmatic, Trained to Hallucinate? Quantifying the Origins of Contextual Bias in LLMs via the PaCE Benchmark](https://doi.org/10.18653/v1/2026.findings-acl.959)** · ACL 2026 · LLM · Training-based · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[Beyond Output Confidence: Epistemic-Aware Hallucination Detection with Answer-Level Signals](https://aclanthology.org/2026.findings-acl.674/)** · ACL 2026 · LLM · Training-free · 💻[code](https://github.com/HXYfighter/AIC-ACL2026)
- **[Beyond Noise: Characterizing Creative Potential in Unverifiable LLM Hallucinations](https://aclanthology.org/2026.acl-long.554/)** · ACL 2026 · LLM · Training-free · 💻[code](https://github.com/YuLab1/llm-concept-creation)
- **[Awakening Dormant Experts: Counterfactual Routing to Mitigate MoE Hallucinations](https://aclanthology.org/2026.acl-long.2187/)** · ACL 2026 · LLM · Training-free · 💻[code](https://github.com/ZhaiYanbo/CoR)
...
- **[Readable but Not Controllable: Neuron-Level Evidence for Medical LLM Hallucination](https://arxiv.org/abs/2607.00158)** · arXiv · LLM · Training-free · 💻[code](https://github.com/sehaxe/burn-antihall)
- **[CORTEX: Token-Level Hallucination Detection in RAG via Comparative Internal Representations](https://arxiv.org/abs/2606.31033)** · arXiv · LLM · Training-free · 💻[code](https://github.com/rust-embedded/cortex-m)
- **📋 [How Far Can You Get Without a GPU? A Systematic Benchmark of Lightweight Hallucination Detection Across Question Answering, Dialogue, and Summarisation](https://arxiv.org/abs/2606.29809)** · arXiv · LLM · Training-free · 💻[code](https://github.com/fkriti/hallucination-detection-nli)
...
- **[LegalHalluLens: Typed Hallucination Auditing and Calibrated Multi-Agent Debate for Trustworthy Legal AI](https://arxiv.org/abs/2606.18021)** · arXiv · LLM · Training-free · 💻[code](https://github.com/lalitdv9/LegalHallulens)
...
- **[BALTO: Balanced Token-Level Policy Optimization for Hallucination Mitigation](https://arxiv.org/abs/2606.15893)** · arXiv · LLM · Training-based · 💻[code](https://github.com/Lothiraldan/balto)
- **[Zero-source LLM Hallucination Detection with Human-like Criteria Probing](https://arxiv.org/abs/2606.12900)** · arXiv · LLM · Training-free · 💻[code](https://github.com/TRISKEL10N/HCPD)
- **[SafeLLM: Extraction as a Hallucination-Resistant Alternative to Rewriting in Safety-Critical Settings](https://arxiv.org/abs/2606.12897)** · arXiv · LLM · Training-free · 💻[code](https://github.com/julia-ive/safeLLM-extraction)
...
- **[Quickest Detection of Hallucination Onset: Delay Bounds and Learned CUSUM Statistics](https://arxiv.org/abs/2606.12476)** · arXiv · LLM · Training-free · 💻[code](https://github.com/YehudaItkin/quickest-hallucination-onset)
...
- **[Building Reliable Long-Form Generation via Hallucination Rejection Sampling](https://arxiv.org/abs/2606.03628)** · arXiv · LLM · Training-free · 💻[code](https://github.com/TreeLLi/hallucination-rejection-sampling)
- **📚 [DECK: A Consistency x Confidence Taxonomy of LLM Hallucinations](https://arxiv.org/abs/2606.02289)** · arXiv · LLM · Training-free · 💻[code](https://github.com/visgl/deck.gl)
...
- **[TriLens: Per-Layer Logit-Lens Entropy for White-Box Hallucination Detection](https://arxiv.org/abs/2606.01033)** · arXiv · LLM · Training-free · 💻[code](https://github.com/Johan-torfs/trilens-document-intelligence)
- **[Med-HEAL: Analyzing and Mitigating Hallucinations in Medical LLMs with Hallucination-Aware In-Context Learning](https://arxiv.org/abs/2606.01301)** · arXiv · LLM · Training-free · 💻[code](https://github.com/yimingliao-blad/med-heal.git)
- **[Towards Lightweight Reliability: Using Soft Prompts for Hallucination Mitigation in Large Language Models](https://arxiv.org/abs/2606.00919)** · arXiv · LLM · Training-based
...
- **[Hallucination Is Linearly Decodable from Mid-Layer Hidden States in Quantized LLMs](https://arxiv.org/abs/2606.02628)** · arXiv · LLM · Training-free · 💻[code](https://github.com/Ezharjan/HallucinationPatternDetection)
- **[Citation Grounding: Detecting and Reducing LLM Citation Hallucinations via Legal Citation Graphs](https://arxiv.org/abs/2606.00898)** · arXiv · LLM · Training-based · 💻[code](https://github.com/samuelseidel/eu-ai-act-legal-rag)
- **[Fighting Numerical Hallucinations via Data-centric Compilation for Online Financial QA](https://arxiv.org/abs/2605.31064)** · arXiv · LLM · Training-free · 💻[code](https://github.com/shigurenimo/million)
...
- **[Hallucination Mitigation with Agentic AI, Nested Learning, and AI Sustainability via Semantic Caching](https://arxiv.org/abs/2605.29055)** · arXiv · LLM · Training-free · 💻[code](https://github.com/diegogosmar/HallucinationMitCaching)
- **[Hallucination Detection-Guided Preference Optimization for Clinical Summarization](https://arxiv.org/abs/2605.28910)** · arXiv · LLM · Training-free
...
- **[Innovation: An Almost Characterization of Hallucination](https://arxiv.org/abs/2605.26808)** · arXiv · LLM · Training-free · 💻[code](https://github.com/fetchai/innovation-lab-examples)
...
- **[CiteCheck: Retrieval-Grounded Detection of LLM Citation Hallucinations in Scientific Text](https://arxiv.org/abs/2605.27700)** · arXiv · LLM · Training-free · 💻[code](https://github.com/xzy-xzy/CiteCheck)
- **[Chain-based Adaptive Reconfiguration Over Lattices for Hallucination Reduction](https://arxiv.org/abs/2605.27706)** · arXiv · LLM · Training-free · 💻[code](https://github.com/joanvendrell/CAROL)
...
- **[Automatic Layer Selection for Hallucination Detection](https://arxiv.org/abs/2605.26366)** · arXiv · LLM · Training-free · 💻[code](https://github.com/DesoloYw/Automatic-Layer-Selection-for-Hallucination-Detection.git)
- **[MultiHaluDet: Multilingual Hallucination Detection via LLM Hidden State Probing](https://arxiv.org/abs/2605.24919)** · arXiv · LLM · Training-free · 💻[code](https://github.com/alvi-uiu/MULTIHALUDET)
...
- **[Beyond Final Answers: Auditing Trajectory-Level Hallucinations in Multi-Agent Industrial Workflows](https://arxiv.org/abs/2605.24219)** · arXiv · LLM · Training-free · 💻[code](https://github.com/mltooling/ci-test)
- **[Hallucination as Commitment Failure: Larger LLMs Misfire Despite Knowing the Answer](https://arxiv.org/abs/2605.22007)** · arXiv · LLM · Training-based
...
- **[ACL-Verbatim: hallucination-free question answering for research](https://arxiv.org/abs/2605.21102)** · arXiv · LLM · Training-based · 💻[code](https://github.com/KRLabsOrg/acl-verbatim)
- **📋 [HalluWorld: A Controlled Benchmark for Hallucination via Reference World Models](https://arxiv.org/abs/2605.19341)** · arXiv · LLM · Training-free · 💻[code](https://github.com/DegenAI-Labs/HalluWorld)
- **[TRACE: Trajectory Correction from Cross-layer Evidence for Hallucination Reduction](https://arxiv.org/abs/2605.18163)** · arXiv · LLM · Training-free · 💻[code](https://github.com/janestreet/magic-trace)
...
- **📋 [PARALLAX: Separating Genuine Hallucination Detection from Benchmark Construction Artifacts](https://arxiv.org/abs/2605.17028)** · arXiv · LLM · Training-free · 💻[code](https://github.com/wagerfield/parallax)
- **📋 [HalluScore: Large Language Model Hallucination Question Answering Benchmark](https://arxiv.org/abs/2605.17007)** · arXiv · LLM · Training-free · 💻[code](https://github.com/aishaalansari57/HalluScore)
- **[When Answers Stray from Questions: Hallucination Detection via Question-Answer Orthogonal Decomposition](https://arxiv.org/abs/2605.14449)** · arXiv · LLM · Training-free · 💻[code](https://github.com/XiaomingX/arxiv-daily)
- **[Where Does Reasoning Break? Step-Level Hallucination Detection via Hidden-State Transport Geometry](https://arxiv.org/abs/2605.13772)** · arXiv · LLM · Training-free · 💻[code](https://github.com/Muxaline/Renewable-Energy-Optimization)
- **[On Hallucinations in Inverse Problems: Fundamental Limits and Provable Assessment Methods](https://arxiv.org/abs/2605.13146)** · arXiv · LLM · Training-free · 💻[code](https://github.com/davidiagraid/hallucinations_invpb)
- **[Scalable Token-Level Hallucination Detection in Large Language Models](https://arxiv.org/abs/2605.12384)** · arXiv · LLM · Training-based · 💻[code](https://github.com/rmin2000/TokenHD)
- **[REALISTA: Realistic Latent Adversarial Attacks that Elicit LLM Hallucinations](https://arxiv.org/abs/2605.12813)** · arXiv · LLM · Training-free · 💻[code](https://github.com/Buyun-Liang/REALISTA)
- **[OptArgus: A Multi-Agent System to Detect Hallucinations in LLM-based Optimization Modeling](https://arxiv.org/abs/2605.11738)** · arXiv · LLM · Training-free · 💻[code](https://github.com/wang748/test_dir)
- **[CAAFC: Chronological Actionable Automated Fact-Checker for misinformation / non-factual hallucination detection and correction](https://arxiv.org/abs/2605.12436)** · arXiv · LLM · Training-free · 💻[code](https://github.com/lixingze77/caafc)
...
- **[Source or It Didn't Happen: A Multi-Agent Framework for Citation Hallucination Detection](https://arxiv.org/abs/2605.08583)** · arXiv · LLM · Training-free · 💻[code](https://github.com/aaFrostnova/CiteTracer)
- **[Max-pooling Network Revisited: Analyzing the Role of Semantic Probability in Multiple Instance Learning for Hallucination Detection](https://arxiv.org/abs/2605.08863)** · arXiv · LLM · Training-free · 💻[code](https://github.com/FUJI1229/Hallucination_Detection)
- **[Sanity Checks for Long-Form Hallucination Detection](https://arxiv.org/abs/2605.08346)** · arXiv · LLM · Training-free · 💻[code](https://github.com/iszhanjiawei/TTS_arxiv_daily)
- **[LLM hallucinations in the wild: Large-scale evidence from non-existent citations](https://arxiv.org/abs/2605.07723)** · arXiv · LLM · Training-free · 💻[code](https://github.com/ZhuYingJessica/cv-daily)
- **[Hallucination Detection via Activations of Open-Weight Proxy Analyzers](https://arxiv.org/abs/2605.07209)** · arXiv · LLM · Training-based
...
- **[Why DDIM Hallucinates More Than DDPM: A Theoretical Analysis of Reverse Dynamics](https://arxiv.org/abs/2605.06831)** · arXiv · LLM · Training-free · 💻[code](https://github.com/diffusion-hallucination/ddim_vs_ddpm_hallucinations)
- **[Hallucination as an Anomaly: Dynamic Intervention via Probabilistic Circuits](https://arxiv.org/abs/2605.05953)** · arXiv · LLM · Training-free · 💻[code](https://github.com/NielsenErik/DeepFakeDet)
- **📋 [Delulu: A Verified Multi-Lingual Benchmark for Code Hallucination Detection in Fill-in-the-Middle Tasks](https://arxiv.org/abs/2605.07024)** · arXiv · LLM · Training-free · 💻[code](https://github.com/microsoft/delulu)
- **[Attractor Geometry of Transformer Memory: From Conflict Arbitration to Confident Hallucination](https://arxiv.org/abs/2605.05686)** · arXiv · LLM · Training-based
...
- **[From Flat Facts to Sharp Hallucinations: Detecting Stubborn Errors via Gradient Sensitivity](https://arxiv.org/abs/2605.00939)** · arXiv · LLM · Training-free · 💻[code](https://github.com/potato0o/Stubborn_Hallucinations)
- **[From Architecture to Output: Structural Origins of Hallucination in Large Language Models and the Amplifying Role of Data](https://arxiv.org/abs/2606.07537)** · arXiv · LLM · Training-based
- **📋 [Semantic Layers for Reliable LLM-Powered Data Analytics: A Paired Benchmark of Accuracy and Hallucination Across Three Frontier Models](https://arxiv.org/abs/2604.25149)** · arXiv · LLM · Training-free
- **[HIVE: Hidden-Evidence Verification for Hallucination Detection in Diffusion Large Language Models](https://arxiv.org/abs/2604.26139)** · arXiv · LLM · Training-free · 💻[code](https://github.com/aden-hive/hive)
- **[Detecting Hallucinations for Large Language Model-based Knowledge Graph Reasoning](https://arxiv.org/abs/2606.19351)** · arXiv · LLM · Training-free · 💻[code](https://github.com/liuzhen9320/zstar)
- **[FinGround: Detecting and Grounding Financial Hallucinations via Atomic Claim Verification](https://arxiv.org/abs/2604.23588)** · arXiv · LLM · Training-free · 💻[code](https://github.com/YanbiaoLab/finground)
- **[GSAR: Typed Grounding for Hallucination Detection and Recovery in Multi-Agent LLMs](https://arxiv.org/abs/2604.23366)** · arXiv · LLM · Training-free · 💻[code](https://github.com/abronte/gsar)
...
- **[Where Fake Citations Are Made: Tracing Field-Level Hallucination to Specific Neurons in LLMs](https://arxiv.org/abs/2604.18880)** · arXiv · LLM · Training-based · 💻[code](https://github.com/mltooling/ci-test)
- **[BEACON: Behavioral Entropy Aggregation for Cross-Model Hallucination Detection in Large Language Models](https://arxiv.org/abs/2606.07528)** · arXiv · LLM · Training-based · 💻[code](https://github.com/igrigorik/ga-beacon)
- **[Evaluating Hallucinations in Domain-Adapted Large Language Models](https://arxiv.org/abs/2606.07521)** · arXiv · LLM · Training-based
- **[RAGognizer: Hallucination-Aware Fine-Tuning via Detection Head Integration](https://arxiv.org/abs/2604.15945)** · arXiv · LLM · Training-free · 💻[code](https://github.com/F4biian/RAGognizer)
- **[Why Fine-Tuning Encourages Hallucinations and How to Fix It](https://arxiv.org/abs/2604.15574)** · arXiv · LLM · Training-free · 💻[code](https://github.com/schwartz-lab-NLP/finetuning-hallucinations)
- **[Hallucination as Trajectory Commitment: Causal Evidence for Asymmetric Attractor Dynamics in Transformer Generation](https://arxiv.org/abs/2604.15400)** · arXiv · LLM · Training-free · 💻[code](https://github.com/MindyRenee/ai-epistemic-arcade-game)
...
- **[Synthius-Mem: Brain-Inspired Hallucination-Resistant Persona Memory Achieving 94.4% Memory Accuracy and 99.6% Adversarial Robustness on LoCoMo](https://arxiv.org/abs/2604.11563)** · arXiv · LLM · Training-free · 💻[code](https://github.com/Kirafy123/synthius-mem-claude)
- **[Attention Sinks as Internal Signals for Hallucination Detection in Large Language Models](https://arxiv.org/abs/2604.10697)** · arXiv · LLM · Training-free · 💻[code](https://github.com/graphml-lab-pwr/sink-probe)
- **[Micro-Macro Retrieval: Reducing Long-Form Hallucination in Large Language Models](https://arxiv.org/abs/2605.28828)** · arXiv · LLM · Training-based
...
- **[Weakly Supervised Distillation of Hallucination Signals into Transformer Representations](https://arxiv.org/abs/2604.06277)** · arXiv · LLM · Training-free · 💻[code](https://github.com/TheoMarkopoulos/halluscope)
...
- **[From Hallucination to Structure Snowballing: The Alignment Tax of Constrained Decoding in LLM Reflection](https://arxiv.org/abs/2604.06066)** · arXiv · LLM · Training-free · 💻[code](https://github.com/hongxuzhou/agentic_llm_structured_self_critique)
- **[CareGuardAI: Context-Aware Multi-Agent Guardrails for Clinical Safety & Hallucination Mitigation in Patient-Facing LLMs](https://arxiv.org/abs/2604.26959)** · arXiv · LLM · Training-free · 💻[code](https://github.com/venkataDeepthiSri/CareGuardAI)
- **[Hallucination Basins: A Dynamic Framework for Understanding and Controlling LLM Hallucinations](https://arxiv.org/abs/2604.04743)** · arXiv · LLM · Training-free · 💻[code](https://github.com/MindyRenee/ai-epistemic-arcade-game)
...
- **[I-CALM: Incentivizing Confidence-Aware Abstention for LLM Hallucination Mitigation](https://arxiv.org/abs/2604.03904)** · arXiv · LLM · Training-free · 💻[code](https://github.com/binzeli/hallucinationControl)
...
- **[KARL: Mitigating Hallucinations in LLMs via Knowledge-Boundary-Aware Reinforcement Learning](https://arxiv.org/abs/2604.22779)** · arXiv · LLM · Training-based · 💻[code](https://github.com/thunlp/KARL)
- **[Detecting and Correcting Reference Hallucinations in Commercial LLMs and Deep Research Agents](https://arxiv.org/abs/2604.03173)** · arXiv · LLM · Training-free · 💻[code](https://github.com/delip/urlhealth)
- **[Council Mode: A Heterogeneous Multi-Agent Consensus Framework for Reducing LLM Hallucination and Bias](https://arxiv.org/abs/2604.02923)** · arXiv · LLM · Training-free · 💻[code](https://github.com/gpowerf/Council-Mode-Skill)
- **[BibTeX Citation Hallucinations in Scientific Publishing Agents: Evaluation and Mitigation](https://arxiv.org/abs/2604.03159)** · arXiv · LLM · Training-free · 💻[code](https://github.com/delip/clibib)
...
- **[Token-Guard: Towards Token-Level Hallucination Control via Self-Checking Decoding](https://arxiv.org/abs/2601.21969)** · ICLR 2026 · LLM · Training-based · 💻[code](https://github.com/RongHuiQiang/Token-Guard)
...
- **[HARP: Hallucination Detection via Reasoning Subspace Projection](https://arxiv.org/abs/2509.11536)** · ICLR 2026 · LLM · Training-free · 💻[code](https://github.com/sintaxi/harp)
- **📋 [DHEval: A Dynamic Hallucination Evaluation Protocol Robust to Data Contamination](https://doi.org/10.1109/icassp55912.2026.11462032)** · ICASSP 2026 · LLM · Training-free · 💻[code](https://github.com/spmede/DHEval)
...
- **[An Industrial-Scale Insurance LLM Achieving Verifiable Domain Mastery and Hallucination Control without Competence Trade-offs](https://arxiv.org/abs/2603.14463)** · ICLR 2026 · LLM · Training-based · 💻[code](https://github.com/linuxhw/LsCPU)
...
- **[Retromorphic Testing with Hierarchical Verification for Hallucination Detection in RAG](https://arxiv.org/abs/2603.27752)** · arXiv · LLM · Training-free · 💻[code](https://github.com/mltooling/ci-test)
...
- **[Do Hallucination Neurons Generalize? Evidence from Cross-Domain Transfer in LLMs](https://arxiv.org/abs/2604.19765)** · arXiv · LLM · Training-based
- **[MARCH: Multi-Agent Reinforced Self-Check for LLM Hallucination](https://arxiv.org/abs/2603.24579)** · arXiv · LLM · Training-based · 💻[code](https://github.com/Qwen-Applications/MARCH)
...
- **[Inducing Epistemological Humility in Large Language Models: A Targeted SFT Approach to Reducing Hallucination](https://arxiv.org/abs/2603.17504)** · arXiv · LLM · Training-based
...
- **[POaaS: Minimal-Edit Prompt Optimization as a Service to Lift Accuracy and Cut Hallucinations on On-Device sLLMs](https://arxiv.org/abs/2603.16045)** · arXiv · LLM · Training-free · 💻[code](https://github.com/jshim0978/POaaS)
- **[DynHD: Hallucination Detection for Diffusion Large Language Models via Denoising Dynamics Deviation Learning](https://arxiv.org/abs/2603.16459)** · arXiv · LLM · Training-free · 💻[code](https://github.com/wang748/test_dir)
- **[Blending Human and LLM Expertise to Detect Hallucinations and Omissions in Mental Health Chatbot Responses](https://arxiv.org/abs/2604.06216)** · arXiv · LLM · Training-based · 💻[code](https://github.com/ZhuYingJessica/cv-daily)
...
- **📋 [FinReflectKG -- HalluBench: GraphRAG Hallucination Benchmark for Financial Question Answering Systems](https://arxiv.org/abs/2603.20252)** · arXiv · LLM · Training-based
- **[Disentangling Prompt Element Level Risk Factors for Hallucinations and Omissions in Mental Health LLM Responses](https://arxiv.org/abs/2604.00014)** · arXiv · LLM · Training-free · 💻[code](https://github.com/liutaocode/TTS-arxiv-daily)
...
- **[Tool Receipts, Not Zero-Knowledge Proofs: Practical Hallucination Detection for AI Agents](https://arxiv.org/abs/2603.10060)** · arXiv · LLM · Training-free · 💻[code](https://github.com/SRagan/faithguard)
...
- **[A Novel Multi-Agent Architecture to Reduce Hallucinations of Large Language Models in Multi-Step Structural Modeling](https://arxiv.org/abs/2603.07728)** · arXiv · LLM · Training-free · 💻[code](https://github.com/twist1999/Multi_Agent_2Dframe)
- **[Do Deployment Constraints Make LLMs Hallucinate Citations? An Empirical Study across Four Models and Five Prompting Regimes](https://arxiv.org/abs/2603.07287)** · arXiv · LLM · Training-free · 💻[code](https://github.com/hardy30894/citation-under-pressure)
- **[HART: Data-Driven Hallucination Attribution and Evidence-Based Tracing for Large Language Models](https://arxiv.org/abs/2603.05828)** · arXiv · LLM · Training-free · 💻[code](https://github.com/mit-han-lab/hart)
- **[Neuro-Symbolic Financial Reasoning via Deterministic Fact Ledgers and Adversarial Low-Latency Hallucination Detector](https://arxiv.org/abs/2603.04663)** · arXiv · LLM · Training-free · 💻[code](https://github.com/pagand/VeNRA)
- **[The Unintended Trade-off of AI Alignment: Balancing Hallucination Mitigation and Safety in LLMs](https://doi.org/10.18653/v1/2026.findings-eacl.53)** · EACL 2026 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[Taming Object Hallucinations with Verified Atomic Confidence Estimation](https://doi.org/10.18653/v1/2026.eacl-long.252)** · EACL 2026 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[Rethinking Hallucinations: Correctness, Consistency, and Prompt Multiplicity](https://doi.org/10.18653/v1/2026.eacl-long.327)** · EACL 2026 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[Reducing Hallucinations in Language Model-based SPARQL Query Generation Using Post-Generation Memory Retrieval](https://doi.org/10.18653/v1/2026.findings-eacl.243)** · EACL 2026 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[Reasoning&apos;s Razor: Reasoning Improves Accuracy but Hurts Recall at Critical Operating Points in Safety and Hallucination Detection](https://doi.org/10.18653/v1/2026.eacl-long.190)** · EACL 2026 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **📋 [Multi-Hall-SA: A Cross-lingual Benchmark for Multi-Type Hallucination Detection in Low-Resource South African Languages](https://doi.org/10.18653/v1/2026.findings-eacl.330)** · EACL 2026 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **📋 [KGHaluBench: A Knowledge Graph-Based Hallucination Benchmark for Evaluating the Breadth and Depth of LLM Knowledge](https://doi.org/10.18653/v1/2026.findings-eacl.206)** · EACL 2026 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[HalluZig: Hallucination Detection using Zigzag Persistence](https://doi.org/10.18653/v1/2026.eacl-long.159)** · EACL 2026 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **📋 [GHOST: Getting to the Bottom of Hallucinations with A Multi-round Consistency Benchmark](https://doi.org/10.1109/WACV61042.2026.00596)** · WACV 2026 · LLM · Training-free · 💻[code](https://github.com/TryGhost/Ghost)
- **[FactSelfCheck: Fact-Level Black-Box Hallucination Detection for LLMs](https://doi.org/10.18653/v1/2026.findings-eacl.296)** · EACL 2026 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **📋 [FFE-Hallu: Hallucinations in Fixed Figurative Expressions: A Benchmark of Idioms and Proverbs in the Persian Language](https://doi.org/10.18653/v1/2026.eacl-long.241)** · EACL 2026 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[Do LLM hallucination detectors suffer from low-resource effect?](https://doi.org/10.18653/v1/2026.eacl-long.136)** · EACL 2026 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **📋 [Constructing a Dataset for Hallucination Detection in Japanese Summarization with Fine-grained Faithfulness Labels](https://doi.org/10.18653/v1/2026.eacl-srw.15)** · EACL 2026 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[Being Kind Isn't Always Being Safe: Diagnosing Affective Hallucination in LLMs](https://doi.org/10.18653/v1/2026.findings-eacl.4)** · EACL 2026 · LLM · Training-based · 💻[code](https://github.com/0oOMiNGOo0/AHaBench)
- **[Being Kind Isn&apos;t Always Being Safe: Diagnosing Affective Hallucination in LLMs](https://doi.org/10.18653/v1/2026.findings-eacl.4)** · EACL 2026 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
...
- **[Detecting Contextual Hallucinations in LLMs with Frequency-Aware Attention](https://arxiv.org/abs/2602.18145)** · arXiv · LLM · Training-free · 💻[code](https://github.com/ramgopal-reddy/repro-detecting-contextual-hallucinations-in-large-language-models-with-frequency-aware-attentio)
...
- **[A Geometric Analysis of Small-sized Language Model Hallucinations](https://arxiv.org/abs/2602.14778)** · arXiv · LLM · Training-free · 💻[code](https://github.com/eOnofri04/APORIA)
...
- **[TDGNet: Hallucination Detection in Diffusion Language Models via Temporal Dynamic Graphs](https://arxiv.org/abs/2602.08048)** · arXiv · LLM · Training-free · 💻[code](https://github.com/ms1211/TDGNet)
- **[Spectral Guardrails for Agents in the Wild: Detecting Tool Use Hallucinations via Attention Topology](https://arxiv.org/abs/2602.08082)** · arXiv · LLM · Training-free · 💻[code](https://github.com/yehor04/sentinel)
...
- **[Stop Rewarding Hallucinated Steps: Faithfulness-Aware Step-Level Reinforcement Learning for Small Reasoning Models](https://arxiv.org/abs/2602.05897)** · arXiv · LLM · Training-based · 💻[code](https://github.com/Easy195/FaithRL)
...
- **[HALT: Hallucination Assessment via Log-probs as Time series](https://arxiv.org/abs/2602.02888)** · arXiv · LLM · Training-free · 💻[code](https://github.com/augustl/halt)
...
- **📋 [HalluHard: A Hard Multi-Turn Hallucination Benchmark](https://arxiv.org/abs/2602.01031)** · arXiv · LLM · Training-free · 💻[code](https://github.com/fan1dy/halluhard)
- **[SEVADE: Self-Evolving Multi-Agent Analysis with Decoupled Evaluation for Hallucination-Resistant Sarcasm Detection](https://doi.org/10.1609/aaai.v40i35.40200)** · AAAI 2026 · LLM · Training-free · 💻[code](https://github.com/sunbus100/SEVADE)
- **[ProgRAG: Hallucination-Resistant Progressive Retrieval and Reasoning over Knowledge Graphs](https://doi.org/10.1609/aaai.v40i39.40545)** · AAAI 2026 · LLM · Training-free · 💻[code](https://github.com/hyemin-yang/ProgRAG)
...
- **[NewsLensAI: NER-Guided Summarization for Mitigating Hallucination and Bias in LLM-Based News Summaries (Student Abstract)](https://doi.org/10.1609/aaai.v40i48.42250)** · AAAI 2026 · LLM · Training-free · 💻[code](https://github.com/GogoRit/NewsLensAI)
- **[Mitigating Hallucinations in Large Language Models via Causal Reasoning](https://doi.org/10.1609/aaai.v40i38.40454)** · AAAI 2026 · LLM · Training-based · 💻[code](https://github.com/MrLYG/CDCR-SFT)
- **📋 [MHB: Medical Hallucination Benchmark for Large Language Models in Complex Clinical Tasks](https://doi.org/10.1609/aaai.v40i45.41243)** · AAAI 2026 · LLM · Training-free · 💻[code](https://github.com/justiceamoh/mhb)
...
- **[HalluClean: A Unified Framework to Combat Hallucinations in LLMs](https://doi.org/10.1609/aaai.v40i42.40926)** · AAAI 2026 · LLM · Training-free · 💻[code](https://github.com/tingmuor/HalluClean)
...
- **[From Detection to Diagnosis: Advancing Hallucination Analysis with Automated Data Synthesis](https://doi.org/10.1609/aaai.v40i38.40495)** · AAAI 2026 · LLM · Training-based
...
- **[Why Your Deep Research Agent Fails? On Hallucination Evaluation in Full Research Trajectory](https://arxiv.org/abs/2601.22984)** · arXiv · LLM · Training-free · 💻[code](https://github.com/yuhao-zhan/DeepHalluBench)
- **[Can We Improve Educational Diagram Generation with In-Context Examples? Not if a Hallucination Spoils the Bunch](https://arxiv.org/abs/2601.20476)** · arXiv · LLM · Training-free · 💻[code](https://github.com/evalog-a/llm-diagram-generator)
- **[CheckIfExist: Detecting Citation Hallucinations in the Era of AI-Generated Content](https://arxiv.org/abs/2602.15871)** · arXiv · LLM · Training-free · 💻[code](https://github.com/ruffles182/checkifexist)
- **[HalluGuard: Demystifying Data-Driven and Reasoning-Driven Hallucinations in LLMs](https://arxiv.org/abs/2601.18753)** · arXiv · LLM · Training-free · 💻[code](https://github.com/Susan571/HalluGuard-ICLR2026)
- **📚 [A Geometric Taxonomy of Hallucinations in LLMs](https://arxiv.org/abs/2602.13224)** · arXiv · LLM · Training-free
...
- **[CORVUS: Red-Teaming Hallucination Detectors via Internal Signal Camouflage in Large Language Models](https://arxiv.org/abs/2601.14310)** · arXiv · LLM · Training-free · 💻[code](https://github.com/eleme/corvus)
- **[Small Updates, Big Doubts: Does Parameter-Efficient Fine-tuning Enhance Hallucination Detection ?](https://arxiv.org/abs/2602.11166)** · arXiv · LLM · Training-based · 💻[code](https://github.com/he-yufeng/he-yufeng)
- **[Relational Linearity is a Predictor of Hallucinations](https://arxiv.org/abs/2601.11429)** · arXiv · LLM · Training-free · 💻[code](https://github.com/liutaocode/TTS-arxiv-daily)
- **[Hallucinations Live in Variance](https://arxiv.org/abs/2601.07058)** · arXiv · LLM · Training-free
- **[AgentHallu: Benchmarking Automated Hallucination Attribution of LLM-based Agents](https://arxiv.org/abs/2601.06818)** · arXiv · LLM · Training-free · 💻[code](https://github.com/liuxuannan/AgentHallu)
- **[AI Hallucination from Students' Perspective: A Thematic Analysis](https://arxiv.org/abs/2602.17671)** · arXiv · LLM · Training-free
- **[Internal Representations as Indicators of Hallucinations in Agent Tool Selection](https://arxiv.org/abs/2601.05214)** · arXiv · LLM · Training-free · 💻[code](https://github.com/RLASAF12/toolrot)
- **[Geometry-Aware Hallucination Detection in Large Language Models](https://arxiv.org/abs/2601.06196)** · arXiv · LLM · Training-based
...
- **[KDCM: Reducing Hallucination in LLMs through Explicit Reasoning Structures](https://arxiv.org/abs/2601.04086)** · arXiv · LLM · Training-free · 💻[code](https://github.com/CharissLumongsod/KDCM-Salon-Reservation)
- **[Temporal Graph Network: Hallucination Detection in Multi-Turn Conversation](https://arxiv.org/abs/2601.03051)** · arXiv · LLM · Training-free · 💻[code](https://github.com/sambuaneesh/anlp-project)
- **[RAL2M: Retrieval Augmented Learning-To-Match Against Hallucination in Compliance-Guaranteed Service Systems](https://arxiv.org/abs/2601.02917)** · arXiv · LLM · Training-free · 💻[code](https://github.com/wangqiannudt/nerf-arxiv-daily)
- **[Mitigating Prompt-Induced Hallucinations in Large Language Models via Structured Reasoning](https://arxiv.org/abs/2601.02739)** · arXiv · LLM · Training-free · 💻[code](https://github.com/YuzeHao2023/daily-arxiv-ai4polymer)
- **[Not All Needles Are Found: How Fact Distribution and Don't Make It Up Prompts Shape Retrieval, Reasoning, and Hallucination in Long-Context LLMs](https://arxiv.org/abs/2601.02023)** · arXiv · LLM · Training-free · 💻[code](https://github.com/AmiraliE1380/not-all-needles-are-found)
- **[LANCET: Neural Intervention via Structural Entropy for Mitigating Faithfulness Hallucinations in LLMs](https://arxiv.org/abs/2601.01401)** · arXiv · LLM · Training-free · 💻[code](https://github.com/awslabs/Lancet-Accelerating-MoE-Training-via-Whole-Graph-Computation-Communication-Overlapping)
- **[Empowering Small Language Models with Factual Hallucination-Aware Reasoning for Financial Classification](https://arxiv.org/abs/2601.01378)** · arXiv · LLM · Training-free · 💻[code](https://github.com/Han-Yuan-Med/Factuality-Aware-Reasoning)
...
- **[The Verified Query Repository: A Human-in-the-Loop Architectural Pattern for Eliminating Hallucination in Enterprise NLP Systems](https://doi.org/10.51483/ijaiml.6.6s.2026.320-330)** · Other · LLM · Training-free
- **[SIC-Autonomous Ensemble: Large Language Model Hallucination Mitigation Framework using Self Iterative Contradiction and Optimal Ensembling](https://doi.org/10.1109/tai.2026.3721061)** · Other · LLM · Training-free
- **[Layer-wise symbolic attention instability as a diagnostic signal for hallucination in large language models](https://doi.org/10.1007/s44163-026-01839-3)** · Other · LLM · Training-free
- **[Insights on Mitigating Privacy Concerns in Gamification through LLM-Assisted Qualitative Analysis with Minimal Hallucination](https://doi.org/10.1145/3839358)** · Other · LLM · Training-free
- **[Hallucination-Aware Hierarchical LLM for Autonomous UAV Mobility Control: A Safe Reinforcement Learning Approach](https://doi.org/10.1109/ton.2026.3725648)** · Other · LLM · Training-based
- **[Hallucination to Harmony](https://doi.org/10.4018/979-8-3373-7534-2.ch002)** · Other · LLM · Training-free
- **📚 [Hallucination Detection, Verification, and Correction in Generative AI: A Comprehensive Survey](https://doi.org/10.1016/j.nlp.2026.100231)** · Other · LLM · Training-free
- **[Detecting Hallucinations in Large Language Models via Internal Attention Divergence Signals](https://doi.org/10.18653/v1/2026.acl-srw.6)** · Other · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[Beyond Hallucination: Reframing LLM Quality Assessment as Task-Output Alignment](https://doi.org/10.18653/v1/2026.bigpicture-main.3)** · Other · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[uir-cis at SemEval-2026 Task 12: Mitigating Prior-Induced Hallucinations in Retrieval-Augmented Reasoning via Precision-Oriented Decoding](https://doi.org/10.18653/v1/2026.semeval-1.415)** · SemEval@ACL 2026 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
...
- **[Towards Grounded Hallucination Definitions for Biomedical Question Answering with Reproducible Examples from ClinIQLink](https://doi.org/10.18653/v1/2026.bionlp-1.67)** · BioNLP@ACL 2026 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
...
- **[The Case for Repeatable, Open, and Expert-Grounded Hallucination Benchmarks in Large Language Models](https://doi.org/10.1145/3803291.3803328)** · ICICT 2026 · LLM · Training-free · 💻[code](https://github.com/Alex223124/high_load_app)
...
- **[SelfCheck-Eval: A Multi-Module Framework for Zero-Resource Hallucination Detection in Large Language Models](https://doi.org/10.1016/j.patter.2026.101569)** · Patterns 2026 · LLM · Training-based · 💻[code](https://github.com/corei5/SelfCheck-Eval)
- **[SeaRAG: Reducing Hallucination in Retrieval-Augmented Generation via Statement-Entity Adaptive Ranking](https://doi.org/10.1145/3774904.3792598)** · WWW 2026 · LLM · Training-free · 💻[code](https://github.com/Invariant0502/SEARAG)
- **[SUMMIR: A Hallucination-Aware Framework for Ranking Sports Insights from LLMs](https://doi.org/10.1007/978-3-032-21289-4_23)** · ECIR 2026 · LLM · Training-free · 💻[code](https://github.com/nitish-iitp/SUMMIR)
- **[SINdex: Semantic INconsistency Index for Hallucination Detection in LLMs](https://doi.org/10.1109/OJCS.2026.3697236)** · IEEE Open J. Comput. Soc. 2026 · LLM · Training-free · 💻[code](https://github.com/timob/sindex)
- **[RusHallu-RAG: benchmarking hallucination detection for Russian RAG](https://doi.org/10.29003/2075-7182-2026-24-516-534)** · Comput. Linguistics 2026 · LLM · Training-free · 💻[code](https://github.com/feudor2/RusHallu-RAG)
- **[ReGA: Zero-Overhead Graph Alignment for Structural Hallucination Detection Without Generation](https://doi.org/10.1145/3774905.3794657)** · WWW 2026 · LLM · Training-free · 💻[code](https://github.com/ioBroker/ioBroker.hm-rega)
...
- **[Mitigating hallucinations in healthcare LLMs with granular fact-checking and domain-specific adaptation](https://doi.org/10.1016/j.eswa.2026.132966)** · ESWA 2026 · LLM · Training-based
...
- **[MVRL: A Multi-stage Training Framework for Value Alignment and Hallucination Suppression in Large Language Models](https://doi.org/10.1109/prmvai70103.2026.11605527)** · IEEE International Conference on Pattern Recognition, Machine Vision and Artificial Intelligence (PRMVAI) 2026 · LLM · Training-based · 💻[code](https://github.com/mlii/mvrl)
- **📚 [Loki’s Dance of Illusions: A Comprehensive Survey of Hallucination in Large Language Models](https://doi.org/10.1109/tcss.2026.3661295)** · IEEE Transactions on Computational Social Systems 2026 · LLM · Training-free
...
- **[Learned Hallucination Detection in Black-Box LLMs using Token-level Entropy Production Rate](https://doi.org/10.1007/978-3-032-21289-4_8)** · ECIR 2026 · LLM · Training-free · 💻[code](https://github.com/CharlesMoslonka/demo_atfal)
...
- **[HalluJudge: A Reference-Free Hallucination Detection for Context Misalignment in Code Review Automation](https://doi.org/10.1145/3803437.3805236)** · SIGSOFT FSE Companion 2026 · LLM · Training-free · 💻[code](https://github.com/minwoo/fse26-hallujudge)
...
- **[FACTUM: Mechanistic Detection of Citation Hallucination in Long-Form RAG](https://doi.org/10.1007/978-3-032-21289-4_18)** · ECIR 2026 · LLM · Training-free · 💻[code](https://github.com/DFiantWorks/factum)
...
- **[DHI: Leveraging Diverse Hallucination Induction for Enhanced Contrastive Factuality Control in Large Language Models](https://doi.org/10.1007/978-981-95-4088-4_15)** · Communications in Computer and Information Science 2026 · LLM · Training-free · 💻[code](https://github.com/OLife97/dhi-caddy-cloudflare)
...
- **[CHIME: Conditional Hallucination and Integrated Multi-scale Enhancement for Time Series Diffusion Model](https://doi.org/10.1016/j.knosys.2026.116089)** · KBS 2026 · LLM · Training-free · 💻[code](https://github.com/aws/amazon-chime-sdk-js)
- **[Beyond Functional Correctness: Exploring Hallucinations in LLM-Generated Code](https://doi.org/10.1109/TSE.2026.3657432)** · IEEE Trans. Software Eng. 2026 · LLM · Training-free · 💻[code](https://github.com/Lorien1128/code_hallucination)
...
<details>
<summary>📅 2025 · 443 papers</summary>
...
- **[The Semantic Illusion: Certified Limits of Embedding-Based Hallucination Detection in RAG Systems](https://arxiv.org/abs/2512.15068)** · arXiv · LLM · Training-based · 💻[code](https://github.com/debu-sinha/guard)
- **[Photorealistic Phantom Roads in Real Scenes: Disentangling 3D Hallucinations from Physical Geometry](https://arxiv.org/abs/2512.15423)** · arXiv · LLM · Training-based
...
- **[Semantic Faithfulness and Entropy Production Measures to Tame Your LLM Demons and Manage Hallucinations](https://arxiv.org/abs/2512.05156)** · arXiv · LLM · Training-free · 💻[code](https://github.com/ighalp/semantic-faithfulness-sdm)
- **[Towards Unification of Hallucination Detection and Fact Verification for Large Language Models](https://arxiv.org/abs/2512.02772)** · arXiv · LLM · Training-free · 💻[code](https://github.com/oneal2000/UniFact)
...
- **📚 [A Concise Review of Hallucinations in LLMs and their Mitigation](https://arxiv.org/abs/2512.02527)** · arXiv · LLM · Training-free
- **[HalluGraph: Auditable Hallucination Detection for Legal RAG Systems via Knowledge Graph Alignment](https://arxiv.org/abs/2512.01659)** · arXiv · LLM · Training-free · 💻[code](https://github.com/susanjax/HalluGraph_smiles)
- **[H-Neurons: On the Existence, Impact, and Origin of Hallucination-Associated Neurons in LLMs](https://arxiv.org/abs/2512.01797)** · arXiv · LLM · Training-free · 💻[code](https://github.com/thunlp/H-Neurons)
- **📋 [BHRAM-IL: A Benchmark for Hallucination Recognition and Assessment in Multiple Indian Languages](https://arxiv.org/abs/2512.01852)** · arXiv · LLM · Training-free · 💻[code](https://github.com/sambhashana/BHRAM-IL)
...
- **[SECA: Semantically Equivalent and Coherent Attacks for Eliciting LLM Hallucinations](http://papers.nips.cc/paper_files/paper/2025/hash/d077bc9ea82a2998ca6b2d0158b5ac6e-Abstract-Conference.html)** · NeurIPS 2025 · LLM · Training-free · 💻[code](https://github.com/Buyun-Liang/SECA)
- **[Robust Hallucination Detection in LLMs via Adaptive Token Selection](http://papers.nips.cc/paper_files/paper/2025/hash/b7c43d4a79dede363a2d061c6158e5a5-Abstract-Conference.html)** · NeurIPS 2025 · LLM · Training-free · 💻[code](https://github.com/mala-lab/HaMI)
- **[Reasoning Models Hallucinate More: Factuality-Aware Reinforcement Learning for Large Reasoning Models](http://papers.nips.cc/paper_files/paper/2025/hash/ddd50f29fa472095515fa0df31749e6c-Abstract-Conference.html)** · NeurIPS 2025 · LLM · Training-based · 💻[code](https://github.com/nusnlp/FSPO)
- **📋 [PHANTOM: A Benchmark for Hallucination Detection in Financial Long-Context QA](http://papers.nips.cc/paper_files/paper/2025/hash/b8badadce3f482ba340ff870f4894441-Abstract-Datasets_and_Benchmarks_Track.html)** · NeurIPS 2025 · LLM · Training-free · 💻[code](https://github.com/ramokz/phantom-camera)
...
- **[Investigating Hallucinations of Time Series Foundation Models through Signal Subspace Analysis](http://papers.nips.cc/paper_files/paper/2025/hash/a5059a9a389ccc76da85760ea79490d8-Abstract-Conference.html)** · NeurIPS 2025 · LLM · Training-free · 💻[code](https://github.com/RohanGd/ExploringTSHallucinations)
...
- **["AGI" team at SHROOM-CAP: Data-Centric Approach to Multilingual Hallucination Detection using XLM-RoBERTa](https://arxiv.org/abs/2511.18301)** · arXiv · LLM · Training-based
- **[Measuring the Impact of Lexical Training Data Coverage on Hallucination Detection in Large Language Models](https://arxiv.org/abs/2511.17946)** · arXiv · LLM · Training-based · 💻[code](https://github.com/WWWonderer/ostd)
- **📋 [MUCH: A Multilingual Claim Hallucination Benchmark](https://arxiv.org/abs/2511.17081)** · arXiv · LLM · Training-free · 💻[code](https://github.com/orailix/much)
- **[CONFIDE: Hallucination Assessment for Reliable Biomolecular Structure Prediction and Design](https://arxiv.org/abs/2512.02033)** · arXiv · LLM · Training-free · 💻[code](https://github.com/Zizaco/confide)
...
- **[HaluMem: Evaluating Hallucinations in Memory Systems of Agents](https://arxiv.org/abs/2511.03506)** · arXiv · LLM · Training-free · 💻[code](https://github.com/MemTensor/HaluMem)
- **[GRAD: Graph-Retrieved Adaptive Decoding for Hallucination Mitigation](https://arxiv.org/abs/2511.03900)** · arXiv · LLM · Training-free · 💻[code](https://github.com/SimplifyJobs/New-Grad-Positions)
- **[COMPASS: Context-Modulated PID Attention Steering System for Hallucination Mitigation](https://arxiv.org/abs/2511.14776)** · arXiv · LLM · Training-free · 💻[code](https://github.com/hyperoslo/Compass)
- **[Zero-knowledge LLM hallucination detection and mitigation through fine-grained cross-model consistency](https://doi.org/10.18653/v1/2025.emnlp-industry.139)** · EMNLP 2025 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[When Models Lie, We Learn: Multilingual Span-Level Hallucination Detection with PsiloQA](https://doi.org/10.18653/v1/2025.findings-emnlp.626)** · EMNLP 2025 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[Unsupervised Hallucination Detection by Inspecting Reasoning Processes](https://doi.org/10.18653/v1/2025.emnlp-main.1124)** · EMNLP 2025 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[Trust Me, I'm Wrong: LLMs Hallucinate with Certainty Despite Knowing the Answer](https://doi.org/10.18653/v1/2025.findings-emnlp.792)** · EMNLP 2025 · LLM · Training-free · 💻[code](https://github.com/technion-cs-nlp/Trust_me_Im_wrong)
- **[The Impact of Negated Text on Hallucination with Large Language Models](https://doi.org/10.18653/v1/2025.emnlp-main.684)** · EMNLP 2025 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[The Illusion of Progress: Re-evaluating Hallucination Detection in LLMs](https://doi.org/10.18653/v1/2025.emnlp-main.1761)** · EMNLP 2025 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[The Hallucination Tax of Reinforcement Finetuning](https://doi.org/10.18653/v1/2025.findings-emnlp.112)** · EMNLP 2025 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[Simple Factuality Probes Detect Hallucinations in Long-Form Natural Language Generation](https://doi.org/10.18653/v1/2025.findings-emnlp.880)** · EMNLP 2025 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[SAFE: A Sparse Autoencoder-Based Framework for Robust Query Enrichment and Hallucination Mitigation in LLMs](https://doi.org/10.18653/v1/2025.findings-emnlp.496)** · EMNLP 2025 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[Representation-based Broad Hallucination Detectors Fail to Generalize Out of Distribution](https://doi.org/10.18653/v1/2025.findings-emnlp.952)** · EMNLP 2025 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[Regularized Contrastive Decoding with Hard Negative Samples for LLM Hallucination Mitigation](https://doi.org/10.18653/v1/2025.findings-emnlp.322)** · EMNLP 2025 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[Mitigating Hallucinations in LM-Based TTS Models via Distribution Alignment Using GFlowNets](https://doi.org/10.18653/v1/2025.emnlp-main.976)** · EMNLP 2025 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[Mitigating Geospatial Knowledge Hallucination in Large Language Models: Benchmarking and Dynamic Factuality Aligning](https://doi.org/10.18653/v1/2025.findings-emnlp.45)** · EMNLP 2025 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **📋 [MedHallu: A Comprehensive Benchmark for Detecting Medical Hallucinations in Large Language Models](https://doi.org/10.18653/v1/2025.emnlp-main.143)** · EMNLP 2025 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[Low-Hallucination and Efficient Coreference Resolution with LLMs](https://doi.org/10.18653/v1/2025.findings-emnlp.934)** · EMNLP 2025 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[Logit Space Constrained Fine-Tuning for Mitigating Hallucinations in LLM-Based Recommender Systems](https://doi.org/10.18653/v1/2025.emnlp-main.1491)** · EMNLP 2025 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[Humans Hallucinate Too: Language Models Identify and Correct Subjective Annotation Errors With Label-in-a-Haystack Prompts](https://doi.org/10.18653/v1/2025.emnlp-main.993)** · EMNLP 2025 · LLM · Training-free · 💻[code](https://github.com/gchochla/liahr)
- **[How Much Do LLMs Hallucinate across Languages? On Realistic Multilingual Estimation of LLM Hallucination](https://doi.org/10.18653/v1/2025.emnlp-main.1481)** · EMNLP 2025 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[Hallucination Detection in Structured Query Generation via LLM Self-Debating](https://doi.org/10.18653/v1/2025.findings-emnlp.873)** · EMNLP 2025 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[Hallucination Detection in LLMs Using Spectral Features of Attention Maps](https://doi.org/10.18653/v1/2025.emnlp-main.1239)** · EMNLP 2025 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[HalluDetect: Detecting, Mitigating, and Benchmarking Hallucinations in Conversational Systems in the Legal Domain](https://doi.org/10.18653/v1/2025.emnlp-industry.128)** · EMNLP 2025 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[HEAL: An Empirical Study on Hallucinations in Embodied Agents Driven by Large Language Models](https://doi.org/10.18653/v1/2025.findings-emnlp.1158)** · EMNLP 2025 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[FG-PRM: Fine-grained Hallucination Detection and Mitigation in Language Model Mathematical Reasoning](https://doi.org/10.18653/v1/2025.findings-emnlp.228)** · EMNLP 2025 · LLM · Training-free · 💻[code](https://github.com/du-nlp-lab/FG-PRM)
- **[FACTCHECKMATE: Preemptively Detecting and Mitigating Hallucinations in LMs](https://doi.org/10.18653/v1/2025.findings-emnlp.663)** · EMNLP 2025 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[Exploring the Generalizability of Factual Hallucination Mitigation via Enhancing Precise Knowledge Utilization](https://doi.org/10.18653/v1/2025.findings-emnlp.211)** · EMNLP 2025 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[Evaluating Evaluation Metrics - The Mirage of Hallucination Detection](https://doi.org/10.18653/v1/2025.findings-emnlp.1035)** · EMNLP 2025 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[Detecting LLM Hallucination Through Layer-wise Information Deficiency: Analysis of Ambiguous Prompts and Unanswerable Questions](https://doi.org/10.18653/v1/2025.emnlp-main.1644)** · EMNLP 2025 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[DeCoRe: Decoding by Contrasting Retrieval Heads to Mitigate Hallucinations](https://doi.org/10.18653/v1/2025.findings-emnlp.531)** · EMNLP 2025 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[Chain-of-Thought Prompting Obscures Hallucination Cues in Large Language Models: An Empirical Evaluation](https://doi.org/10.18653/v1/2025.findings-emnlp.67)** · EMNLP 2025 · LLM · Training-free · 💻[code](https://github.com/ECNU-Text-Computing/cot-hallu-detect)
- **[Calibrating Verbal Uncertainty as a Linear Feature to Reduce Hallucinations](https://doi.org/10.18653/v1/2025.emnlp-main.187)** · EMNLP 2025 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[CCL-XCoT: An Efficient Cross-Lingual Knowledge Transfer Method for Mitigating Hallucination Generation](https://doi.org/10.18653/v1/2025.findings-emnlp.93)** · EMNLP 2025 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[Bridging External and Parametric Knowledge: Mitigating Hallucination of LLMs with Shared-Private Semantic Synergy in Dual-Stream Knowledge](https://doi.org/10.18653/v1/2025.emnlp-main.549)** · EMNLP 2025 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[Bold Claims or Self-Doubt? Factuality Hallucination Type Detection via Belief State](https://doi.org/10.18653/v1/2025.findings-emnlp.527)** · EMNLP 2025 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[Attention-guided Self-reflection for Zero-shot Hallucination Detection in Large Language Models](https://doi.org/10.18653/v1/2025.emnlp-main.1063)** · EMNLP 2025 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[Active Layer-Contrastive Decoding Reduces Hallucination in Large Language Model Generation](https://doi.org/10.18653/v1/2025.emnlp-main.150)** · EMNLP 2025 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[A Head to Predict and a Head to Question: Pre-trained Uncertainty Quantification Heads for Hallucination Detection in LLM Outputs](https://doi.org/10.18653/v1/2025.emnlp-main.1809)** · EMNLP 2025 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[Hallucinations in Bibliographic Recommendation: Citation Frequency as a Proxy for Training Data Redundancy](https://arxiv.org/abs/2510.25378)** · arXiv · LLM · Training-based
- **📚 [Mitigating Hallucination in Large Language Models (LLMs): An Application-Oriented Survey on RAG, Reasoning, and Agentic Systems](https://arxiv.org/abs/2510.24476)** · arXiv · LLM · Training-free · 💻[code](https://github.com/ovxncdev/llm-hallucination-normalization)
- **[HACK: Hallucinations Along Certainty and Knowledge Axes](https://arxiv.org/abs/2510.24222)** · arXiv · LLM · Training-free · 💻[code](https://github.com/source-foundry/Hack)
- **📋 [Challenging Multilingual LLMs: A New Taxonomy and Benchmark for Unraveling Hallucination in Translation](https://arxiv.org/abs/2510.24073)** · arXiv · LLM · Training-free
- **📋 [Confabulations from ACL Publications (CAP): A Dataset for Scientific Hallucination Detection](https://arxiv.org/abs/2510.22395)** · arXiv · LLM · Training-free
...
- **[Credal Transformer: A Principled Approach for Quantifying and Mitigating Hallucinations in Large Language Models](https://arxiv.org/abs/2510.12137)** · arXiv · LLM · Training-free · 💻[code](https://github.com/0riange/Credal-Transformer)
...
- **[Detecting Hallucinations in Authentic LLM-Human Interactions](https://arxiv.org/abs/2510.10539)** · arXiv · LLM · Training-free · 💻[code](https://github.com/TAI-HAMBURG/AuthenHallu)
...
- **[TraceDet: Hallucination Detection from the Decoding Trace of Diffusion Large Language Models](https://arxiv.org/abs/2510.01274)** · arXiv · LLM · Training-free · 💻[code](https://github.com/chang-sx/TraceDet)
...
- **[LUMINA: Detecting Hallucinations in RAG System with Context-Knowledge Signals](https://arxiv.org/abs/2509.21875)** · arXiv · LLM · Training-free · 💻[code](https://github.com/deeplearning-wisc/LUMINA)
...
- **[Beyond Textual Context: Structural Graph Encoding with Adaptive Space Alignment to alleviate the hallucination of LLMs](https://arxiv.org/abs/2509.22251)** · arXiv · LLM · Training-free · 💻[code](https://github.com/yfangZhang/SSKG-LLM)
- **📋 [PerHalluEval: Persian Hallucination Evaluation Benchmark for Large Language Models](https://arxiv.org/abs/2509.21104)** · arXiv · LLM · Training-free
...
- **📚 [LLM-based Agents Suffer from Hallucinations: A Survey of Taxonomy, Methods, and Directions](https://arxiv.org/abs/2509.18970)** · arXiv · LLM · Training-free · 💻[code](https://github.com/nans6/agent-evals)
- **[Confidence-Aware Routing for Large Language Model Reliability Enhancement: A Multi-Signal Approach to Pre-Generation Hallucination Mitigation](https://arxiv.org/abs/2510.01237)** · arXiv · LLM · Training-free · 💻[code](https://github.com/mokumaisancho/question-signal-detector)
- **[Turk-LettuceDetect: A Hallucination Detection Models for Turkish RAG Applications](https://arxiv.org/abs/2509.17671)** · arXiv · LLM · Training-based
- **[A Novel Differential Feature Learning for Effective Hallucination Detection and Classification](https://arxiv.org/abs/2509.21357)** · arXiv · LLM · Training-free · 💻[code](https://github.com/wang748/test_dir)
- **[How Large Language Models are Designed to Hallucinate](https://arxiv.org/abs/2509.16297)** · arXiv · LLM · Training-free
- **[Enhancing Financial RAG with Agentic AI and Multi-HyDE: A Novel Approach to Knowledge Retrieval and Hallucination Reduction](https://arxiv.org/abs/2509.16369)** · arXiv · LLM · Training-free · 💻[code](https://github.com/RadhaRamakantha/DataScience-pml-Project)
...
- **[Knowledge-Driven Hallucination in Large Language Models: An Empirical Study on Process Modeling](https://arxiv.org/abs/2509.15336)** · arXiv · LLM · Training-free · 💻[code](https://github.com/antonov1/process-hallucinations)
...
- **[HalluField: Detecting LLM Hallucinations via Field-Theoretic Modeling](https://arxiv.org/abs/2509.10753)** · arXiv · LLM · Training-free · 💻[code](https://github.com/lanl/hallufield)
...
- **[Real-Time Detection of Hallucinated Entities in Long-Form Generation](https://arxiv.org/abs/2509.03531)** · arXiv · LLM · Training-based · 💻[code](https://github.com/obalcells/hallucination_probes)
- **[An Investigation on Group Query Hallucination Attacks](https://arxiv.org/abs/2508.19321)** · arXiv · LLM · Training-free
- **[QueryBandits for Hallucination Mitigation: Exploiting Semantic Features for No-Regret Rewriting](https://arxiv.org/abs/2508.16697)** · arXiv · LLM · Training-based
- **[Hallucination-Resistant Relation Extraction via Dependency-Aware Sentence Simplification and Two-tiered Hierarchical Refinement](https://arxiv.org/abs/2508.14391)** · arXiv · LLM · Training-based · 💻[code](https://github.com/leiassyun/UnfoldingMap_Pedestrian_NYC)
...
- **[SEVADE: Self-Evolving Multi-Agent Analysis with Decoupled Evaluation for Hallucination-Resistant Irony Detection](https://arxiv.org/abs/2508.06803)** · arXiv · LLM · Training-free · 💻[code](https://github.com/sunbus100/SEVADE)
- **[Counterfactual Probing for Hallucination Detection and Mitigation in Large Language Models](https://arxiv.org/abs/2508.01862)** · arXiv · LLM · Training-based
- **[Multispin Physics of AI Tipping Points and Hallucinations](https://arxiv.org/abs/2508.01097)** · arXiv · LLM · Training-free
- **[Toward Reliable Scientific Hypothesis Generation: Evaluating Truthfulness and Hallucination in Large Language Models](https://doi.org/10.24963/ijcai.2025/873)** · IJCAI 2025 · LLM · Training-free · 💻[code](https://github.com/Teddy-XiongGZ/TruthHypo)
- **[Detecting Hallucination in Large Language Models Through Deep Internal Representation Analysis](https://doi.org/10.24963/ijcai.2025/929)** · IJCAI 2025 · LLM · Training-free · 💻[code](https://github.com/mimiframework/Mimi.jl)
...
- **📋 [MIRAGE-Bench: LLM Agent is Hallucinating and Where to Find Them](https://arxiv.org/abs/2507.21017)** · arXiv · LLM · Training-free · 💻[code](https://github.com/sunblaze-ucb/mirage-bench)
- **[First Hallucination Tokens Are Different from Conditional Ones](https://arxiv.org/abs/2507.20836)** · arXiv · LLM · Training-free · 💻[code](https://github.com/jakobsnl/RAGTruth_Xtended)
- **[FRED: Financial Retrieval-Enhanced Detection and Editing of Hallucinations in Language Models](https://arxiv.org/abs/2507.20930)** · arXiv · LLM · Training-based · 💻[code](https://github.com/pegasi-ai/shield)
...
- **[AutoRAG-LoRA: Hallucination-Triggered Knowledge Retuning via Lightweight Adapters](https://arxiv.org/abs/2507.10586)** · arXiv · LLM · Training-based · 💻[code](https://github.com/kaushikd24/autorag-lora)
...
- **📋 [TreeCut: A Synthetic Unanswerable Math Word Problem Dataset for LLM Hallucination Evaluation](https://doi.org/10.18653/v1/2025.acl-short.84)** · ACL 2025 · LLM · Training-free · 💻[code](https://github.com/j-bagel/treecut-math)
- **[Think More, Hallucinate Less: Mitigating Hallucinations via Dual Process of Fast and Slow Thinking](https://doi.org/10.18653/v1/2025.findings-acl.417)** · ACL 2025 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[The Law of Knowledge Overshadowing: Towards Understanding, Predicting and Preventing LLM Hallucination](https://doi.org/10.18653/v1/2025.findings-acl.1199)** · ACL 2025 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[Stochastic Chameleons: Irrelevant Context Hallucinations Reveal Class-Based (Mis)Generalization in LLMs](https://doi.org/10.18653/v1/2025.acl-long.1458)** · ACL 2025 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
...
- **[On-Policy Self-Alignment with Fine-grained Knowledge Feedback for Hallucination Mitigation](https://doi.org/10.18653/v1/2025.findings-acl.271)** · ACL 2025 · LLM · Training-based · 💻[code](https://github.com/iszhanjiawei/flow_matching_arxiv_daily)
- **[Monitoring Decoding: Mitigating Hallucination via Evaluating the Factuality of Partial Response during Generation](https://doi.org/10.18653/v1/2025.findings-acl.752)** · ACL 2025 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[Long-form Hallucination Detection with Self-elicitation](https://doi.org/10.18653/v1/2025.findings-acl.211)** · ACL 2025 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[Learning Auxiliary Tasks Improves Reference-Free Hallucination Detection in Open-Domain Long-Form Generation](https://doi.org/10.18653/v1/2025.acl-short.93)** · ACL 2025 · LLM · Training-based
- **[ICR Probe: Tracking Hidden State Dynamics for Reliable Hallucination Detection in LLMs](https://doi.org/10.18653/v1/2025.acl-long.880)** · ACL 2025 · LLM · Training-free · 💻[code](https://github.com/imaganarry/SMILES-2026-Hallucination-Detection-Bovt-Anna)
...
- **📋 [HalluLens: LLM Hallucination Benchmark](https://doi.org/10.18653/v1/2025.acl-long.1176)** · ACL 2025 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[HICD: Hallucination-Inducing via Attention Dispersion for Contrastive Decoding to Mitigate Hallucinations in Large Language Models](https://doi.org/10.18653/v1/2025.findings-acl.405)** · ACL 2025 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[HD-NDEs: Neural Differential Equations for Hallucination Detection in LLMs](https://doi.org/10.18653/v1/2025.acl-long.309)** · ACL 2025 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[HALoGEN: Fantastic LLM Hallucinations and Where to Find Them](https://doi.org/10.18653/v1/2025.acl-long.71)** · ACL 2025 · LLM · Training-free · 💻[code](https://github.com/AbhilashaRavichander/HALoGEN)
- **[Explainable Hallucination through Natural Language Inference Mapping](https://doi.org/10.18653/v1/2025.findings-acl.96)** · ACL 2025 · LLM · Training-free · 💻[code](https://github.com/caisa-lab/acl25-halumap)
- **[Evaluating LLMs’ Assessment of Mixed-Context Hallucination Through the Lens of Summarization](https://doi.org/10.18653/v1/2025.findings-acl.847)** · ACL 2025 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[ETF: An Entity Tracing Framework for Hallucination Detection in Code Summaries](https://doi.org/10.18653/v1/2025.acl-long.1480)** · ACL 2025 · LLM · Training-free · 💻[code](https://github.com/zhangsensen/etf-rotation-strategy)
...
- **[Do Robot Snakes Dream like Electric Sheep? Investigating the Effects of Architectural Inductive Biases on Hallucination](https://doi.org/10.18653/v1/2025.findings-acl.60)** · ACL 2025 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[DRAG: Distilling RAG for SLMs from LLMs to Transfer Knowledge and Mitigate Hallucination via Evidence and Graph-based Distillation](https://doi.org/10.18653/v1/2025.acl-long.358)** · ACL 2025 · LLM · Training-free · 💻[code](https://github.com/VILA-Lab/DRAG)
- **📋 [CCHall: A Novel Benchmark for Joint Cross-Lingual and Cross-Modal Hallucinations Detection in Large Language Models](https://doi.org/10.18653/v1/2025.acl-long.1485)** · ACL 2025 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[Beyond Facts: Evaluating Intent Hallucination in Large Language Models](https://doi.org/10.18653/v1/2025.acl-long.349)** · ACL 2025 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
...
- **[Alleviating Hallucinations from Knowledge Misalignment in Large Language Models via Selective Abstention Learning](https://doi.org/10.18653/v1/2025.acl-long.1199)** · ACL 2025 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[Aligning Large Language Models to Follow Instructions and Hallucinate Less via Effective Data Filtering](https://doi.org/10.18653/v1/2025.acl-long.804)** · ACL 2025 · LLM · Training-based · 💻[code](https://github.com/Rook1echen/arxiv-daily)
...
- **[Correcting Hallucinations in News Summaries: Exploration of Self-Correcting LLM Methods with External Knowledge](https://arxiv.org/abs/2506.19607)** · arXiv · LLM · Training-free · 💻[code](https://github.com/jvladika/HalluCorrect)
...
- **[MALM: A Multi-Information Adapter for Large Language Models to Mitigate Hallucination](https://arxiv.org/abs/2506.12483)** · arXiv · LLM · Training-free · 💻[code](https://github.com/glmcdona/MALM)
...
- **[Trustworthy AI for Medicine: Continuous Hallucination Detection and Elimination with CHECK](https://arxiv.org/abs/2506.11129)** · arXiv · LLM · Training-free · 💻[code](https://github.com/Aakash-Tripathi/Aakash-Tripathi)
- **[The impact of fine tuning in LLaMA on hallucinations for named entity extraction in legal documentation](https://arxiv.org/abs/2506.08827)** · arXiv · LLM · Training-based
- **[GOLFer: Smaller LM-Generated Documents Hallucination Filter & Combiner for Query Expansion in Information Retrieval](https://arxiv.org/abs/2506.04762)** · arXiv · LLM · Training-free · 💻[code](https://github.com/liuliuyuan6/GOLFer)
- **[CLATTER: Comprehensive Entailment Reasoning for Hallucination Detection](https://arxiv.org/abs/2506.05243)** · arXiv · LLM · Training-free · 💻[code](https://github.com/throneless-tech/clatter)
...
- **[Mitigating Hallucinated Translations in Large Language Models with Hallucination-focused Preference Optimization](https://doi.org/10.18653/v1/2025.naacl-long.175)** · NAACL 2025 · LLM · Training-based · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[Investigating Hallucinations in Simultaneous Machine Translation: Knowledge Distillation Solution and Components Analysis](https://doi.org/10.18653/v1/2025.naacl-long.364)** · NAACL 2025 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
...
- **[Alleviating Hallucinations of Large Language Models through Induced Hallucinations](https://doi.org/10.18653/v1/2025.findings-naacl.459)** · NAACL 2025 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[A Probabilistic Framework for LLM Hallucination Detection via Belief Tree Propagation](https://doi.org/10.18653/v1/2025.naacl-long.158)** · NAACL 2025 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[From Hallucinations to Jailbreaks: Rethinking the Vulnerability of Large Foundation Models](https://arxiv.org/abs/2505.24232)** · arXiv · LLM · Training-free · 💻[code](https://github.com/BichengLUO/GeometryViewer)
...
- **[VeriTrail: Closed-Domain Hallucination Detection with Traceability](https://arxiv.org/abs/2505.21786)** · arXiv · LLM · Training-free · 💻[code](https://github.com/PolnareffDing/veritrail-verification-core)
...
- **[RePPL: Recalibrating Perplexity by Uncertainty in Semantic Propagation and Language Generation for Explainable QA Hallucination Detection](https://arxiv.org/abs/2505.15386)** · arXiv · LLM · Training-free · 💻[code](https://github.com/appl-team/reppl)
- **[Hallucinate at the Last in Long Response Generation: A Case Study on Long Document Summarization](https://arxiv.org/abs/2505.15291)** · arXiv · LLM · Training-free · 💻[code](https://github.com/MrYangAKAZJM/zjm-0)
- **📋 [MultiHal: Multilingual Dataset for Knowledge-Graph Grounded Evaluation of LLM Hallucinations](https://arxiv.org/abs/2505.14101)** · arXiv · LLM · Training-free · 💻[code](https://github.com/ernlavr/multihal)
- **[Detection and Mitigation of Hallucination in Large Reasoning Models: A Mechanistic Perspective](https://arxiv.org/abs/2505.12886)** · arXiv · LLM · Training-based · 💻[code](https://github.com/Kaike-Zhang/Robust_arXiv_daily)
- **[Reasoning Large Language Model Errors Arise from Hallucinating Critical Problem Features](https://arxiv.org/abs/2505.12151)** · arXiv · LLM · Training-based · 💻[code](https://github.com/Alex223124/high_load_app)
- **[Finetune-RAG: Fine-Tuning Language Models to Resist Hallucination in Retrieval-Augmented Generation](https://arxiv.org/abs/2505.10792)** · arXiv · LLM · Training-based · 💻[code](https://github.com/Pints-AI/Finetune-Bench-RAG)
- **[Eliminating Hallucination-Induced Errors in LLM Code Generation with Functional Clustering](https://arxiv.org/abs/2506.11021)** · arXiv · LLM · Training-free · 💻[code](https://github.com/20ChaituR/functional-clustering)
...
- **[Osiris: A Lightweight Open-Source Hallucination Detection System](https://arxiv.org/abs/2505.04844)** · arXiv · LLM · Training-based · 💻[code](https://github.com/simplifaisoul/osiris)
- **[Triggering Hallucinations in LLMs: A Quantitative Study of Prompt-Induced Hallucination in Large Language Models](https://arxiv.org/abs/2505.00557)** · arXiv · LLM · Training-based
- **📋 [HalluMix: A Task-Agnostic, Multi-Domain Benchmark for Real-World Hallucination Detection](https://arxiv.org/abs/2505.00506)** · arXiv · LLM · Training-free · 💻[code](https://github.com/intoexistence/RAG-Hallumix)
...
- **[Hallucination by Code Generation LLMs: Taxonomy, Benchmarks, Mitigation, and Challenges](https://arxiv.org/abs/2504.20799)** · arXiv · LLM · Training-free · 💻[code](https://github.com/Leeaandrob/arxiv-daily)
- **[Can LLMs Detect Intrinsic Hallucinations in Paraphrasing and Machine Translation?](https://arxiv.org/abs/2504.20699)** · arXiv · LLM · Training-based
...
- **📋 [How to Detect and Defeat Molecular Mirage: A Metric-Driven Benchmark for Hallucination in LLM-based Molecular Comprehension](https://arxiv.org/abs/2504.12314)** · arXiv · LLM · Training-free · 💻[code](https://github.com/XuzhaoLi/ro-arxiv-daily)
- **[HalluciNot: Hallucination Detection Through Context and Common Knowledge Verification](https://arxiv.org/abs/2504.07069)** · arXiv · LLM · Training-free · 💻[code](https://github.com/Shafwansafi06/hallucinot)
...
- **[Noise Augmented Fine Tuning for Mitigating Hallucinations in Large Language Models](https://arxiv.org/abs/2504.03302)** · arXiv · LLM · Training-free · 💻[code](https://github.com/akhadangi/NoiseFiT)
- **[A Unified Virtual Mixture-of-Experts Framework:Enhanced Inference and Hallucination Mitigation in Single-Model System](https://arxiv.org/abs/2504.03739)** · arXiv · LLM · Training-free · 💻[code](https://github.com/liutaocode/TTS-arxiv-daily)
...
- **[CoMT: Chain-of-Medical-Thought Reduces Hallucination in Medical Report Generation](https://doi.org/10.1109/ICASSP49660.2025.10887699)** · ICASSP 2025 · LLM · Training-free · 💻[code](https://github.com/gogoczh/CoMT)
- **[Can Knowledge Editing Really Correct Hallucinations?](https://openreview.net/forum?id=hmDt068MoZ)** · ICLR 2025 · LLM · Training-based · 💻[code](https://github.com/baixianghuang/HalluEditBench)
...
- **[Hyper-RAG: Combating LLM Hallucinations using Hypergraph-Driven Retrieval-Augmented Generation](https://arxiv.org/abs/2504.08758)** · arXiv · LLM · Training-free · 💻[code](https://github.com/tolgahanozdemir7/hyper-rag)
...
- **[Guarding against artificial intelligence--hallucinated citations: the case for full-text reference deposit](https://arxiv.org/abs/2503.19848)** · arXiv · LLM · Training-free · 💻[code](https://github.com/Alex223124/high_load_app)
- **[ShED-HD: A Shannon Entropy Distribution Framework for Lightweight Hallucination Detection on Edge Devices](https://arxiv.org/abs/2503.18242)** · arXiv · LLM · Training-free · 💻[code](https://github.com/aneeshvathul/ShED-HD)
- **📋 [Poly-FEVER: A Multilingual Fact Verification Benchmark for Hallucination Detection in Large Language Models](https://arxiv.org/abs/2503.16541)** · arXiv · LLM · Training-free · 💻[code](https://github.com/HanzhiZhang-Ulrica/Poly-Fever_LLaMA3.1)
...
- **[Medical Hallucinations in Foundation Models and Their Impact on Healthcare](https://arxiv.org/abs/2503.05777)** · arXiv · LLM · Training-based · 💻[code](https://github.com/mitmedialab/medical_hallucination)
- **📋 [Bi'an: A Bilingual Benchmark and Model for Hallucination Detection in Retrieval-Augmented Generation](https://arxiv.org/abs/2502.19209)** · arXiv · LLM · Training-free · 💻[code](https://github.com/OpenSPG/KAG)
...
- **[LettuceDetect: A Hallucination Detection Framework for RAG Applications](https://arxiv.org/abs/2502.17125)** · arXiv · LLM · Training-based · 💻[code](https://github.com/Nyasa13/RAGTruth-LettuceDetect-Evaluation)
...
- **[Detecting LLM Fact-conflicting Hallucinations Enhanced by Temporal-logic-based Reasoning](https://arxiv.org/abs/2502.13416)** · arXiv · LLM · Training-based · 💻[code](https://github.com/mltooling/ci-test)
- **[Valuable Hallucinations: Realizable Non-realistic Propositions](https://arxiv.org/abs/2502.11113)** · arXiv · LLM · Training-free
- **[Smoothing Out Hallucinations: Mitigating LLM Hallucination with Smoothed Knowledge Distillation](https://arxiv.org/abs/2502.11306)** · arXiv · LLM · Training-based
...
- **[MIH-TCCT: Mitigating Inconsistent Hallucinations in LLMs via Event-Driven Text-Code Cyclic Training](https://arxiv.org/abs/2502.08904)** · arXiv · LLM · Training-free · 💻[code](https://github.com/sun-gift/cv-arxiv-daily)
- **[HuDEx: Integrating Hallucination Detection and Explainability for Enhancing the Reliability of LLM responses](https://arxiv.org/abs/2502.08109)** · arXiv · LLM · Training-free · 💻[code](https://github.com/Seosamo/hudex)
- **[Hallucination, Monofacts, and Miscalibration: An Empirical Investigation](https://arxiv.org/abs/2502.08666)** · arXiv · LLM · Training-free · 💻[code](https://github.com/mmiao2/Hallucination)
...
- **[Linear Correlation in LM's Compositional Generalization and Hallucination](https://arxiv.org/abs/2502.04520)** · arXiv · LLM · Training-free · 💻[code](https://github.com/chaowentao/cv-arxiv-daily-old)
...
- **[RaDIO: Real-Time Hallucination Detection with Contextual Index Optimized Query Formulation for Dynamic Retrieval Augmented Generation](https://doi.org/10.1609/aaai.v39i24.34809)** · AAAI 2025 · LLM · Training-free · 💻[code](https://github.com/NVlabs/RADIO)
- **📋 [MedHallBench: A New Benchmark for Assessing Hallucination in Medical Large Language Models](https://proceedings.mlr.press/v281/zuo25b.html)** · AAAI Bridge Program 2025 · LLM · Training-free
...
- **[Improving Factuality in Large Language Models via Decoding-Time Hallucinatory and Truthful Comparators](https://doi.org/10.1609/aaai.v39i24.34751)** · AAAI 2025 · LLM · Training-free · 💻[code](https://github.com/ydk122024/CDT)
...
- **[Enhancing Uncertainty Modeling with Semantic Graph for Hallucination Detection](https://doi.org/10.1609/aaai.v39i22.34528)** · AAAI 2025 · LLM · Training-free · 💻[code](https://github.com/141forever/UncerSema4HalluDetec)
- **📋 [CodeHalu: Investigating Code Hallucinations in LLMs via Execution-based Verification](https://doi.org/10.1609/aaai.v39i24.34717)** · AAAI 2025 · LLM · Training-free · 💻[code](https://github.com/yuchen814/CodeHalu)
- **[Attributive Reasoning for Hallucination Diagnosis of Large Language Models](https://doi.org/10.1609/aaai.v39i22.34536)** · AAAI 2025 · LLM · Training-based
- **[Importing Phantoms: Measuring LLM Package Hallucination Vulnerabilities](https://arxiv.org/abs/2501.19012)** · arXiv · LLM · Training-free · 💻[code](https://github.com/vamshikrishna144/todoWithNode)
- **[Can Hallucinations Help? Boosting LLMs for Drug Discovery](https://arxiv.org/abs/2501.13824)** · arXiv · LLM · Training-free
- **[OnionEval: An Unified Evaluation of Fact-conflicting Hallucination for Small-Large Language Models](https://arxiv.org/abs/2501.12975)** · arXiv · LLM · Training-free · 💻[code](https://github.com/sunchongren/OnionEval)
- **[Hallucination Mitigation using Agentic AI Natural Language-Based Frameworks](https://arxiv.org/abs/2501.13946)** · arXiv · LLM · Training-free · 💻[code](https://github.com/diegogosmar/hall_evaluator)
...
- **[Synthetic Paths to Integral Truth: Mitigating Hallucinations Caused by Confirmation Bias with Synthetic Data](https://aclanthology.org/2025.coling-main.347/)** · COLING 2025 · LLM · Training-based · 💻[code](https://github.com/OccasionallyNLP/Synthetic-Paths-to-Integral-Truth.git)
- **[RoleBreak: Character Hallucination as a Jailbreak Attack in Role-Playing Systems](https://aclanthology.org/2025.coling-main.494/)** · COLING 2025 · LLM · Training-based · 💻[code](https://github.com/Toyhom/RoleBreak)
...
- **[Luna: A Lightweight Evaluation Model to Catch Language Model Hallucinations with High Accuracy and Low Cost](https://aclanthology.org/2025.coling-industry.34/)** · COLING 2025 · LLM · Training-based · 💻[code](https://github.com/tj/luna)
- **📋 [KG-FPQ: Evaluating Factuality Hallucination in LLMs with Knowledge Graph-based False Premise Questions](https://aclanthology.org/2025.coling-main.698/)** · COLING 2025 · LLM · Training-free · 💻[code](https://github.com/yanxuzhu/KG-FPQ)
...
- **[Why and How LLMs Hallucinate: Connecting the Dots with Subsequence Associations](http://papers.nips.cc/paper_files/paper/2025/hash/3255a7554605a88800f4e120b3a929e1-Abstract-Conference.html)** · Unlabeled · LLM · Training-free · 💻[code](https://github.com/sunyiyou/SAT)
- **[Trust Me, I&apos;m Wrong: LLMs Hallucinate with Certainty Despite Knowing the Answer](https://doi.org/10.18653/v1/2025.findings-emnlp.792)** · Other · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[The Map of Misbelief: Tracing Intrinsic and Extrinsic Hallucinations Through Attention Patterns](https://doi.org/10.1609/aaaiss.v7i1.36884)** · Other · LLM · Training-free
- **[RODS: Robust Optimization Inspired Diffusion Sampling for Detecting and Reducing Hallucination in Generative Models](http://papers.nips.cc/paper_files/paper/2025/hash/24c79c21eb699e9efdebaafa40ed0e4d-Abstract-Conference.html)** · Unlabeled · LLM · Training-free · 💻[code](https://github.com/RigsOfRods/rigs-of-rods)
- **[Mitigating Hallucination in VideoLLMs via Temporal-Aware Activation Engineering](http://papers.nips.cc/paper_files/paper/2025/hash/5683583b88da51c79d2eb263f295286e-Abstract-Conference.html)** · Unlabeled · LLM · Training-free
- **[HAD: HAllucination Detection Language Models Based on a Comprehensive Hallucination Taxonomy](https://doi.org/10.18653/v1/2026.acl-industry.11)** · Other · LLM · Training-free · 💻[code](https://github.com/batmanpriv/had)
- **[From Noise to Narrative: Tracing the Origins of Hallucinations in Transformers](http://papers.nips.cc/paper_files/paper/2025/hash/208d6cfa1728ee9e9e56a45fc6ff542c-Abstract-Conference.html)** · Unlabeled · LLM · Training-free
...
- **[WITHDRAWN: Ambiguity processing in Large Language Models: Detection, resolution, and the path to hallucination](https://doi.org/10.1016/j.nlp.2025.100173)** · Natural Language Processing Journal 2025 · LLM · Training-free · 💻[code](https://github.com/Baptiste-Yucca/bot-withdrawn)
...
- **[SymLoc: Symbolic Localization of Hallucination across HaluEval and TruthfulQA](https://doi.org/10.1145/3799830.3799850)** · CODS 2025 · LLM · Training-free · 💻[code](https://github.com/naveen308/SYMLOC)
- **[Shared Imagination: LLMs Hallucinate Alike](https://openreview.net/forum?id=NUXpBMtDYs)** · TMLR 2025 · LLM · Training-based
...
- **[SOK: Exploring Hallucinations and Security Risks in AI-Assisted Software Development with Insights for LLM Deployment](https://doi.org/10.1109/IDSTA66210.2025.11202778)** · IDSTA 2025 · LLM · Training-free · 💻[code](https://github.com/junxzm1990/x86-sok)
...
- **[REFIND at SemEval-2025 Task 3: Retrieval-Augmented Factuality Hallucination Detection in Large Language Models](https://aclanthology.org/2025.semeval-1.2/)** · SemEval@ACL 2025 · LLM · Training-free · 💻[code](https://github.com/oneonlee/REFIND)
...
- **[MultiRAG: A Knowledge-guided Framework for Mitigating Hallucination in Multi-source Retrieval Augmented Generation](https://doi.org/10.1109/ICDE65448.2025.00230)** · ICDE 2025 · LLM · Training-free · 💻[code](https://github.com/wuwenlong123/MultiRAG)
- **[MetaRAG: Metamorphic Testing for Hallucination Detection in RAG Systems](https://ceur-ws.org/Vol-4136/iaai6.pdf)** · IAAI/ALA@ECAI 2025 · LLM · Training-free · 💻[code](https://github.com/JuanDavid2020/MetaRAG_Chatbot)
...
- **[LargePiG for Hallucination-Free Query Generation: Your Large Language Model is Secretly a Pointer Generator](https://doi.org/10.1145/3696410.3714800)** · WWW 2025 · LLM · Training-free · 💻[code](https://github.com/Jeryi-Sun/LargePiG)
...
- **[LLM Hallucinations in Practical Code Generation: Phenomena, Mechanism, and Mitigation](https://doi.org/10.1145/3728894)** · Proc. ACM Softw. Eng. 2025 · LLM · Training-free · 💻[code](https://github.com/DeepSoftwareAnalytics/LLMCodingHallucination)
...
- **[Hallucinations in Code Change to Natural Language Generation: Prevalence and Evaluation of Detection Metrics](https://doi.org/10.18653/v1/2025.ijcnlp-long.137)** · IJCNLP-AACL 2025 · LLM · Training-free · 💻[code](https://github.com/getquoteonline/K825.store-Modern-NSN-Defense-Electronics-Distribution-Hub)
...
- **[Hallucination-Aware Generative Pretrained Transformer for Cooperative Aerial Mobility Control](https://doi.org/10.1109/GLOBECOM59602.2025.11432325)** · GLOBECOM 2025 · LLM · Training-based
...
- **[HalluShift: Measuring Distribution Shifts towards Hallucination Detection in LLMs](https://doi.org/10.1109/IJCNN64981.2025.11228484)** · IJCNN 2025 · LLM · Training-free · 💻[code](https://github.com/sharanya-dasgupta001/hallushift)
...
- **[HalluCounter: Reference-free LLM Hallucination Detection in the Wild!](https://doi.org/10.18653/v1/2025.findings-ijcnlp.20)** · IJCNLP-AACL 2025 · LLM · Training-free · 💻[code](https://github.com/rahulOm9/HalluCounter)
- **[HFuzzer: Testing Large Language Models for Package Hallucinations via Phrase-based Fuzzing](https://doi.org/10.1109/ASE63991.2025.00225)** · ASE 2025 · LLM · Training-free · 💻[code](https://github.com/YukZhao/HFuzzer)
- **[HALO: Hallucination Analysis and Learning Optimization to Empower LLMs with Retrieval-Augmented Context for Guided Clinical Decision Making](https://doi.org/10.1145/3721201.3721385)** · CHASE 2025 · LLM · Training-free · 💻[code](https://github.com/ResponsibleAILab/HALO)
...
- **[GRAVITI: Grounded Retrieval Generation Framework for VideoLLM Hallucination Mitigation](https://doi.org/10.5120/ijca2025926005)** · International Journal of Computer Applications 2025 · LLM · Training-free · 💻[code](https://github.com/Graviti-AI/graviti-python-sdk)
- **[GPTs and Hallucination](https://doi.org/10.1145/3703757)** · Commun. ACM 2025 · LLM · Training-free
- **[GOLFer: Smaller LMs-Generated Documents Hallucination Filter &amp; Combiner for Query Expansion in Information Retrieval](https://doi.org/10.18653/v1/2025.findings-acl.8)** · Comput. Linguistics 2025 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[Fine-Tuned Large Language Models for Logical Translation: Reducing Hallucinations with Lang2Logic](https://doi.org/10.1109/ISNCC66965.2025.11250432)** · ISNCC 2025 · LLM · Training-based
...
- **[FAITH: A Framework for Assessing Intrinsic Tabular Hallucinations in Finance](https://doi.org/10.1145/3768292.3770433)** · ICAIF 2025 · LLM · Training-free · 💻[code](https://github.com/wangyuanbiubiubiu/FaithFusion)
- **[Exploring Causal Effect of Social Bias on Faithfulness Hallucinations in Large Language Models](https://doi.org/10.1145/3746252.3761298)** · CIKM 2025 · LLM · Training-free · 💻[code](https://github.com/XavierZhang2002/BID)
...
- **[ECD: Efficient Contrastive Decoding with Probabilistic Hallucination Detection](https://doi.org/10.1007/978-3-032-06109-6_2)** · ECML/PKDD 2025 · LLM · Training-free · 💻[code](https://github.com/yuweiyang-anu/ECD)
...
- **📋 [ChartInsighter: An Approach for Mitigating Hallucination in Time-series Chart Summary Generation with A Benchmark Dataset](https://doi.org/10.1109/TVCG.2025.3567122)** · IEEE Trans. Vis. Comput. Graph. 2025 · LLM · Training-free · 💻[code](https://github.com/wangfen01/ChartInsighter)
- **[Catch Me if You Search: When Contextual Web Search Results Affect the Detection of Hallucinations](https://doi.org/10.1016/j.chb.2025.108763)** · Comput. Hum. Behav. 2025 · LLM · Training-free · 💻[code](https://github.com/MahjabinNahar/CatchMeIfYouSearch)
...
- **[CHAIR-Classifier of Hallucination As Improver](https://doi.org/10.1109/IJCNN64981.2025.11227344)** · IJCNN 2025 · LLM · Training-free · 💻[code](https://github.com/eggachecat/CHAIR)
...
- **[AraHalluEval: A Fine-grained Hallucination Evaluation Framework for Arabic LLMs](https://doi.org/10.18653/v1/2025.arabicnlp-main.12)** · Third Arabic Natural Language Processing Conference 2025 · LLM · Training-free · 💻[code](https://github.com/aishaalansari57/AraHalluEval)
- **[An Analysis on AI Hallucination from the Perspective of Media Archaeology](https://doi.org/10.54254/2753-7064/2025.bj29177)** · Communications in Humanities Research 2025 · LLM · Training-free · 💻[code](https://github.com/genecast-2025/ctDNA-analysis-from-the-Evidence-trial)
- **[AggTruth: Contextual Hallucination Detection using Aggregated Attention Scores in LLMs](https://doi.org/10.1007/978-3-031-97570-7_18)** · ICCS 2025 · LLM · Training-free · 💻[code](https://github.com/janeliasz/aggtruth-insight-hub)
- **[Agentic Legal Intake: A Multi-Agent Framework For Hallucination-Free, Audit-Ready AI Screening In Mass-Tort Litigation](https://doi.org/10.37547/feaiml/volume02issue09-02)** · Frontiers in Emerging Artificial Intelligence and Machine Learning 2025 · LLM · Training-free · 💻[code](https://github.com/amiaopensource/analog-inspection)
- **[Aftina: enhancing stability and preventing hallucination in AI-based Islamic fatwa generation using LLMs and RAG](https://doi.org/10.1007/s00521-025-11229-y)** · Neural Comput. Appl. 2025 · LLM · Training-free · 💻[code](https://github.com/chaimahorcheni-maker/aftina)
...
<details>
<summary>📅 2024 · 250 papers</summary>
...
- **[THaMES: An End-to-End Tool for Hallucination Mitigation and Evaluation in Large Language Models](https://arxiv.org/abs/2409.11353)** · NeurIPS 2024 · LLM · Training-based · 💻[code](https://github.com/AI-Stuff/hudson-and-thames-research)
- **[Looks Too Good To Be True: An Information-Theoretic Analysis of Hallucinations in Generative Restoration Models](http://papers.nips.cc/paper_files/paper/2024/hash/2847d43f17410c5beb25b2736c3ae778-Abstract-Conference.html)** · NeurIPS 2024 · LLM · Training-free
- **[Leveraging Hallucinations to Reduce Manual Prompt Dependency in Promptable Segmentation](http://papers.nips.cc/paper_files/paper/2024/hash/c1e1ad233411e25b54bb5df3a0576c2c-Abstract-Conference.html)** · NeurIPS 2024 · LLM · Training-free · 💻[code](https://github.com/lwpyh/ProMaC_code)
- **[LLM-Check: Investigating Detection of Hallucinations in Large Language Models](http://papers.nips.cc/paper_files/paper/2024/hash/3c1e1fdf305195cd620c118aaa9717ad-Abstract-Conference.html)** · NeurIPS 2024 · LLM · Training-free · 💻[code](https://github.com/GaurangSriramanan/LLM_Check_Hallucination_Detection)
- **[HaloScope: Harnessing Unlabeled LLM Generations for Hallucination Detection](http://papers.nips.cc/paper_files/paper/2024/hash/ba92705991cfbbcedc26e27e833ebbae-Abstract-Conference.html)** · NeurIPS 2024 · LLM · Training-free · 💻[code](https://github.com/deeplearning-wisc/haloscope)
- **[Estimating the Hallucination Rate of Generative AI](http://papers.nips.cc/paper_files/paper/2024/hash/3791f5fc0e8e43730466afd2bcdb7493-Abstract-Conference.html)** · NeurIPS 2024 · LLM · Training-free
- **📋 [ERBench: An Entity-Relationship based Automatically Verifiable Hallucination Benchmark for Large Language Models](http://papers.nips.cc/paper_files/paper/2024/hash/5ef9853a6cdea40ae3e301a6d8dc32b5-Abstract-Datasets_and_Benchmarks_Track.html)** · NeurIPS 2024 · LLM · Training-free · 💻[code](https://github.com/erbench/erbench)
...
- **📋 [DAHL: Domain-specific Automated Hallucination Evaluation of Long-Form Text through a Benchmark Dataset in Biomedicine](https://arxiv.org/abs/2411.09255)** · arXiv · LLM · Training-free · 💻[code](https://github.com/rldv1/dahl)
- **[DecoPrompt : Decoding Prompts Reduces Hallucinations when Large Language Models Meet False Premises](https://arxiv.org/abs/2411.07457)** · arXiv · LLM · Training-free · 💻[code](https://github.com/xunannancy/DecoPrompt)
- **[Prompt-Efficient Fine-Tuning for GPT-like Deep Models to Reduce Hallucination and to Improve Reproducibility in Scientific Text Generation Using Stochastic Optimisation Techniques](https://arxiv.org/abs/2411.06445)** · arXiv · LLM · Training-based
...
- **[Zero-Resource Hallucination Prevention for Large Language Models](https://doi.org/10.18653/v1/2024.findings-emnlp.204)** · EMNLP 2024 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[Whispers that Shake Foundations: Analyzing and Mitigating False Premise Hallucinations in Large Language Models](https://doi.org/10.18653/v1/2024.emnlp-main.155)** · EMNLP 2024 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[Two-tiered Encoder-based Hallucination Detection for Retrieval-Augmented Generation in the Wild](https://doi.org/10.18653/v1/2024.emnlp-industry.2)** · EMNLP 2024 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **📋 [ToolBeHonest: A Multi-level Hallucination Diagnostic Benchmark for Tool-Augmented Large Language Models](https://doi.org/10.18653/v1/2024.emnlp-main.637)** · EMNLP 2024 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
...
- **[Multilingual Fine-Grained News Headline Hallucination Detection](https://doi.org/10.18653/v1/2024.findings-emnlp.461)** · EMNLP 2024 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[Mitigating Open-Vocabulary Caption Hallucinations](https://doi.org/10.18653/v1/2024.emnlp-main.1263)** · EMNLP 2024 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[Mitigating Hallucinations of Large Language Models in Medical Information Extraction via Contrastive Decoding](https://doi.org/10.18653/v1/2024.findings-emnlp.456)** · EMNLP 2024 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[Mitigating Hallucination in Fictional Character Role-Play](https://doi.org/10.18653/v1/2024.findings-emnlp.846)** · EMNLP 2024 · LLM · Training-free · 💻[code](https://github.com/NafisSadeq/rolefact.git)
- **[Medico: Towards Hallucination Detection and Correction with Multi-source Evidence Fusion](https://doi.org/10.18653/v1/2024.emnlp-demo.4)** · EMNLP 2024 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[Mechanistic Understanding and Mitigation of Language Model Non-Factual Hallucinations](https://doi.org/10.18653/v1/2024.findings-emnlp.466)** · EMNLP 2024 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[Machine Translation Hallucination Detection for Low and High Resource Languages using Large Language Models](https://doi.org/10.18653/v1/2024.findings-emnlp.564)** · EMNLP 2024 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[Lookback Lens: Detecting and Mitigating Contextual Hallucinations in Large Language Models Using Only Attention Maps](https://doi.org/10.18653/v1/2024.emnlp-main.84)** · EMNLP 2024 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[Knowledge-Centric Hallucination Detection](https://doi.org/10.18653/v1/2024.emnlp-main.395)** · EMNLP 2024 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[Knowledge Verification to Nip Hallucination in the Bud](https://doi.org/10.18653/v1/2024.emnlp-main.152)** · EMNLP 2024 · LLM · Training-free · 💻[code](https://github.com/fanqiwan/KCA)
- **[HalluMeasure: Fine-grained Hallucination Measurement Using Chain-of-Thought Reasoning](https://doi.org/10.18653/v1/2024.emnlp-main.837)** · EMNLP 2024 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[Enhanced Hallucination Detection in Neural Machine Translation through Simple Detector Aggregation](https://doi.org/10.18653/v1/2024.emnlp-main.1033)** · EMNLP 2024 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
...
- **[Beyond Fine-Tuning: Effective Strategies for Mitigating Hallucinations in Large Language Models for Data Analytics](https://arxiv.org/abs/2410.20024)** · arXiv · LLM · Training-based
- **[Investigating the Role of Prompting and External Tools in Hallucination Rates of Large Language Models](https://arxiv.org/abs/2410.19385)** · arXiv · LLM · Training-based
- **[A Debate-Driven Experiment on LLM Hallucinations and Accuracy](https://arxiv.org/abs/2410.19485)** · arXiv · LLM · Training-based · 💻[code](https://github.com/IgnacioValenzuelaM/Smina_Redocking)
...
- **[Large Language Models Powered Multiagent Ensemble for Mitigating Hallucination and Efficient Atrial Fibrillation Annotation of ECG Reports](https://arxiv.org/abs/2410.16543)** · arXiv · LLM · Training-free · 💻[code](https://github.com/vamshikrishna144/todoWithNode)
...
- **[Iter-AHMCL: Alleviate Hallucination for Large Language Model via Iterative Model-level Contrastive Learning](https://arxiv.org/abs/2410.12130)** · arXiv · LLM · Training-based
...
- **[LRP4RAG: Detecting Hallucinations in Retrieval-Augmented Generation via Layer-wise Relevance Propagation](https://arxiv.org/abs/2408.15533)** · arXiv · LLM · Training-free · 💻[code](https://github.com/Tomsawyerhu/LRP4RAG)
...
- **[SLM Meets LLM: Balancing Latency, Interpretability and Consistency in Hallucination Detection](https://arxiv.org/abs/2408.12748)** · arXiv · LLM · Training-free · 💻[code](https://github.com/Alex223124/high_load_app)
...
- **[Lower Layers Matter: Alleviating Hallucination via Multi-Layer Fusion Contrastive Decoding with Truthfulness Refocused](https://arxiv.org/abs/2408.08769)** · arXiv · LLM · Training-free · 💻[code](https://github.com/Xuchen-Li/cv-arxiv-daily)
...
- **📋 [Order Matters in Hallucination: Reasoning Order as Benchmark and Reflexive Prompting for Large-Language-Models](https://arxiv.org/abs/2408.05093)** · arXiv · LLM · Training-free · 💻[code](https://github.com/XieZikai/ReflexivePrompting)
- **[FiSTECH: Financial Style Transfer to Enhance Creativity without Hallucinations in LLMs](https://arxiv.org/abs/2408.05365)** · arXiv · LLM · Training-free · 💻[code](https://github.com/pandeyreah09-stack/fistech)
- **[On Early Detection of Hallucinations in Factual Question Answering](https://doi.org/10.1145/3637528.3671796)** · KDD 2024 · LLM · Training-free · 💻[code](https://github.com/johnnyzheng0636/llm_hallucinations_reimplementation)
- **[Honest AI: Fine-Tuning "Small" Language Models to Say "I Don't Know", and Reducing Hallucination in RAG](https://arxiv.org/abs/2410.09699)** · KDD 2024 · LLM · Training-based
- **[FactCHD: Benchmarking Fact-Conflicting Hallucination Detection](https://www.ijcai.org/proceedings/2024/687)** · IJCAI 2024 · LLM · Training-free · 💻[code](https://github.com/zjunlp/FactCHD)
- **[Controlled Automatic Task-Specific Synthetic Data Generation for Hallucination Detection](https://arxiv.org/abs/2410.12278)** · KDD 2024 · LLM · Training-based
...
- **[Halu-J: Critique-Based Hallucination Judge](https://arxiv.org/abs/2407.12943)** · arXiv · LLM · Training-free · 💻[code](https://github.com/GAIR-NLP/factool)
- **[Look Within, Why LLMs Hallucinate: A Causal Perspective](https://arxiv.org/abs/2407.10153)** · arXiv · LLM · Training-free · 💻[code](https://github.com/MrYangAKAZJM/zjm-0)
- **[Lynx: An Open Source Hallucination Evaluation Model](https://arxiv.org/abs/2407.08488)** · arXiv · LLM · Training-free · 💻[code](https://github.com/lynx-family/lynx-website)
...
- **[Unsupervised Real-Time Hallucination Detection based on the Internal States of Large Language Models](https://doi.org/10.18653/v1/2024.findings-acl.854)** · ACL 2024 · LLM · Training-based · 💻[code](https://github.com/Rivas-AI/HalluDetect)
- **[TruthX: Alleviating Hallucinations by Editing Large Language Models in Truthful Space](https://doi.org/10.18653/v1/2024.acl-long.483)** · ACL 2024 · LLM · Training-free · 💻[code](https://github.com/ictnlp/TruthX)
- **[Truth-O-Meter: Handling Multiple Inconsistent Sources Repairing LLM Hallucinations](https://doi.org/10.1145/3626772.3657679)** · SIGIR 2024 · LLM · Training-free · 💻[code](https://github.com/bgalitsky/Truth-O-Meter-Making-ChatGPT-Truthful)
...
- **[TimeChara: Evaluating Point-in-Time Character Hallucination of Role-Playing Large Language Models](https://doi.org/10.18653/v1/2024.findings-acl.197)** · ACL 2024 · LLM · Training-free · 💻[code](https://github.com/ahnjaewoo/timechara)
- **[The Dawn After the Dark: An Empirical Study on Factuality Hallucination in Large Language Models](https://doi.org/10.18653/v1/2024.acl-long.586)** · ACL 2024 · LLM · Training-free · 💻[code](https://github.com/RUCAIBox/HaluEval-2.0)
...
- **[Self-Alignment for Factuality: Mitigating Hallucinations in LLMs via Self-Evaluation](https://doi.org/10.18653/v1/2024.acl-long.107)** · ACL 2024 · LLM · Training-based
...
- **[On the Hallucination in Simultaneous Machine Translation](https://doi.org/10.18653/v1/2024.acl-short.66)** · ACL 2024 · LLM · Training-free · 💻[code](https://github.com/zhongmz/SiMT-Hallucination)
- **[OTTAWA: Optimal TransporT Adaptive Word Aligner for Hallucination and Omission Translation Errors Detection](https://doi.org/10.18653/v1/2024.findings-acl.377)** · ACL 2024 · LLM · Training-free · 💻[code](https://github.com/BikeOttawa/OSM-Bike-Ottawa-Tagging-Guide)
...
- **[InterrogateLLM: Zero-Resource Hallucination Detection in LLM-Generated Answers](https://arxiv.org/abs/2403.02889)** · ACL 2024 · LLM · Training-free · 💻[code](https://github.com/yakir-yehuda/InterrogateLLM)
- **[In-Context Sharpness as Alerts: An Inner Representation Perspective for Hallucination Mitigation](https://proceedings.mlr.press/v235/chen24av.html)** · ICML 2024 · LLM · Training-free · 💻[code](https://github.com/hkust-nlp/Activation_Decoding)
- **[How Language Model Hallucinations Can Snowball](https://proceedings.mlr.press/v235/zhang24ay.html)** · ICML 2024 · LLM · Training-free · 💻[code](https://github.com/AlexBraverman/ExplanatoryPrompting)
- **[Genetic Approach to Mitigate Hallucination in Generative IR](https://arxiv.org/abs/2409.00085)** · SIGIR 2024 · LLM · Training-free
- **[Enhancing Hallucination Detection through Perturbation-Based Synthetic Data Generation in System Responses](https://doi.org/10.18653/v1/2024.findings-acl.789)** · ACL 2024 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
...
- **[Confabulation: The Surprising Value of Large Language Model Hallucinations](https://doi.org/10.18653/v1/2024.acl-long.770)** · ACL 2024 · LLM · Training-free · 💻[code](https://github.com/pgliaskovitis/confabulation-engine)
- **[Coarse-to-Fine Highlighting: Reducing Knowledge Hallucination in Large Language Models](https://proceedings.mlr.press/v235/lv24c.html)** · ICML 2024 · LLM · Training-free
...
- **[ANHALTEN: Cross-Lingual Transfer for German Token-Level Reference-Free Hallucination Detection](https://doi.org/10.18653/v1/2024.acl-srw.18)** · ACL 2024 · LLM · Training-free · 💻[code](https://github.com/janekh24/anhalten)
- **[ANAH: Analytical Annotation of Hallucinations in Large Language Models](https://doi.org/10.18653/v1/2024.acl-long.442)** · ACL 2024 · LLM · Training-based · 💻[code](https://github.com/open-compass/ANAH)
- **[ACUEval: Fine-grained Hallucination Evaluation and Correction for Abstractive Summarization](https://doi.org/10.18653/v1/2024.findings-acl.597)** · ACL 2024 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[PFME: A Modular Approach for Fine-grained Hallucination Detection and Editing of Large Language Models](https://arxiv.org/abs/2407.00488)** · arXiv · LLM · Training-free · 💻[code](https://github.com/Neal006/pfme)
- **[Banishing LLM Hallucinations Requires Rethinking Generalization](https://arxiv.org/abs/2406.17642)** · arXiv · LLM · Training-based · 💻[code](https://github.com/iszhanjiawei/TTS_arxiv_daily)
- **[Semantic Entropy Probes: Robust and Cheap Hallucination Detection in LLMs](https://arxiv.org/abs/2406.15927)** · arXiv · LLM · Training-free · 💻[code](https://github.com/Kaike-Zhang/Robust_arXiv_daily)
...
- **[PoLLMgraph: Unraveling Hallucinations in Large Language Models via State Transition Dynamics](https://doi.org/10.18653/v1/2024.findings-naacl.294)** · NAACL 2024 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
...
- **📚 [Can Knowledge Graphs Reduce Hallucinations in LLMs? : A Survey](https://doi.org/10.18653/v1/2024.naacl-long.219)** · NAACL 2024 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[ALOHa: A New Measure for Hallucination in Captioning Models](https://doi.org/10.18653/v1/2024.naacl-short.30)** · NAACL 2024 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
...
- **[Detecting Hallucinations in Large Language Model Generation: A Token Probability Approach](https://arxiv.org/abs/2405.19648)** · arXiv · LLM · Training-free · 💻[code](https://github.com/Baylor-AI/HalluDetect)
...
- **📋 [RefChecker: Reference-based Fine-grained Hallucination Checker and Benchmark for Large Language Models](https://arxiv.org/abs/2405.14486)** · arXiv · LLM · Training-free · 💻[code](https://github.com/amazon-science/RefChecker)
- **[Mitigating Hallucinations in Large Language Models via Self-Refinement-Enhanced Knowledge Retrieval](https://arxiv.org/abs/2405.06545)** · arXiv · LLM · Training-free · 💻[code](https://github.com/chaowentao/cv-arxiv-daily-old)
- **[Can a Hallucinating Model help in Reducing Human "Hallucination"?](https://arxiv.org/abs/2405.00843)** · arXiv · LLM · Training-free
- **[Addressing Topic Granularity and Hallucination in Large Language Models for Topic Modelling](https://arxiv.org/abs/2405.00611)** · arXiv · LLM · Training-based · 💻[code](https://github.com/GateNLP/TopicLLM_Granularity_Hallucination)
- **📚 [A Survey of Automatic Hallucination Evaluation on Natural Language Generation](https://arxiv.org/abs/2404.12041)** · arXiv · LLM · Training-free · 💻[code](https://github.com/KNZLink/KNZLink)
- **[Uncertainty-Based Abstention in LLMs Improves Safety and Reduces Hallucinations](https://arxiv.org/abs/2404.10960)** · arXiv · LLM · Training-based
- **[Constructing Benchmarks and Interventions for Combating Hallucinations in LLMs](https://arxiv.org/abs/2404.09971)** · arXiv · LLM · Training-free · 💻[code](https://github.com/technion-cs-nlp/hallucination-mitigation)
...
- **📋 [The Hallucinations Leaderboard -- An Open Effort to Measure Hallucinations in Large Language Models](https://arxiv.org/abs/2404.05904)** · arXiv · LLM · Training-free
- **[Mitigating LLM Hallucinations via Conformal Abstention](https://arxiv.org/abs/2405.01563)** · arXiv · LLM · Training-free · 💻[code](https://github.com/SebAustin/fsi-compliance-agent)
...
- **[DoLa: Decoding by Contrasting Layers Improves Factuality in Large Language Models](https://openreview.net/forum?id=Th6NyL07na)** · ICLR 2024 · LLM · Training-free · 💻[code](https://github.com/voidism/DoLa)
...
- **[FACTOID: FACtual enTailment fOr hallucInation Detection](https://arxiv.org/abs/2403.19113)** · arXiv · LLM · Training-free · 💻[code](https://github.com/chentong0/factoid-wiki)
- **["Sorry, Come Again?" Prompting -- Enhancing Comprehension and Diminishing Hallucination with \[PAUSE\]-injected Optimal Paraphrasing](https://arxiv.org/abs/2403.18976)** · arXiv · LLM · Training-based
- **[Zero-Shot Multi-task Hallucination Detection](https://arxiv.org/abs/2403.12244)** · arXiv · LLM · Training-free
- **[Enhancing LLM Factual Accuracy with RAG to Counter Hallucinations: A Case Study on Domain-Specific Queries in Private Knowledge-Bases](https://arxiv.org/abs/2403.10446)** · arXiv · LLM · Training-free · 💻[code](https://github.com/Kaike-Zhang/Robust_arXiv_daily)
- **[DiffMAC: Diffusion Manifold Hallucination Correction for High Generalization Blind Face Restoration](https://arxiv.org/abs/2403.10098)** · arXiv · LLM · Training-free · 💻[code](https://github.com/iszhanjiawei/dubbing-dubber-arxiv-daily)
- **[HaluEval-Wild: Evaluating Hallucinations of Language Models in the Wild](https://arxiv.org/abs/2403.04307)** · arXiv · LLM · Training-free · 💻[code](https://github.com/HaluEval-Wild/HaluEval-Wild)
- **[Mitigating Hallucinations and Off-target Machine Translation with Source-Contrastive and Language-Contrastive Decoding](https://doi.org/10.18653/v1/2024.eacl-short.4)** · EACL 2024 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **📋 [HypoTermQA: Hypothetical Terms Dataset for Benchmarking Hallucination Tendency of LLMs](https://doi.org/10.18653/v1/2024.eacl-srw.9)** · EACL 2024 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[Contrastive Decoding Reduces Hallucinations in Large Multilingual Machine Translation Models](https://doi.org/10.18653/v1/2024.eacl-long.155)** · EACL 2024 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[Ask, Assess, and Refine: Rectifying Factual Consistency and Hallucination in LLMs with Metric-Guided Feedback Learning](https://doi.org/10.18653/v1/2024.eacl-long.149)** · EACL 2024 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
...
- **[Hallucinations or Attention Misdirection? The Path to Strategic Value Extraction in Business Using Large Language Models](https://arxiv.org/abs/2402.14002)** · arXiv · LLM · Training-free · 💻[code](https://github.com/Muxaline/Renewable-Energy-Optimization)
- **[Using Hallucinations to Bypass GPT4's Filter](https://arxiv.org/abs/2403.04769)** · arXiv · LLM · Training-based
- **[Measuring and Reducing LLM Hallucination without Gold-Standard Answers](https://arxiv.org/abs/2402.10412)** · arXiv · LLM · Training-free · 💻[code](https://github.com/liutaocode/TTS-arxiv-daily)
...
- **[Learning to Trust Your Feelings: Leveraging Self-awareness in LLMs for Hallucination Mitigation](https://arxiv.org/abs/2401.15449)** · arXiv · LLM · Training-based · 💻[code](https://github.com/wang748/test_dir)
...
- **[Fine-grained Hallucination Detection and Editing for Language Models](https://arxiv.org/abs/2401.06855)** · arXiv · LLM · Training-based · 💻[code](https://github.com/abhika-m/FAVA)
- **[Navigating Uncertainty: Optimizing API Dependency for Hallucination Reduction in Closed-Book Question Answering](https://arxiv.org/abs/2401.01780)** · arXiv · LLM · Training-based
- **[Large Legal Fictions: Profiling Legal Hallucinations in Large Language Models](https://arxiv.org/abs/2401.01301)** · arXiv · LLM · Training-free · 💻[code](https://github.com/kaeve1/Rag-Assistant-for-Brazilian-legislation)
- **📚 [A Comprehensive Survey of Hallucination Mitigation Techniques in Large Language Models](https://arxiv.org/abs/2401.01313)** · arXiv · LLM · Training-free
- **[INSIDE: LLMs&apos; Internal States Retain the Power of Hallucination Detection](https://openreview.net/forum?id=Zj12nzlQbz)** · Unlabeled · LLM · Training-free · 💻[code](https://github.com/nteract/hydrogen)
- **[Hallucination Detection in Virtually-Stained Histology: A Latent Space Baseline](https://doi.org/10.1109/tmi.2026.3720925)** · Other · LLM · Training-free
- **[Do Language Models Know When They&apos;re Hallucinating References?](https://doi.org/10.18653/v1/2024.findings-eacl.62)** · Other · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
...
- **[The Problem of AI Hallucination and How to Solve It](https://doi.org/10.34190/ecel.23.1.2584)** · European Conference on e-Learning 2024 · LLM · Training-free · 💻[code](https://github.com/Aryia-Behroziuan/References)
...
- **[TU Wien at SemEval-2024 Task 6: Unifying Model-Agnostic and Model-Aware Techniques for Hallucination Detection](https://doi.org/10.18653/v1/2024.semeval-1.173)** · SemEval@NAACL 2024 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[SmurfCat at SemEval-2024 Task 6: Leveraging Synthetic Data for Hallucination Detection](https://doi.org/10.18653/v1/2024.semeval-1.125)** · SemEval@NAACL 2024 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[SemEval-2024 Task 6: SHROOM, a Shared-task on Hallucinations and Related Observable Overgeneration Mistakes](https://doi.org/10.18653/v1/2024.semeval-1.273)** · SemEval@NAACL 2024 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
...
- **[NU-RU at SemEval-2024 Task 6: Hallucination and Related Observable Overgeneration Mistake Detection Using Hypothesis-Target Similarity and SelfCheckGPT](https://doi.org/10.18653/v1/2024.semeval-1.39)** · SemEval@NAACL 2024 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
...
- **[Maha Bhaashya at SemEval-2024 Task 6: Zero-Shot Multi-task Hallucination Detection](https://doi.org/10.18653/v1/2024.semeval-1.241)** · SemEval@NAACL 2024 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **📋 [MASSIVE Multilingual Abstract Meaning Representation: A Dataset and Baselines for Hallucination Detection](https://doi.org/10.18653/v1/2024.starsem-1.1)** · 13th Joint Conference on Lexical and Computational Semantics (*SEM 2024) 2024 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[MARiA at SemEval 2024 Task-6: Hallucination Detection Through LLMs, MNLI, and Cosine similarity](https://doi.org/10.18653/v1/2024.semeval-1.225)** · SemEval@NAACL 2024 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[MALTO at SemEval-2024 Task 6: Leveraging Synthetic Data for LLM Hallucination Detection](https://doi.org/10.18653/v1/2024.semeval-1.240)** · SemEval@NAACL 2024 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[LP-LM: No Hallucinations in Question Answering with Logic Programming](https://doi.org/10.4204/EPTCS.416.5)** · ICLP 2024 · LLM · Training-free · 💻[code](https://github.com/katherinewu312/lp-lm)
- **[LLM Internal States Reveal Hallucination Risk Faced With a Query](https://doi.org/10.18653/v1/2024.blackboxnlp-1.6)** · NN 2024 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[IRIT-Berger-Levrault at SemEval-2024: How Sensitive Sentence Embeddings are to Hallucinations?](https://doi.org/10.18653/v1/2024.semeval-1.86)** · SemEval@NAACL 2024 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[Halwasa: Quantify and Analyze Hallucinations in Large Language Models: Arabic as a Case Study](https://aclanthology.org/2024.lrec-main.705)** · LREC/COLING 2024 · LLM · Training-free · 💻[code](https://github.com/mohamedmorh/pause_halwasa_4)
- **[Halu-NLP at SemEval-2024 Task 6: MetaCheckGPT - A Multi-task Hallucination Detection using LLM uncertainty and meta-models](https://doi.org/10.18653/v1/2024.semeval-1.52)** · SemEval@NAACL 2024 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[HalluSafe at SemEval-2024 Task 6: An NLI-based Approach to Make LLMs Safer by Better Detecting Hallucinations and Overgeneration Mistakes](https://doi.org/10.18653/v1/2024.semeval-1.22)** · SemEval@NAACL 2024 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
...
- **[DeepPavlov at SemEval-2024 Task 6: Detection of Hallucinations and Overgeneration Mistakes with an Ensemble of Transformer-based Models](https://doi.org/10.18653/v1/2024.semeval-1.42)** · SemEval@NAACL 2024 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[DUTh at SemEval-2024 Task 6: Comparing Pre-trained Models on Sentence Similarity Evaluation for Detecting of Hallucinations and Related Observable Overgeneration Mistakes](https://doi.org/10.18653/v1/2024.semeval-1.154)** · 18th International Workshop on Semantic Evaluation (SemEval-2024) 2024 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[DAHRS: Divergence-Aware Hallucination-Remediated SRL Projection](https://doi.org/10.1007/978-3-031-70239-6_29)** · NLDB 2024 · LLM · Training-free · 💻[code](https://github.com/dahrs/dahrs)
...
- **[Compos Mentis at SemEval2024 Task6: A Multi-Faceted Role-based Large Language Model Ensemble to Detect Hallucination](https://doi.org/10.18653/v1/2024.semeval-1.208)** · SemEval@NAACL 2024 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **📚 [Cognitive Mirage: A Review of Hallucinations in Large Language Models](https://ceur-ws.org/Vol-3818/paper2.pdf)** · LKM@IJCAI 2024 · LLM · Training-free
...
- **[AILS-NTUA at SemEval-2024 Task 6: Efficient model tuning for hallucination detection and analysis](https://doi.org/10.18653/v1/2024.semeval-1.222)** · 18th International Workshop on Semantic Evaluation (SemEval-2024) 2024 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
...
<details>
<summary>📅 2023 · 26 papers</summary>
...
- **[KCTS: Knowledge-Constrained Tree Search Decoding with Token-Level Hallucination Detection](https://doi.org/10.18653/v1/2023.emnlp-main.867)** · EMNLP 2023 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[Hallucination Detection for Grounded Instruction Generation](https://doi.org/10.18653/v1/2023.findings-emnlp.266)** · EMNLP 2023 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **📋 [HalOmi: A Manually Annotated Benchmark for Multilingual Hallucination and Omission Detection in Machine Translation](https://doi.org/10.18653/v1/2023.emnlp-main.42)** · EMNLP 2023 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
...
- **[HADES: Hallucination-Aware Detection and Evaluation System for Large Language Model Outputs in Enterprise CRM Workflows](https://doi.org/10.71097/ijaidr.v14.i1.1964)** · Other · LLM · Training-free · 💻[code](https://github.com/chriskaliX/Hades)
...
- **[Hallucinated Neural Radiance Fields in the Wild](https://doi.org/10.1109/CVPR52688.2022.01260)** · CVPR 2022 · LLM · Training-free · 💻[code](https://github.com/rover-xingyu/Ha-NeRF)
...
- **[Structural Hallucination in LLMs: A Formal Characterization and Mitigation Method](https://doi.org/10.36948/ijfmr.2020.v02i05.61072)** · International Journal For Multidisciplinary Research 2020 · LLM · Training-based
...
- **[Ranking Generated Summaries by Correctness: An Interesting but Challenging Application for Natural Language Inference](https://doi.org/10.18653/v1/P19-1213)** · ACL 2019 · LLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
...
<details>
<summary>👁️ VLM · 781 篇</summary>

<details>
<summary>📅 2027 · 1 papers</summary>

- **[Stroke-Level Connectivity Verification: Grounding Vision-Language Models Against Topology Hallucination in Diagram Understanding](https://doi.org/10.1007/978-3-032-36023-6_19)** · Other · VLM · Training-free

</details>

<details>
<summary>📅 2026 · 346 papers</summary>
...
- **[Semantic-Spatial Agreement Verification for Mitigating Object Hallucination in Multimodal Large Language Models](https://arxiv.org/abs/2609.17269)** · arXiv · VLM · Training-free · 💻[code](https://github.com/RyuJungSik/Algorithm)
- **[SAVOR: Self-Aware Visual Grounding via Confidence-Calibrated Reinforcement Learning for Multimodal Hallucination Mitigation](https://arxiv.org/abs/2609.16601)** · arXiv · VLM · Training-free · 💻[code](https://github.com/empriselab/SAVOR)
- **[AgenTeeth: A Model-Agnostic Framework for Suppressing Hallucination in Frozen Vision-Language Models on Dental X-Rays via Tool Evidence Injection](https://arxiv.org/abs/2609.17800)** · arXiv · VLM · Training-free
...
- **[RVSD: Retrieval Vision Sparse Decoding for Mitigating Visual Hallucinations in Large Vision-Language Models](https://arxiv.org/abs/2609.02731)** · arXiv · VLM · Training-free · 💻[code](https://github.com/canjie-liu/RVSD)
- **[From Tokens to Semantics: Leveraging Complementary Signals for Hallucination Detection in Black-Box LLMs](https://arxiv.org/abs/2609.02679)** · arXiv · VLM · Training-free
- **[Detecting Object Hallucinations in Large Vision-Language Models via Cross-Modal Attention Drifts and Mask-Based Verification](https://arxiv.org/abs/2609.02028)** · arXiv · VLM · Training-free · 💻[code](https://github.com/getquoteonline/NSN-Supplier-for-Defense-Aviation-Getaquote.store)
- **[Does Playing it Safe Count as Faithfulness? Reassessing LVLM Hallucination Mitigation Methods](https://arxiv.org/abs/2609.01888)** · arXiv · VLM · Training-free · 💻[code](https://github.com/ZhuYingJessica/cv-daily)
- **[VisER: Visual Evidence and Reliance for Object Hallucination Detection in LVLMs](https://arxiv.org/abs/2608.30480)** · arXiv · VLM · Training-free · 💻[code](https://github.com/viser-project/viser)
- **[Beyond Language Priors: Diagnosing and Fixing Visual-Origin Hallucinations in Multimodal LLM](https://arxiv.org/abs/2609.00231)** · arXiv · VLM · Training-free · 💻[code](https://github.com/zxp555/ACFT_MM)
...
- **[Hallucination Mitigation for Large Vision-Language Models via Implicit Feature Stabilization](https://arxiv.org/abs/2608.29924)** · arXiv · VLM · Training-free · 💻[code](https://github.com/krishnaaditi/INFUSE)
- **[EviAnchor: Mitigating Hallucinations in Large Vision-Language Models via Regional Visual Evidence Compensation](https://arxiv.org/abs/2608.29092)** · arXiv · VLM · Training-free · 💻[code](https://github.com/solitern/EviAnchor)
- **[Dynamic Alignment Compensation for Hallucination Mitigation in Large Vision-Language Models](https://arxiv.org/abs/2608.28058)** · arXiv · VLM · Training-free · 💻[code](https://github.com/zhuozhiyongde/Stargazer)
- **[Overview of SHROOM-Visions 2026: A Shared Task on Hallucination Detection in Large Vision-Language Models](https://arxiv.org/abs/2608.25662)** · arXiv · VLM · Training-free · 💻[code](https://github.com/berkbubus/probe-judge-fusion)
...
- **[Counterfactual Anatomy-guided Spatial-Temporal Decoding for Annotation-Free Hallucination Mitigation in Medical VLMs](https://arxiv.org/abs/2608.17427)** · arXiv · VLM · Training-free · 💻[code](https://github.com/csyifan/CAST)
- **[Catching Hallucinated Citations in Video-LLM Question Answering: A Self-Verification Pipeline and Verifier Ablation Study](https://arxiv.org/abs/2608.15574)** · arXiv · VLM · Training-free · 💻[code](https://github.com/yogesh-iitj/grounded-video-qa)
- **[Context Blindness in DPO: Mitigating Object Hallucination in MLLMs via Context-Calibrated Preference Optimization](https://arxiv.org/abs/2608.12158)** · arXiv · VLM · Training-based · 💻[code](https://github.com/mlvlab/C2-DPO)
- **[When Visual Signals Mislead: A Mechanistic Study of Attribute Hallucination in Vision-Language Models](https://arxiv.org/abs/2608.11024)** · arXiv · VLM · Training-free · 💻[code](https://github.com/wangqiannudt/nerf-arxiv-daily)
- **[UniProbe: A Learnable Token-Level Hallucination Detector for Large VLMs using Multi-Structural Internal Representations](https://arxiv.org/abs/2608.10835)** · arXiv · VLM · Training-free · 💻[code](https://github.com/haolipeng/UniProbe)
- **[Test-Time Hallucination Control in Large Vision-Language Models](https://arxiv.org/abs/2608.11474)** · arXiv · VLM · Training-free · 💻[code](https://github.com/Mehran-TAM/TTH)
- **[Hallucination-Free GUI Grounding via Regression-Free Layout-Aware Matching](https://arxiv.org/abs/2608.09654)** · arXiv · VLM · Training-based
- **[Beyond Global Editing: Per-Instance Disentangled Subspaces for Training-Free Hallucination Mitigation in LVLMs](https://arxiv.org/abs/2608.09344)** · arXiv · VLM · Training-free
- **[VADER: Adaptive Debiasing for Hallucination Mitigation in Video Large Language Models](https://arxiv.org/abs/2608.08622)** · arXiv · VLM · Training-free · 💻[code](https://github.com/mihirp1998/VADER)
- **[Wiener Representation Filtering for VLM Hallucination Suppression](https://arxiv.org/abs/2608.08167)** · arXiv · VLM · Training-free
- **[TruthLens: Object Hallucination Detection via Self-Evaluating Truthfulness Scores in LVLMs](https://arxiv.org/abs/2608.05616)** · arXiv · VLM · Training-based · 💻[code](https://github.com/wyqstan/TruthLens)
- **[UHP Detection: LVLMs have their Unique Hallucination Pattern in the Consistency Space](https://arxiv.org/abs/2608.03817)** · arXiv · VLM · Training-free · 💻[code](https://github.com/amirezzati/uhpdet)
- **📋 [KnowHal: A Knowledge-Driven Benchmark for Comprehensive Multimodal Hallucination Evaluation](https://arxiv.org/abs/2608.03782)** · arXiv · VLM · Training-free
...
- **[HalluScope: Fine-grained Hallucination Diagnosis for Multimodal Large Language Models](https://arxiv.org/abs/2607.21105)** · arXiv · VLM · Training-free · 💻[code](https://github.com/shiv2077/HalluScope)
- **[Geo3R: Mitigating Spatial Reasoning Hallucination in Multimodal Large Language Models](https://arxiv.org/abs/2607.21085)** · arXiv · VLM · Training-free · 💻[code](https://github.com/hiMyee/Geo3R-Mitigating-Spatial-Reasoning-Hallucination)
- **[Vera: Identity-Faithful Human Subject-to-Video Generation](https://arxiv.org/abs/2607.20247)** · arXiv · VLM · Training-free · 💻[code](https://github.com/sizhe-li/VERA)
- **[Axolotl3D: a Unified Framework for Faithful 3D Shape Completion](https://arxiv.org/abs/2607.20660)** · arXiv · VLM · Training-based · 💻[code](https://github.com/MatMaxMatrix/Axolotl3D)
- **📋 [MissingBench-Verified: Probing Vision-Language Models' Inability to Detect Missing Object Parts](https://arxiv.org/abs/2607.18673)** · arXiv · VLM · Training-free
...
- **[Naming the Concepts Classifiers Rely On: Language-Anchored Decomposition for Faithful Explanation](https://arxiv.org/abs/2607.07264)** · arXiv · VLM · Training-free
- **[HIVE: Understanding Post-Hallucination Reasoning in Vision Language Models](https://arxiv.org/abs/2607.07507)** · arXiv · VLM · Training-free · 💻[code](https://github.com/hefengcs/HIVE)
- **📋 [HoloCount: A Holistic Visual Counting Benchmark for MLLMs](https://arxiv.org/abs/2607.06420)** · arXiv · VLM · Training-free · 💻[code](https://github.com/MM-MVR/HoloCount)
...
- **[SeeMe: Mitigating Hallucinations in Large Vision-Language Models through Effective Visual Token Engineering](https://arxiv.org/abs/2607.04163)** · arXiv · VLM · Training-free · 💻[code](https://github.com/L-Scofano/SEEME)
- **[Do Medical Vision Language Models Actually See? A Counterfactual Grounding Framework and Hard-Negative Contrastive Training for Visually-Reliant Medical VLMs](https://arxiv.org/abs/2607.03647)** · arXiv · VLM · Training-based
- **📋 [MoHallBench: A Benchmark for Motion Hallucination in Video Large Language Models](https://arxiv.org/abs/2607.01117)** · arXiv · VLM · Training-free
- **[Vocabulary Hijacking in LVLMs: Unveiling Critical Attention Heads by Excluding Inert Tokens to Mitigate Hallucination](https://aclanthology.org/2026.acl-long.1782/)** · ACL 2026 · VLM · Training-free · 💻[code](https://github.com/lab-klc/HAVAE)
- **[Vision-Language Introspection: Mitigating Overconfident Hallucinations in MLLMs via Interpretable Bi-Causal Steering](https://aclanthology.org/2026.acl-long.1784/)** · ACL 2026 · VLM · Training-free · 💻[code](https://github.com/liutaocode/TTS-arxiv-daily)
...
- **[Through the Magnifying Glass: Adaptive Perception Magnification for Hallucination-Free VLM Decoding](https://aclanthology.org/2026.acl-long.2059/)** · ACL 2026 · VLM · Training-free · 💻[code](https://github.com/ShunqiM/PM)
...
- **[Mitigating Hallucinations in Large Vision-Language Models without Performance Degradation](https://aclanthology.org/2026.acl-long.89/)** · ACL 2026 · VLM · Training-free · 💻[code](https://github.com/zhuhsingyuu/MPD)
...
- **[Inject to Heal: Alleviating hallucination in LVLMs via Context Embedding Injection](https://aclanthology.org/2026.findings-acl.2048/)** · ACL 2026 · VLM · Training-free · 💻[code](https://github.com/mehrdadfazli/CEI)
- **📋 [INFACT: A Diagnostic Benchmark for Induced Faithfulness and Factuality Hallucinations in Video-LLMs](https://aclanthology.org/2026.acl-long.2062/)** · ACL 2026 · VLM · Training-free · 💻[code](https://github.com/yangjunqi1217/INFACT)
...
- **📚 [Distorted or Fabricated? A Survey on Hallucination in Video LLMs](https://aclanthology.org/2026.findings-acl.1325/)** · ACL 2026 · VLM · Training-free · 💻[code](https://github.com/hukcc/Awesome-Video-Hallucination)
- **[Dialectic-Med: Mitigating Diagnostic Hallucinations via Counterfactual Adversarial Multi-Agent Debate](https://aclanthology.org/2026.findings-acl.1837/)** · ACL 2026 · VLM · Training-free · 💻[code](https://github.com/YuJunWang/Medical-Dialectic-Engine)
- **[DiVE: Decoupling Intra-layer Visual Evidence for Mitigating Hallucinations in Large Vision-Language Models](https://aclanthology.org/2026.acl-long.1742/)** · ACL 2026 · VLM · Training-free · 💻[code](https://github.com/wagoodman/dive)
- **[Correcting Visual Blur Induced by Attention Distraction to Reduce Hallucinations: Algorithm and Theory](https://arxiv.org/abs/2605.24602)** · ICML 2026 · VLM · Training-free · 💻[code](https://github.com/MIKUZ12/AFIP)
- **[CEBC: Conformal Evidence-Bounded Control for Low-Hallucination Vision-Language Generation](https://aclanthology.org/2026.acl-long.2142/)** · ACL 2026 · VLM · Training-free · 💻[code](https://github.com/Noeducation42/CEBC_Penguin_2024)
- **[CCD: Mitigating Hallucinations in Radiology MLLMs via Clinical Contrastive Decoding](https://aclanthology.org/2026.findings-acl.1755/)** · ACL 2026 · VLM · Training-free · 💻[code](https://github.com/TongkunGuan/CCD)
...
- **[AHEAD: Attention Head Energy-Aware Dynamics for Hallucination Mitigation in MLLMs](https://aclanthology.org/2026.findings-acl.425/)** · ACL 2026 · VLM · Training-free · 💻[code](https://github.com/brian-kward/letting-ahead-content-hub-scraper)
...
- **[FADE: Mitigating Hallucinations by Reducing Language-Prior Dominance in Large Vision-Language Models](https://arxiv.org/abs/2606.29431)** · arXiv · VLM · Training-free · 💻[code](https://github.com/gkaemmer/react-fade-in)
- **[AURORA: Asymmetry and Update-Induced Rotation for Robust Hallucination Detection in Large Language Models](https://arxiv.org/abs/2606.29545)** · arXiv · VLM · Training-free · 💻[code](https://github.com/FunkyMuse/Aurora)
- **[Detecting Clinical Hallucinations in LVLMs via Counterfactual Visual Grounding Uncertainty](https://arxiv.org/abs/2606.28520)** · arXiv · VLM · Training-free · 💻[code](https://github.com/Agentic-CliniAI/CounterVHD)
- **[TAVR-VLM: Risk-Conditioned Causal Grounding for Hallucination-Resistant Report Generation](https://arxiv.org/abs/2606.26874)** · arXiv · VLM · Training-free · 💻[code](https://github.com/Leo1998-Lu/TAVR-VLM)
- **[Hallucination in World Models is Predictable and Preventable](https://arxiv.org/abs/2606.27326)** · arXiv · VLM · Training-based · 💻[code](https://github.com/nicklashansen/mmbench2)
- **[From Hallucination to Grounding: Diagnosing Visual Spatial Intelligence via CRISP](https://arxiv.org/abs/2606.26535)** · arXiv · VLM · Training-free · 💻[code](https://github.com/iiyamayuki/CRISP-Bench)
...
- **📋 [MedBench v5: A Dynamic, Process-Oriented, and Hallucination-Aware Benchmark for Clinical Multimodal Models](https://arxiv.org/abs/2606.24155)** · arXiv · VLM · Training-free
- **📋 [A Benchmark for Hallucination Detection in VLMs for Gastrointestinal Endoscopy](https://arxiv.org/abs/2606.24115)** · arXiv · VLM · Training-free
- **[MotionHalluc: Diagnosing Kinematic Hallucinations in Fine-Grained Motion Reasoning](https://arxiv.org/abs/2606.23061)** · arXiv · VLM · Training-free
- **📋 [SAGE: An Expert-Annotated South Asian GI Endoscopy Dataset for Multimodal Learning and Hallucination Analysis](https://arxiv.org/abs/2606.22144)** · arXiv · VLM · Training-free · 💻[code](https://github.com/roots/sage)
...
- **📋 [ClinHallu: A Benchmark for Diagnosing Stage-Wise Hallucinations in Medical MLLM Reasoning](https://arxiv.org/abs/2606.14697)** · arXiv · VLM · Training-free · 💻[code](https://github.com/alibaba-damo-academy/ClinHallu)
- **[MultiToP: Learning to Patch Visual Tokens to Mitigate Hallucinations in Video Large Multimodal Models](https://arxiv.org/abs/2606.11792)** · arXiv · VLM · Training-free · 💻[code](https://github.com/ztomer/multitop)
- **[Disentangling Hallucinations: Orthogonal Semantic Projection for Robust Interpretability](https://arxiv.org/abs/2606.14758)** · arXiv · VLM · Training-free · 💻[code](https://github.com/emirhanbilgic/Orthogonal-Semantic-Projection)
...
- **[How Many Counterfactuals Does It Take? Probing VLM Hallucinations Through Circuits and Causal Effects](https://arxiv.org/abs/2606.08777)** · arXiv · VLM · Training-free · 💻[code](https://github.com/dsgiitr/mechanistic-counterfactual-grounding)
...
- **[ZINA: Multimodal Fine-grained Hallucination Detection and Editing](https://openaccess.thecvf.com/content/CVPR2026/html/Wada_ZINA_Multimodal_Fine-grained_Hallucination_Detection_and_Editing_CVPR_2026_paper.html)** · CVPR 2026 · VLM · Training-free · 💻[code](https://github.com/YuigaWada/ZINA)
...
- **[Understanding and Mitigating Hallucinations in Multimodal Chain-of-Thought Models](https://openaccess.thecvf.com/content/CVPR2026/html/Ma_Understanding_and_Mitigating_Hallucinations_in_Multimodal_Chain-of-Thought_Models_CVPR_2026_paper.html)** · CVPR 2026 · VLM · Training-free · 💻[code](https://github.com/ASGO-MM/MCoT-hallucination)
- **[Thinking in Uncertainty: Mitigating Hallucinations in MLRMs with Latent Entropy-Aware Decoding](https://openaccess.thecvf.com/content/CVPR2026/html/Xu_Thinking_in_Uncertainty_Mitigating_Hallucinations_in_MLRMs_with_Latent_Entropy-Aware_CVPR_2026_paper.html)** · CVPR 2026 · VLM · Training-free · 💻[code](https://github.com/mlrm-LEAD/mlrm-LEAD)
...
- **[Same Attention, Different Truths: Put Logit-Lens over Visual Attention to Detect and Mitigate LVLM Object Hallucination](https://openaccess.thecvf.com/content/CVPR2026/html/Wang_Same_Attention_Different_Truths_Put_Logit-Lens_over_Visual_Attention_to_CVPR_2026_paper.html)** · CVPR 2026 · VLM · Training-free · 💻[code](https://github.com/wzczc/SADT)
- **[SEASON: Mitigating Temporal Hallucination in Video Large Language Models via Self-Diagnostic Contrastive Decoding](https://openaccess.thecvf.com/content/CVPR2026/html/Wu_SEASON_Mitigating_Temporal_Hallucination_in_Video_Large_Language_Models_via_CVPR_2026_paper.html)** · CVPR 2026 · VLM · Training-free · 💻[code](https://github.com/google/season-of-docs)
...
- **[Lyapunov Probes for Hallucination Detection in Large Foundation Models](https://openaccess.thecvf.com/content/CVPR2026/html/Luan_Lyapunov_Probes_for_Hallucination_Detection_in_Large_Foundation_Models_CVPR_2026_paper.html)** · CVPR 2026 · VLM · Training-based · 💻[code](https://github.com/13358-lbz/Lyapunov-Probes)
- **[Locate-then-Sparsify: Attribution Guided Sparse Strategy for Visual Hallucination Mitigation](https://openaccess.thecvf.com/content/CVPR2026/html/Dang_Locate-then-Sparsify_Attribution_Guided_Sparse_Strategy_for_Visual_Hallucination_Mitigation_CVPR_2026_paper.html)** · CVPR 2026 · VLM · Training-free · 💻[code](https://github.com/huttersadan/LTS-FS)
- **[KVSmooth: Mitigating Hallucination in Multi-modal Large Language Models through Key-Value Smoothing](https://openaccess.thecvf.com/content/CVPR2026/html/Jiang_KVSmooth_Mitigating_Hallucination_in_Multi-modal_Large_Language_Models_through_Key-Value_CVPR_2026_paper.html)** · CVPR 2026 · VLM · Training-free · 💻[code](https://github.com/mismailzz/kvsmooth)
- **[HulluEdit: Single-Pass Evidence-Consistent Subspace Editing for Mitigating Hallucinations in Large Vision-Language Models](https://openaccess.thecvf.com/content/CVPR2026/html/Lin_HulluEdit_Single-Pass_Evidence-Consistent_Subspace_Editing_for_Mitigating_Hallucinations_in_Large_CVPR_2026_paper.html)** · CVPR 2026 · VLM · Training-free · 💻[code](https://github.com/VioAgnes/HulluEdit)
- **[HAD: Hallucination-Aware Diffusion Priors for 3D Reconstruction](https://openaccess.thecvf.com/content/CVPR2026/html/Liu_HAD_Hallucination-Aware_Diffusion_Priors_for_3D_Reconstruction_CVPR_2026_paper.html)** · CVPR 2026 · VLM · Training-based · 💻[code](https://github.com/batmanpriv/had)
- **[First Logit Boosting: Visual Grounding Method to Mitigate Object Hallucination in Large Vision-Language Models](https://openaccess.thecvf.com/content/CVPR2026/html/Ha_First_Logit_Boosting_Visual_Grounding_Method_to_Mitigate_Object_Hallucination_CVPR_2026_paper.html)** · CVPR 2026 · VLM · Training-free · 💻[code](https://github.com/jiwooha20/FLB)
- **📋 [Fine-Grained Multi Image Object Hallucination Benchmark](https://openaccess.thecvf.com/content/CVPR2026/html/Min_Fine-Grained_Multi_Image_Object_Hallucination_Benchmark_CVPR_2026_paper.html)** · CVPR 2026 · VLM · Training-free
...
- **[FINER: MLLMs Hallucinate under Fine-grained Negative Queries](https://openaccess.thecvf.com/content/CVPR2026/html/Xiao_FINER_MLLMs_Hallucinate_under_Fine-grained_Negative_Queries_CVPR_2026_paper.html)** · CVPR 2026 · VLM · Training-free · 💻[code](https://github.com/fighting41love/funNLP)
- **[Envision, Attend, Then Respond: Counterfactual Hallucination Mitigation in Large Vision-Language Models](https://openaccess.thecvf.com/content/CVPR2026/html/Liang_Envision_Attend_Then_Respond_Counterfactual_Hallucination_Mitigation_in_Large_Vision-Language_CVPR_2026_paper.html)** · CVPR 2026 · VLM · Training-free · 💻[code](https://github.com/Lyxxx1211/CVPR2026-EnAR)
- **[ELV-Halluc: Benchmarking Semantic Aggregation Hallucinations in Video Understanding](https://openaccess.thecvf.com/content/CVPR2026/html/Lu_ELV-Halluc_Benchmarking_Semantic_Aggregation_Hallucinations_in_Video_Understanding_CVPR_2026_paper.html)** · CVPR 2026 · VLM · Training-free · 💻[code](https://github.com/hlsv02/ELV-Halluc)
...
- **[Cross-Modal Attention Calibration for LVLM Hallucination Mitigation](https://openaccess.thecvf.com/content/CVPR2026/html/Li_Cross-Modal_Attention_Calibration_for_LVLM_Hallucination_Mitigation_CVPR_2026_paper.html)** · CVPR 2026 · VLM · Training-free · 💻[code](https://github.com/lijm48/IMCCD)
- **[CausalLens: Sensitivity-Guided Multi-Head Causal Intervention for Hallucination Mitigation in Large Vision-Language Models](https://openaccess.thecvf.com/content/CVPR2026/html/Ji_CausalLens_Sensitivity-Guided_Multi-Head_Causal_Intervention_for_Hallucination_Mitigation_in_Large_CVPR_2026_paper.html)** · CVPR 2026 · VLM · Training-free · 💻[code](https://github.com/jijy20/CausalLens)
- **[COPO: Causal-Oriented Policy Optimization for Hallucinations of MLLMs](https://openaccess.thecvf.com/content/CVPR2026/html/Guo_COPO_Causal-Oriented_Policy_Optimization_for_Hallucinations_of_MLLMs_CVPR_2026_paper.html)** · CVPR 2026 · VLM · Training-based · 💻[code](https://github.com/decisionforce/CoPO)
- **[Beyond the Global Scores: Fine-Grained Token Grounding as a Robust Detector of LVLM Hallucinations](https://openaccess.thecvf.com/content/CVPR2026/html/Nguyen_Beyond_the_Global_Scores_Fine-Grained_Token_Grounding_as_a_Robust_CVPR_2026_paper.html)** · CVPR 2026 · VLM · Training-free · 💻[code](https://github.com/peter-scitix/lvlm-hallucination-grounding)
- **[AdaIAT: Adaptively Increasing Attention to Generated Text to Alleviate Hallucinations in LVLM](https://openaccess.thecvf.com/content/CVPR2026/html/Zhong_AdaIAT_Adaptively_Increasing_Attention_to_Generated_Text_to_Alleviate_Hallucinations_CVPR_2026_paper.html)** · CVPR 2026 · VLM · Training-free · 💻[code](https://github.com/XianguiKang/AdaIAT)
...
- **[MM-Snowball: Evaluating and Mitigating Hallucination Snowballing in Multimodal Multi-Turn Dialogue](https://arxiv.org/abs/2606.00622)** · arXiv · VLM · Training-free · 💻[code](https://github.com/FRENKIE-CHIANG/MM-Snowball)
- **[YARD: Y-Architecture Register Decoding for Efficient Hallucination Mitigation in Large Vision-Language Models](https://arxiv.org/abs/2605.31429)** · arXiv · VLM · Training-free · 💻[code](https://github.com/lsegal/yard)
...
- **[Learning from Fine-Grained Visual Discrepancies: Mitigating Multimodal Hallucinations via In-Context Visual Contrastive Optimization](https://arxiv.org/abs/2605.31312)** · arXiv · VLM · Training-based · 💻[code](https://github.com/OPPO-Mente-Lab/IC-VCO)
- **📋 [ReactBench: A Cause-Driven Benchmark for Multimodal Hallucination via Systematic Evaluation](https://arxiv.org/abs/2605.29579)** · arXiv · VLM · Training-free · 💻[code](https://github.com/millionco/reactbench)
...
- **[Adversarial Orthogonal Disentanglement for LVLM Hallucination Mitigation](https://arxiv.org/abs/2605.25377)** · arXiv · VLM · Training-free · 💻[code](https://github.com/Hunter-Wrynn/AOD)
...
- **[CHASD: Language Increment-Calibrated Contrastive Decoding against Hallucination in LVLMs](https://arxiv.org/abs/2605.23344)** · arXiv · VLM · Training-free · 💻[code](https://github.com/caihonyyangcong/chasd)
...
- **[VIHD: Visual Intervention-based Hallucination Detection for Medical Visual Question Answering](https://arxiv.org/abs/2605.20772)** · arXiv · VLM · Training-free · 💻[code](https://github.com/Jiayi-Chen-AU/VIHD)
...
- **[Finding the Correct Visual Evidence Without Forgetting: Mitigating Hallucination in LVLMs via Inter-Layer Visual Attention Discrepancy](https://arxiv.org/abs/2605.20965)** · arXiv · VLM · Training-free · 💻[code](https://github.com/ytx-ML/ILVAD)
- **[HalluCXR: Benchmarking and Mitigating Hallucinations in Medical Vision-Language Models for Chest Radiograph Interpretation](https://arxiv.org/abs/2605.20469)** · arXiv · VLM · Training-free · 💻[code](https://github.com/haoyu-haoyu/HalluCXR)
...
- **[Can These Views Be One Scene? Evaluating Multiview 3D Consistency when 3D Foundation Models Hallucinate](https://arxiv.org/abs/2605.18754)** · arXiv · VLM · Training-free · 💻[code](https://github.com/mvp18/3DConsistency-metrics)
...
- **[MHSA: A Lightweight Framework for Mitigating Hallucinations via Steered Attention in LVLMs](https://arxiv.org/abs/2605.14966)** · arXiv · VLM · Training-free · 💻[code](https://github.com/tranleanh/yolov4-mhsa)
...
- **[When Looking Is Not Enough: Visual Attention Structure Reveals Hallucination in MLLMs](https://arxiv.org/abs/2605.11559)** · arXiv · VLM · Training-free · 💻[code](https://github.com/macovaseas/LaSCD)
- **[Instruction Lens Score: Your Instruction Contributes a Powerful Object Hallucination Detector for Multimodal Large Language Models](https://arxiv.org/abs/2605.12258)** · arXiv · VLM · Training-free · 💻[code](https://github.com/Fraserlairh/Instruction-Lens-Score)
- **📋 [Med-StepBench: A Hierarchical Reasoning Framework for Evaluating Hallucinations in Medical Vision-Language Models](https://arxiv.org/abs/2605.10002)** · arXiv · VLM · Training-free
- **[Object Hallucination-Free Reinforcement Unlearning for Vision-Language Models](https://arxiv.org/abs/2605.08031)** · arXiv · VLM · Training-based · 💻[code](https://github.com/XMUDeepLIT/HFRU)
...
- **[CAST: Mitigating Object Hallucination in Large Vision-Language Models via Caption-Guided Visual Attention Steering](https://arxiv.org/abs/2605.04641)** · arXiv · VLM · Training-free · 💻[code](https://github.com/spf13/cast)
- **[GEASS: Training-Free Caption Steering for Hallucination Mitigation in Vision-Language Models](https://arxiv.org/abs/2605.01733)** · arXiv · VLM · Training-free · 💻[code](https://github.com/cloudle/geass)
...
- **[HalluCiteChecker: A Lightweight Toolkit for Hallucinated Citation Detection and Verification in the Era of AI Scientists](https://arxiv.org/abs/2604.26835)** · arXiv · VLM · Training-free · 💻[code](https://github.com/yusuke1997/HalluCiteChecker)
...
- **[R-CoV: Region-Aware Chain-of-Verification for Alleviating Object Hallucinations in LVLMs](https://arxiv.org/abs/2604.20696)** · arXiv · VLM · Training-free · 💻[code](https://github.com/Jiahao000/R-CoV)
- **[AI models of unstable flow exhibit hallucination](https://arxiv.org/abs/2604.20372)** · arXiv · VLM · Training-free
- **[VCE: A zero-cost hallucination mitigation method of LVLMs via visual contrastive editing](https://arxiv.org/abs/2604.19412)** · arXiv · VLM · Training-free · 💻[code](https://github.com/Shivambansal96/VCE_Hyd)
...
- **📋 [DO-Bench: An Attributable Benchmark for Diagnosing Object Hallucination in Vision-Language Models](https://arxiv.org/abs/2604.22822)** · arXiv · VLM · Training-free
- **[Aligning What Vision-Language Models See and Perceive with Adaptive Information Flow](https://arxiv.org/abs/2604.15809)** · arXiv · VLM · Training-free · 💻[code](https://github.com/cxliu0/AIF)
...
- **[HTDC: Hesitation-Triggered Differential Calibration for Mitigating Hallucination in Large Vision-Language Models](https://arxiv.org/abs/2604.12115)** · arXiv · VLM · Training-free · 💻[code](https://github.com/lukasz-mroz/HTDC)
- **[A Progressive Training Strategy for Vision-Language Models to Counteract Spatio-Temporal Hallucinations in Embodied Reasoning](https://arxiv.org/abs/2604.10506)** · arXiv · VLM · Training-based · 💻[code](https://github.com/MrYangAKAZJM/zjm-0)
- **[SinkTrack: Attention Sink based Context Anchoring for Large Language Models](https://arxiv.org/abs/2604.10027)** · arXiv · VLM · Training-free · 💻[code](https://github.com/67L1/SinkTrack)
- **[Cognitive Pivot Points and Visual Anchoring: Unveiling and Rectifying Hallucinations in Multimodal Reasoning Models](https://arxiv.org/abs/2604.10219)** · arXiv · VLM · Training-based · 💻[code](https://github.com/wangqiannudt/nerf-arxiv-daily)
...
- **[Steering the Verifiability of Multimodal AI Hallucinations](https://arxiv.org/abs/2604.06714)** · arXiv · VLM · Training-free · 💻[code](https://github.com/pang-jh/Steering_the_Verifiability)
- **[GIRL: Generative Imagination Reinforcement Learning via Information-Theoretic Hallucination Control](https://arxiv.org/abs/2604.07426)** · arXiv · VLM · Training-based · 💻[code](https://github.com/mperham/girl_friday)
- **[HaloProbe: Bayesian Detection and Mitigation of Object Hallucinations in Vision-Language Models](https://arxiv.org/abs/2604.06165)** · arXiv · VLM · Training-free · 💻[code](https://github.com/multimodal-ai-lab/HaloProbe)
- **📋 [DetailVerifyBench: A Benchmark for Dense Hallucination Localization in Long Image Captions](https://arxiv.org/abs/2604.05623)** · arXiv · VLM · Training-free
...
- **[STEAR: Layer-Aware Spatiotemporal Evidence Intervention for Hallucination Mitigation in Video Large Language Models](https://arxiv.org/abs/2604.03045)** · arXiv · VLM · Training-free · 💻[code](https://github.com/Fanlinfeng23/STEAR)
...
- **[Overconfidence and Calibration in Medical VQA: Empirical Findings and Hallucination-Aware Mitigation](https://arxiv.org/abs/2604.02543)** · arXiv · VLM · Training-free · 💻[code](https://github.com/JiyoungByun/hac)
- **[Attention at Rest Stays at Rest: Breaking Visual Inertia for Cognitive Hallucination Mitigation](https://arxiv.org/abs/2604.01989)** · arXiv · VLM · Training-free · 💻[code](https://github.com/wfr429/IVE)
...
- **[ORSc: Object-Aware Reinforcement with Semantic Consistency for Hallucination Mitigation in MLLMs](https://doi.org/10.1109/icassp55912.2026.11464193)** · ICASSP 2026 · VLM · Training-free · 💻[code](https://github.com/ZhihaoZhang97/Health-ORSC-Bench)
- **[Multi-Agent Brainstorming for Interpreting and Mitigating Hallucination in Multimodal-LLM](https://doi.org/10.1109/icassp55912.2026.11464937)** · ICASSP 2026 · VLM · Training-free · 💻[code](https://github.com/LZzz25/Multi-agent-Brainstorming)
...
- **[CVSTIM: Mitigating Object Hallucination in Mllms Via Co-Occurrence Guided Visual Stimulation](https://doi.org/10.1109/icassp55912.2026.11464584)** · ICASSP 2026 · VLM · Training-free · 💻[code](https://github.com/Adamsarp/CVStim)
- **[AFTER: Mitigating the Object Hallucination of LVLM via Adaptive Factual-Guided Activation Editing](https://arxiv.org/abs/2601.01957)** · ICLR 2026 · VLM · Training-free · 💻[code](https://github.com/jaredpalmer/after.js)
- **[Hallucination-aware intermediate representation edit in large vision-language models](https://arxiv.org/abs/2603.29405)** · arXiv · VLM · Training-free · 💻[code](https://github.com/ASGO-MM/HIRE)
- **[SAGE: Sink-Aware Grounded Decoding for Multimodal Hallucination Mitigation](https://arxiv.org/abs/2603.27898)** · arXiv · VLM · Training-free · 💻[code](https://github.com/roots/sage)
...
- **[Mitigating Object Hallucinations in LVLMs via Attention Imbalance Rectification](https://arxiv.org/abs/2603.24058)** · arXiv · VLM · Training-free · 💻[code](https://github.com/Ice-wave/AIR)
- **[Deterministic Hallucination Detection in Medical VQA via Confidence-Evidence Bayesian Gain](https://arxiv.org/abs/2603.21693)** · arXiv · VLM · Training-free · 💻[code](https://github.com/masadi-99/CEBaG)
- **📋 [FREAK: A Fine-grained Hallucination Evaluation Benchmark for Advanced MLLMs](https://arxiv.org/abs/2603.19765)** · arXiv · VLM · Training-free · 💻[code](https://github.com/kikohs/freak)
- **[VGS-Decoding: Visual Grounding Score Guided Decoding for Hallucination Mitigation in Medical VLMs](https://arxiv.org/abs/2603.20314)** · arXiv · VLM · Training-free · 💻[code](https://github.com/kishan8354/VGS-Decoding)
...
- **[Kestrel: Grounding Self-Refinement for LVLM Hallucination Mitigation](https://arxiv.org/abs/2603.16664)** · arXiv · VLM · Training-free · 💻[code](https://github.com/twitter-archive/kestrel)
- **📋 [HalDec-Bench: Benchmarking Hallucination Detector in Image Captioning](https://arxiv.org/abs/2603.15253)** · arXiv · VLM · Training-free · 💻[code](https://github.com/dahlian00/HalDec-Bench-Page)
...
- **[Anatomy of a Lie: A Multi-Stage Diagnostic Framework for Tracing Hallucinations in Vision-Language Models](https://arxiv.org/abs/2603.15557)** · arXiv · VLM · Training-free · 💻[code](https://github.com/Lexiang-Xiong/CAD)
- **[GroundCount: Grounding Vision-Language Models with Object Detection for Mitigating Counting Hallucinations](https://arxiv.org/abs/2603.10978)** · arXiv · VLM · Training-free · 💻[code](https://github.com/BoyuanChen99/GroundCount)
- **[Overthinking Causes Hallucination: Tracing Confounder Propagation in Vision Language Models](https://arxiv.org/abs/2603.07619)** · arXiv · VLM · Training-free · 💻[code](https://github.com/abinshoby/Overthinking)
- **[Looking Back and Forth: Cross-Image Attention Calibration and Attentive Preference Learning for Multi-Image Hallucination Mitigation](https://arxiv.org/abs/2603.07048)** · arXiv · VLM · Training-based · 💻[code](https://github.com/yyyxcleo/CAPL)
- **[Seeing Clearly without Training: Mitigating Hallucinations in Multimodal LLMs for Remote Sensing](https://arxiv.org/abs/2603.02754)** · arXiv · VLM · Training-free · 💻[code](https://github.com/MiliLab/RADAR)
...
- **[Scalpel: Fine-Grained Alignment of Attention Activation Manifolds via Mixture Gaussian Bridges to Mitigate Multimodal Hallucination](https://doi.org/10.1109/WACV61042.2026.00290)** · WACV 2026 · VLM · Training-free · 💻[code](https://github.com/JakeWharton/scalpel)
- **[SAVE: Sparse Autoencoder-Driven Visual Information Enhancement for Mitigating Object Hallucination](https://doi.org/10.1109/WACV61042.2026.00766)** · WACV 2026 · VLM · Training-free · 💻[code](https://github.com/wiarae/SAVE)
...
- **[HALP: Detecting Hallucinations in Vision-Language Models without Generating a Single Token](https://doi.org/10.18653/v1/2026.eacl-long.287)** · EACL 2026 · VLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[CAAC: Confidence-Aware Attention Calibration to Reduce Hallucinations in Large Vision-Language Models](https://doi.org/10.1109/WACV61042.2026.00127)** · WACV 2026 · VLM · Training-free · 💻[code](https://github.com/mehrdadfazli/CAAC)
- **[Attribution-Guided Multi-Object Hallucination and Bias Detection in Vision-Language Models](https://doi.org/10.18653/v1/2026.eacl-long.210)** · EACL 2026 · VLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
...
- **[Suppressing Prior-Comparison Hallucinations in Radiology Report Generation via Semantically Decoupled Latent Steering](https://arxiv.org/abs/2602.23676)** · arXiv · VLM · Training-free · 💻[code](https://github.com/AoXan/SDLS-Radiology)
...
- **[See It, Say It, Sorted: An Iterative Training-Free Framework for Visually-Grounded Multimodal Reasoning in LVLMs](https://arxiv.org/abs/2602.21497)** · arXiv · VLM · Training-free · 💻[code](https://github.com/uuuuZYC/ECRD)
- **[NoLan: Mitigating Object Hallucinations in Large Vision-Language Models via Dynamic Suppression of Language Priors](https://arxiv.org/abs/2602.22144)** · arXiv · VLM · Training-free · 💻[code](https://github.com/lingfengren/NoLan)
...
- **📋 [ManiBench: A Benchmark for Testing Visual-Logic Drift and Syntactic Hallucinations in Manim Code Generation](https://arxiv.org/abs/2603.13251)** · arXiv · VLM · Training-free · 💻[code](https://github.com/nabin2004/ManiBench)
- **[HIME: Mitigating Object Hallucinations in LVLMs via Hallucination Insensitivity Model Editing](https://arxiv.org/abs/2602.18711)** · arXiv · VLM · Training-based · 💻[code](https://github.com/TSKI433/hime-display)
- **[Triggering hallucinations in model-based MRI reconstruction via adversarial perturbations](https://arxiv.org/abs/2602.18536)** · arXiv · VLM · Training-based · 💻[code](https://github.com/saeyslab/adversarial-mri)
- **[VIGIL: Tackling Hallucination Detection in Image Recontextualization](https://arxiv.org/abs/2602.14633)** · arXiv · VLM · Training-free · 💻[code](https://github.com/mlubneuskaya/vigil)
- **[AdaVBoost: Mitigating Hallucinations in LVLMs via Token-Level Adaptive Visual Attention Boosting](https://arxiv.org/abs/2602.13600)** · arXiv · VLM · Training-free · 💻[code](https://github.com/JiachengZ01/SAVVA)
- **[Revis: Sparse Latent Steering to Mitigate Object Hallucination in Large Vision-Language Models](https://arxiv.org/abs/2602.11824)** · arXiv · VLM · Training-free · 💻[code](https://github.com/antgroup/Revis)
- **[RSHallu: Dual-Mode Hallucination Evaluation for Remote-Sensing Multimodal Large Language Models with Domain-Tailored Mitigation](https://arxiv.org/abs/2602.10799)** · arXiv · VLM · Training-based · 💻[code](https://github.com/zhouzihui2001/RSHallu)
- **[HII-DPO: Eliminate Hallucination via Accurate Hallucination-Inducing Counterfactual Images](https://arxiv.org/abs/2602.10425)** · arXiv · VLM · Training-based · 💻[code](https://github.com/thiyangt/elephants)
...
- **[Beyond Static Cropping: Layer-Adaptive Visual Localization and Decoding Enhancement](https://arxiv.org/abs/2602.04304)** · arXiv · VLM · Training-free · 💻[code](https://github.com/ZhuYingJessica/cv-daily)
...
- **[ConsistentRFT: Reducing Visual Hallucinations in Flow-based Reinforcement Fine-Tuning](https://arxiv.org/abs/2602.03425)** · arXiv · VLM · Training-free · 💻[code](https://github.com/Xiaofeng-Tan/ConsistentRFT)
- **[IRIS: Implicit Reward-Guided Internal Sifting for Mitigating Multimodal Hallucination](https://arxiv.org/abs/2602.01769)** · arXiv · VLM · Training-based · 💻[code](https://github.com/kataras/iris)
...
- **[VCGD: Visual Clue Guided Decoding with Caption Model for Mitigating Hallucination in Multimodal Large Language Models](https://doi.org/10.1609/aaai.v40i24.39089)** · AAAI 2026 · VLM · Training-based · 💻[code](https://github.com/gorakshnath7/vcgd)
...
- **[SmartSight: Mitigating Hallucination in Video-LLMs Without Compromising Video Understanding via Temporal Attention Collapse](https://doi.org/10.1609/aaai.v40i11.37883)** · AAAI 2026 · VLM · Training-free · 💻[code](https://github.com/hpcclab/smartsight)
- **[Seeing Is Believing: Rich-Context Hallucination Detection for MLLMs via Backward Visual Grounding](https://doi.org/10.1609/aaai.v40i37.40345)** · AAAI 2026 · VLM · Training-free · 💻[code](https://github.com/PinxueGuo/VBackChecker)
- **[SAVER: Mitigating Hallucinations in Large Vision-Language Models via Style-Aware Visual Early Revision](https://doi.org/10.1609/aaai.v40i42.40873)** · AAAI 2026 · VLM · Training-free · 💻[code](https://github.com/NanoVNA-Saver/nanovna-saver)
- **[RFI: Rectified Flow Intervention for Mitigating Object Hallucination in Large Vision-Language Models](https://doi.org/10.1609/aaai.v40i5.37320)** · AAAI 2026 · VLM · Training-free · 💻[code](https://github.com/preshanth/SAM-RFI)
- **[Not All Tokens and Heads Are Equally Important: Dual-Level Attention Intervention for Hallucination Mitigation](https://doi.org/10.1609/aaai.v40i11.37904)** · AAAI 2026 · VLM · Training-free
...
- **[Mitigating Entity Hallucinations in 3D Radiology Report Generation via Dual-Stream Alignment](https://doi.org/10.1609/aaai.v40i16.38379)** · AAAI 2026 · VLM · Training-free · 💻[code](https://github.com/SCU-zly/DEAR)
- **[Look Closer! An Adversarial Parametric Editing Framework for Hallucination Mitigation in VLMs](https://doi.org/10.1609/aaai.v40i26.39336)** · AAAI 2026 · VLM · Training-based · 💻[code](https://github.com/hujiayu1223/ALEAHallu)
- **[LLM-CAS: Dynamic Neuron Perturbation for Real-Time Hallucination Correction](https://doi.org/10.1609/aaai.v40i41.40776)** · AAAI 2026 · VLM · Training-based · 💻[code](https://github.com/HCP-AI-Research-Lab/llm-CAS)
- **[InEx: Hallucination Mitigation via Introspection and Cross-Modal Multi-Agent Collaboration](https://doi.org/10.1609/aaai.v40i35.40229)** · AAAI 2026 · VLM · Training-free · 💻[code](https://github.com/Osekai/inex)
- **[Ground What You See: Hallucination-Resistant MLLMs via Caption Feedback, Diversity-Aware Sampling, and Conflict Regularization](https://doi.org/10.1609/aaai.v40i10.37772)** · AAAI 2026 · VLM · Training-based · 💻[code](https://github.com/ZJU-OmniAI/OMNEX-VL)
- **[Causally-Grounded Dual-Path Attention Intervention for Object Hallucination Mitigation in LVLMs](https://doi.org/10.1609/aaai.v40i42.40918)** · AAAI 2026 · VLM · Training-free · 💻[code](https://github.com/CikZ2023/OWL)
- **📋 [Causal-HalBench: Uncovering LVLMs Object Hallucinations Through Causal Intervention](https://doi.org/10.1609/aaai.v40i40.40712)** · AAAI 2026 · VLM · Training-free · 💻[code](https://github.com/zhexu-ustc/Causal-HalBench)
...
- **[Analyzing and Mitigating Object Hallucination: A Training Bias Perspective](https://doi.org/10.1609/aaai.v40i8.37594)** · AAAI 2026 · VLM · Training-based · 💻[code](https://github.com/AoiDragon/POPEv2)
- **[Adaptive Hallucination Alleviation in Multimodal Large Language Models: From Strategic Data Selection to Severity-Guided Training](https://doi.org/10.1609/aaai.v40i32.39955)** · AAAI 2026 · VLM · Training-based
- **[ASCD: Attention-Steerable Contrastive Decoding for Reducing Hallucination in MLLM](https://doi.org/10.1609/aaai.v40i12.38000)** · AAAI 2026 · VLM · Training-free · 💻[code](https://github.com/BroJunn/ASCD)
...
- **[Learning to Decode Against Compositional Hallucination in Video Multimodal Large Language Models](https://arxiv.org/abs/2602.00559)** · arXiv · VLM · Training-based · 💻[code](https://github.com/BMRETURN/OmniVCHall)
- **[One-shot Optimized Steering Vector for Hallucination Mitigation for VLMs](https://arxiv.org/abs/2601.23041)** · arXiv · VLM · Training-free · 💻[code](https://github.com/vamshikrishna144/todoWithNode)
...
- **[Countering the Over-Reliance Trap: Mitigating Object Hallucination for LVLMs via a Self-Validation Framework](https://arxiv.org/abs/2601.22451)** · arXiv · VLM · Training-free · 💻[code](https://github.com/Liushiyu-0709/SelfVal)
- **[From Particles to Agents: Hallucination as a Metric for Cognitive Friction in Spatial Simulation](https://arxiv.org/abs/2601.21977)** · arXiv · VLM · Training-free
- **[Hallucination Begins Where Saliency Drops](https://arxiv.org/abs/2601.20279)** · arXiv · VLM · Training-free · 💻[code](https://github.com/zhangbaijin/LVLMs-Saliency)
...
- **[Training-free counterfactual hallucination mitigation method for large vision-language models](https://doi.org/10.1007/s00530-026-02577-3)** · Other · VLM · Training-free
- **[Tone Matters: The Impact of Linguistic Tone on Hallucination in VLMs](https://doi.org/10.1109/WACVW68408.2026.00147)** · Other · VLM · Training-free
- **[Real-time hallucination correction in vision-language models using dynamic knowledge graph verification](https://doi.org/10.1007/s44163-026-01778-z)** · Other · VLM · Training-free
- **[REVERIE+: Generalized Reflective Instruction Tuning for Hallucination Mitigation in Advanced VLMs](https://doi.org/10.1007/s11263-026-02945-6)** · Other · VLM · Training-based
- **[MBHNet: Multimodal Brain Hallucination Network for Fluid Intelligence Prediction Under Missing Structural Connectivity](https://doi.org/10.1109/icip61757.2026.11630138)** · Other · VLM · Training-free · 💻[code](https://github.com/yudawen/MBHNet)
- **[Hallucination Mitigation in Large Vision-Language Models via Contrastive Decoding with Attention Enhancement and Masking](https://doi.org/10.1109/icip61757.2026.11630515)** · Other · VLM · Training-free
- **[Cohesion: Consensus-Based Hallucination Subspace Estimation for Multimodal Large Language Models](https://doi.org/10.1109/icip61757.2026.11630364)** · Other · VLM · Training-free · 💻[code](https://github.com/Jinfeng-Xu/COHESION)
- **[Beyond Visual Perception: Mitigating Multimodal Hallucination via Hybrid Preference Optimization](https://doi.org/10.1109/icip61757.2026.11630292)** · Other · VLM · Training-based
- **[Alleviating Hallucination in Large Vision-Language Models via Structure-Aware Adaptive Contrastive Decoding](https://doi.org/10.1109/icip61757.2026.11630323)** · Other · VLM · Training-free
...
- **[Mitigating Multilingual Hallucination in Large Vision-Language Models](https://doi.org/10.1145/3797025)** · TOMM 2026 · VLM · Training-based · 💻[code](https://github.com/ssmisya/MHR)
...
<details>
<summary>📅 2025 · 307 papers</summary>
...
- **[InpaintDPO: Mitigating Spatial Relationship Hallucinations in Foreground-conditioned Inpainting via Diverse Preference Optimization](https://arxiv.org/abs/2512.15644)** · arXiv · VLM · Training-based · 💻[code](https://github.com/IApple233/InpaintDPO)
- **[VEGAS: Mitigating Hallucinations in Large Vision-Language Models via Vision-Encoder Attention Guided Adaptive Steering](https://arxiv.org/abs/2512.12089)** · arXiv · VLM · Training-free · 💻[code](https://github.com/jaysalvat/vegas)
- **[CHEM: Estimating and Understanding Hallucinations in Deep Learning for Image Processing](https://arxiv.org/abs/2512.09806)** · arXiv · VLM · Training-free · 💻[code](https://github.com/inesrosellon/CHEM)
- **[When normalization hallucinates: unseen risks in AI-powered whole slide image processing](https://arxiv.org/abs/2512.07426)** · arXiv · VLM · Training-based
- **[Toward More Reliable Artificial Intelligence: Reducing Hallucinations in Vision-Language Models](https://arxiv.org/abs/2512.07564)** · arXiv · VLM · Training-free · 💻[code](https://github.com/kassoumsanogo1/self-correcting-vlm-re-Attention)
- **[HalluShift++: Bridging Language and Vision through Internal Representation Shifts for Hierarchical Hallucinations in MLLMs](https://arxiv.org/abs/2512.07687)** · arXiv · VLM · Training-free · 💻[code](https://github.com/C0mRD/HalluShift_Plus)
...
- **[VideoHallu: Evaluating and Mitigating Multi-modal Hallucinations on Synthetic Video Understanding](http://papers.nips.cc/paper_files/paper/2025/hash/6e1734c47c0cc899021060d88f69dc65-Abstract-Conference.html)** · NeurIPS 2025 · VLM · Training-free · 💻[code](https://github.com/zli12321/VideoHallu)
...
- **[On Epistemic Uncertainty of Visual Tokens for Object Hallucinations in Large Vision-Language Models](http://papers.nips.cc/paper_files/paper/2025/hash/bd6673d95a2a994a5647dca1df91a000-Abstract-Conference.html)** · NeurIPS 2025 · VLM · Training-free · 💻[code](https://github.com/joohoonlee/Epistemic)
- **[More Thinking, Less Seeing? Assessing Amplified Hallucination in Multimodal Reasoning Models](http://papers.nips.cc/paper_files/paper/2025/hash/777db387a5ccb131ba8c7cd155166b85-Abstract-Conference.html)** · NeurIPS 2025 · VLM · Training-free · 💻[code](https://github.com/MLRM-Halu/MLRM-Halu)
- **[Mitigating Hallucination Through Theory-Consistent Symmetric Multimodal Preference Optimization](http://papers.nips.cc/paper_files/paper/2025/hash/a1718f361df32ff3a1fc224f8673c556-Abstract-Conference.html)** · NeurIPS 2025 · VLM · Training-based · 💻[code](https://github.com/iLearn-Lab/NeurIPS25-SymMPO)
- **[MIRAGE: Assessing Hallucination in Multimodal Reasoning Chains of MLLM](http://papers.nips.cc/paper_files/paper/2025/hash/b238324b309da12c7446d92c14db9f7e-Abstract-Conference.html)** · NeurIPS 2025 · VLM · Training-free · 💻[code](https://github.com/UMass-Embodied-AGI/Mirage)
- **[Intervene-All-Paths: Unified Mitigation of LVLM Hallucinations across Alignment Formats](http://papers.nips.cc/paper_files/paper/2025/hash/d0cf89927acd9136d27ebf08f9e8a888-Abstract-Conference.html)** · NeurIPS 2025 · VLM · Training-free · 💻[code](https://github.com/SooLab/AllPath)
...
- **[Discovering Compositional Hallucinations in LVLMs](http://papers.nips.cc/paper_files/paper/2025/hash/299a08ee712d4752c890938da99a77c6-Abstract-Conference.html)** · NeurIPS 2025 · VLM · Training-free
- **[Decoupling Contrastive Decoding: Robust Hallucination Mitigation in Multimodal Large Language Models](http://papers.nips.cc/paper_files/paper/2025/hash/f39cc9110544a067f024c1fb8b396128-Abstract-Conference.html)** · NeurIPS 2025 · VLM · Training-free · 💻[code](https://github.com/HKUST-LongGroup/DCD)
- **[Graphing the Truth: Structured Visualizations for Automated Hallucination Detection in LLMs](https://arxiv.org/abs/2512.00663)** · arXiv · VLM · Training-based
- **[Decoupling Perception from Reasoning for Hallucination-Resistant Video Understanding](https://arxiv.org/abs/2511.18463)** · arXiv · VLM · Training-free · 💻[code](https://github.com/BoweiPu/VideoPLR)
- **📋 [What Color Is It? A Text-Interference Multimodal Hallucination Benchmark](https://arxiv.org/abs/2511.13400)** · arXiv · VLM · Training-free
- **[VOPE: Revisiting Hallucination of Vision-Language Models in Voluntary Imagination Task](https://arxiv.org/abs/2511.13420)** · arXiv · VLM · Training-free · 💻[code](https://github.com/qqwsad5/VOPE)
- **[HEDGE: Hallucination Estimation via Dense Geometric Entropy for VQA with Vision-Language Models](https://arxiv.org/abs/2511.12693)** · arXiv · VLM · Training-based · 💻[code](https://github.com/Simula/HEDGE)
- **[Suppressing VLM Hallucinations with Spectral Representation Filtering](https://arxiv.org/abs/2511.12220)** · arXiv · VLM · Training-free · 💻[code](https://github.com/Muxaline/Renewable-Energy-Optimization)
- **[Multi-agent Undercover Gaming: Hallucination Removal via Counterfactual Test for Multimodal Reasoning](https://arxiv.org/abs/2511.11182)** · arXiv · VLM · Training-free · 💻[code](https://github.com/YongLD/MUG.git)
- **[Adaptive Residual-Update Steering for Low-Overhead Hallucination Mitigation in Large Vision Language Models](https://arxiv.org/abs/2511.10292)** · arXiv · VLM · Training-free · 💻[code](https://github.com/Akko000/RUDDER-Residual-Update-Directed-DEcoding-Regulation-)
- **[Laplacian Score Sharpening for Mitigating Hallucination in Diffusion Models](https://arxiv.org/abs/2511.07496)** · arXiv · VLM · Training-free
- **[NOAH: Benchmarking Narrative Prior driven Hallucination and Omission in Video Large Language Models](https://arxiv.org/abs/2511.06475)** · arXiv · VLM · Training-free · 💻[code](https://github.com/linux-noah/noah)
...
- **[What's in Common? Multimodal Models Hallucinate When Reasoning Across Scenes](https://arxiv.org/abs/2511.03768)** · arXiv · VLM · Training-based
- **[Diagnosing Hallucination Risk in AI Surgical Decision-Support: A Sequential Framework for Sequential Validation](https://arxiv.org/abs/2511.00588)** · arXiv · VLM · Training-free
...
- **[Treble Counterfactual VLMs: A Causal Approach to Hallucination](https://doi.org/10.18653/v1/2025.findings-emnlp.1000)** · EMNLP 2025 · VLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[Token Preference Optimization with Self-Calibrated Visual-Anchored Rewards for Hallucination Mitigation](https://doi.org/10.18653/v1/2025.findings-emnlp.1076)** · EMNLP 2025 · VLM · Training-based · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[Steering LVLMs via Sparse Autoencoder for Hallucination Mitigation](https://doi.org/10.18653/v1/2025.findings-emnlp.572)** · EMNLP 2025 · VLM · Training-free · 💻[code](https://github.com/huazhenglin2003/SSL)
- **[Shallow Focus, Deep Fixes: Enhancing Shallow Layers Vision Attention Sinks to Alleviate Hallucination in LVLMs](https://doi.org/10.18653/v1/2025.emnlp-main.174)** · EMNLP 2025 · VLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[SHARP: Steering Hallucination in LVLMs via Representation Engineering](https://doi.org/10.18653/v1/2025.emnlp-main.725)** · EMNLP 2025 · VLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[ReLoop: &quot;Seeing Twice and Thinking Backwards&quot; via Closed-loop Training to Mitigate Hallucinations in Multimodal understanding](https://doi.org/10.18653/v1/2025.findings-emnlp.222)** · EMNLP 2025 · VLM · Training-free · 💻[code](https://github.com/ZiyanHuang11/Reloop-hallucinations)
- **[ReLoop: "Seeing Twice and Thinking Backwards" via Closed-loop Training to Mitigate Hallucinations in Multimodal understanding](https://doi.org/10.18653/v1/2025.findings-emnlp.222)** · EMNLP 2025 · VLM · Training-free · 💻[code](https://github.com/Radhika1124/ReLoop)
- **[Re-Align: Aligning Vision Language Models via Retrieval-Augmented Direct Preference Optimization](https://doi.org/10.18653/v1/2025.emnlp-main.121)** · EMNLP 2025 · VLM · Training-based · 💻[code](https://github.com/taco-group/Re-Align)
- **[Multi-Frequency Contrastive Decoding: Alleviating Hallucinations for Large Vision-Language Models](https://doi.org/10.18653/v1/2025.emnlp-main.1452)** · EMNLP 2025 · VLM · Training-free · 💻[code](https://github.com/liubq-dev/mfcd)
...
- **[Mitigating Hallucinations in Vision-Language Models through Image-Guided Head Suppression](https://doi.org/10.18653/v1/2025.emnlp-main.631)** · EMNLP 2025 · VLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
...
- **[Mitigating Hallucinations in Large Vision-Language Models by Self-Injecting Hallucinations](https://doi.org/10.18653/v1/2025.findings-emnlp.746)** · EMNLP 2025 · VLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[Mitigating Hallucination in Large Vision-Language Models through Aligning Attention Distribution to Information Flow](https://doi.org/10.18653/v1/2025.findings-emnlp.1352)** · EMNLP 2025 · VLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[MaskCD: Mitigating LVLM Hallucinations by Image Head Masked Contrastive Decoding](https://doi.org/10.18653/v1/2025.findings-emnlp.1025)** · EMNLP 2025 · VLM · Training-free · 💻[code](https://github.com/Deng-Jingyuan/MaskCD)
- **[MRFD: Multi-Region Fusion Decoding with Self-Consistency for Mitigating Hallucinations in LVLMs](https://doi.org/10.18653/v1/2025.findings-emnlp.858)** · EMNLP 2025 · VLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[EGOILLUSION: Benchmarking Hallucinations in Egocentric Video Understanding](https://doi.org/10.18653/v1/2025.emnlp-main.1446)** · EMNLP 2025 · VLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[Diving into Mitigating Hallucinations from a Vision Perspective for Large Vision-Language Models](https://doi.org/10.18653/v1/2025.findings-emnlp.936)** · EMNLP 2025 · VLM · Training-free · 💻[code](https://github.com/whwangovo/VisionWeaver)
- **[DAPE-BR: Distance-Aware Positional Encoding for Mitigating Object Hallucination in LVLMs](https://doi.org/10.18653/v1/2025.findings-emnlp.459)** · EMNLP 2025 · VLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
...
- **[Grounding or Guessing? Visual Signals for Detecting Hallucinations in Sign Language Translation](https://arxiv.org/abs/2510.18439)** · arXiv · VLM · Training-free · 💻[code](https://github.com/yhamidullah/hallucination-slt)
- **[Beyond Single Models: Mitigating Multimodal Hallucinations via Adaptive Token Ensemble Decoding](https://arxiv.org/abs/2510.18321)** · arXiv · VLM · Training-free · 💻[code](https://github.com/jinlin2021/ATED)
- **[Seeing but Not Believing: Probing the Disconnect Between Visual Attention and Answer Correctness in VLMs](https://arxiv.org/abs/2510.17771)** · arXiv · VLM · Training-free · 💻[code](https://github.com/davidbchang/visual-attention-intervention)
- **[SHIELD: Suppressing Hallucinations In LVLM Encoders via Bias and Vulnerability Defense](https://arxiv.org/abs/2510.16596)** · arXiv · VLM · Training-free · 💻[code](https://github.com/hukcc/SHIELD)
- **[Self-Augmented Visual Contrastive Decoding](https://arxiv.org/abs/2510.13315)** · arXiv · VLM · Training-free · 💻[code](https://github.com/eunwooim/selfaug)
- **[Counting Hallucinations in Diffusion Models](https://arxiv.org/abs/2510.13080)** · arXiv · VLM · Training-free · 💻[code](https://github.com/getquoteonline/Fast-NSN-Searches-Real-Time-Quotes-Only-on-Nsnpartlookup.com)
...
- **[To Sink or Not to Sink: Visual Information Pathways in Large Vision-Language Models](https://arxiv.org/abs/2510.08510)** · arXiv · VLM · Training-free · 💻[code](https://github.com/Vita112/vision_sink_neurons)
...
- **[ChainMPQ: Interleaved Text-Image Reasoning Chains for Mitigating Relation Hallucinations](https://arxiv.org/abs/2510.06292)** · arXiv · VLM · Training-free · 💻[code](https://github.com/yike-wu/ChainMPQ)
- **[TAG: Tangential Amplifying Guidance for Hallucination-Resistant Sampling](https://arxiv.org/abs/2510.04533)** · arXiv · VLM · Training-free · 💻[code](https://github.com/xhongc/music-tag-web)
...
- **📋 [SHALE: A Scalable Benchmark for Fine-grained Hallucination Evaluation in LVLMs](https://doi.org/10.1145/3746027.3758308)** · ACM MM 2025 · VLM · Training-free · 💻[code](https://github.com/kgiszczak/shale)
- **[ONLY: One-Layer Intervention Sufficiently Mitigates Hallucinations in Large Vision-Language Models](https://doi.org/10.1109/ICCV51701.2025.00309)** · ICCV 2025 · VLM · Training-free · 💻[code](https://github.com/zifuwan/ONLY)
- **[Mitigating Object Hallucinations via Sentence-Level Early Intervention](https://doi.org/10.1109/ICCV51701.2025.00067)** · ICCV 2025 · VLM · Training-based · 💻[code](https://github.com/pspdada/SENTINEL)
...
- **[MPI-CD: Multi-Path Information Contrastive Decoding for Mitigating Hallucinations in Large Vision-Language Models](https://doi.org/10.1145/3746027.3755372)** · ACM MM 2025 · VLM · Training-free · 💻[code](https://github.com/SammyOnTheRun/CD-EL-MPI_Analyzer)
- **📋 [MIHBench: Benchmarking and Mitigating Multi-Image Hallucinations in Multimodal Large Language Models](https://doi.org/10.1145/3746027.3754993)** · ACM MM 2025 · VLM · Training-free · 💻[code](https://github.com/dhzhang41-tech/MIHBench-DAB-reproduction)
...
- **[MCA-LLaVA: Manhattan Causal Attention for Reducing Hallucination in Large Vision-Language Models](https://doi.org/10.1145/3746027.3755271)** · ACM MM 2025 · VLM · Training-free · 💻[code](https://github.com/ErikZ719/MCA-LLaVA)
...
- **[INTER: Mitigating Hallucination in Large Vision-Language Models by Interaction Guidance Sampling](https://doi.org/10.1109/ICCV51701.2025.00244)** · ICCV 2025 · VLM · Training-free · 💻[code](https://github.com/rsms/inter)
...
- **[Fuzzy Contrastive Decoding to Alleviate Object Hallucination in Large Vision-Language Models](https://doi.org/10.1109/ICCV51701.2025.01913)** · ICCV 2025 · VLM · Training-free · 💻[code](https://github.com/lilly9928/FuzzyCD)
...
- **[Enhancing Visual Reliance in Text Generation: A Bayesian Perspective on Mitigating Hallucination in Large Vision-Language Models](https://doi.org/10.1145/3746027.3755606)** · ACM MM 2025 · VLM · Training-free · 💻[code](https://github.com/NeilHnxTcc/EVRB)
...
- **[DHCP: Detecting Hallucinations by Cross-modal Attention Pattern in Large Vision-Language Models](https://doi.org/10.1145/3746027.3755118)** · ACM MM 2025 · VLM · Training-free · 💻[code](https://github.com/insomniacslk/dhcp)
- **[DASH: Detection and Assessment of Systematic Hallucinations of VLMs](https://doi.org/10.1109/ICCV51701.2025.02112)** · ICCV 2025 · VLM · Training-free · 💻[code](https://github.com/plotly/dash)
- **[Collaboration Wins More: Dual-Modal Collaborative Attention Reinforcement for Mitigating Large Vision Language Models Hallucination](https://doi.org/10.1145/3746027.3755320)** · ACM MM 2025 · VLM · Training-free · 💻[code](https://github.com/xjy2020/DuCAR)
- **[CoFi-Dec: Hallucination-Resistant Decoding via Coarse-to-Fine Generative Feedback in Large Vision-Language Models](https://doi.org/10.1145/3746027.3754791)** · ACM MM 2025 · VLM · Training-free · 💻[code](https://github.com/AI-Researcher-Team/CoFi-Dec)
- **[ARGUS: Hallucination and Omission Evaluation in Video-LLMs](https://doi.org/10.1109/ICCV51701.2025.01886)** · ICCV 2025 · VLM · Training-free · 💻[code](https://github.com/xtekky/TIkTok-X-Argus)
- **[GroundSight: Augmenting Vision-Language Models with Grounding Information and De-hallucination](https://arxiv.org/abs/2509.25669)** · arXiv · VLM · Training-free · 💻[code](https://github.com/andersontruong/GroundSight)
...
- **[Mitigating Hallucination in Multimodal LLMs with Layer Contrastive Decoding](https://arxiv.org/abs/2509.25177)** · arXiv · VLM · Training-free · 💻[code](https://github.com/maifoundations/LayerCD)
- **[GHOST: Hallucination-Inducing Image Generation for Multimodal LLMs](https://arxiv.org/abs/2509.25178)** · arXiv · VLM · Training-based · 💻[code](https://github.com/ai-forever/ghost)
...
- **[Visual Multi-Agent System: Mitigating Hallucination Snowballing via Visual Flow](https://arxiv.org/abs/2509.21789)** · arXiv · VLM · Training-free · 💻[code](https://github.com/YU-deep/ViF.git)
- **📚 [Review of Hallucination Understanding in Large Language and Vision Models](https://arxiv.org/abs/2510.00034)** · arXiv · VLM · Training-free
- **[Exposing Hallucinations To Suppress Them: VLMs Representation Editing With Generative Anchors](https://arxiv.org/abs/2509.21997)** · arXiv · VLM · Training-free · 💻[code](https://github.com/ZoeyYang17/data-6-website)
- **[Hallucination reduction with CASAL: Contrastive Activation Steering For Amortized Learning](https://arxiv.org/abs/2510.02324)** · arXiv · VLM · Training-based
...
- **[Are Hallucinations Bad Estimations?](https://arxiv.org/abs/2509.21473)** · arXiv · VLM · Training-free · 💻[code](https://github.com/MAGICS-LAB/hallucination)
- **[ChartHal: A Fine-grained Framework Evaluating Hallucination of Large Vision Language Models in Chart Understanding](https://arxiv.org/abs/2509.17481)** · arXiv · VLM · Training-free · 💻[code](https://github.com/ymcui/ChartHal)
- **[Leveraging NTPs for Efficient Hallucination Detection in VLMs](https://arxiv.org/abs/2509.20379)** · arXiv · VLM · Training-free
- **[ORCA: An Agentic Reasoning Framework for Hallucination and Adversarial Robustness in Vision-Language Models](https://arxiv.org/abs/2509.15435)** · arXiv · VLM · Training-free · 💻[code](https://github.com/hundredrabbits/Orca)
...
- **[ELV-Halluc: Benchmarking Semantic Aggregation Hallucinations in Long Video Understanding](https://arxiv.org/abs/2508.21496)** · arXiv · VLM · Training-based · 💻[code](https://github.com/hlsv02/ELV-Halluc)
- **[Mitigating Hallucinations in Multimodal LLMs via Object-aware Preference Optimization](https://arxiv.org/abs/2508.20181)** · arXiv · VLM · Training-based · 💻[code](https://github.com/aimagelab/CHAIR-DPO)
- **[GLSim: Detecting Object Hallucinations in LVLMs via Global-Local Similarity](https://arxiv.org/abs/2508.19972)** · arXiv · VLM · Training-free · 💻[code](https://github.com/seongheon-96/glsim)
- **[Grounding the Ungrounded: A Spectral-Graph Framework for Quantifying Hallucinations in Multimodal LLMs](https://arxiv.org/abs/2508.19366)** · arXiv · VLM · Training-free · 💻[code](https://github.com/supratik-sarkar/preprints)
- **[Prompt-Response Semantic Divergence Metrics for Faithfulness Hallucination and Misalignment Detection in Large Language Models](https://arxiv.org/abs/2508.10192)** · arXiv · VLM · Training-free · 💻[code](https://github.com/chirindaopensource/llm_faithfulness_hallucination_misalignment_detection)
- **[Modality Bias in LVLMs: Analyzing and Mitigating Object Hallucination via Attention Lens](https://arxiv.org/abs/2508.02419)** · arXiv · VLM · Training-free · 💻[code](https://github.com/zhenghh8/TVAI)
- **[What Makes "Good" Distractors for Object Hallucination Evaluation in Large Vision-Language Models?](https://arxiv.org/abs/2508.06530)** · arXiv · VLM · Training-free · 💻[code](https://github.com/xiemk/HOPE)
- **[MAP: Mitigating Hallucinations in Large Vision-Language Models with Map-Level Attention Processing](https://arxiv.org/abs/2508.01653)** · arXiv · VLM · Training-free · 💻[code](https://github.com/TeamStuQ/skill-map)
...
- **📚 [A comprehensive taxonomy of hallucinations in Large Language Models](https://arxiv.org/abs/2508.01781)** · arXiv · VLM · Training-free
- **[Understanding Visual Detail Hallucinations of Large Vision-Language Models](https://doi.org/10.24963/ijcai.2025/212)** · IJCAI 2025 · VLM · Training-free · 💻[code](https://github.com/LANL-Bioinformatics/FaQCs)
- **[Hallucination-Aware Prompt Optimization for Text-to-Video Synthesis](https://doi.org/10.24963/ijcai.2025/1133)** · IJCAI 2025 · VLM · Training-based · 💻[code](https://github.com/LadnerLab/Library-Design)
- **[Hallucination Reduction in Video-Language Models via Hierarchical Multimodal Consistency](https://doi.org/10.24963/ijcai.2025/1019)** · IJCAI 2025 · VLM · Training-based · 💻[code](https://github.com/IPCC-WG1/Chapter-10_Fig19)
- **[TARS: MinMax Token-Adaptive Preference Strategy for MLLM Hallucination Reduction](https://arxiv.org/abs/2507.21584)** · arXiv · VLM · Training-based · 💻[code](https://github.com/bytedance/UI-TARS-desktop)
...
- **[Detecting Token-Level Hallucinations Using Variance Signals: A Reference-Free Approach](https://arxiv.org/abs/2507.04137)** · arXiv · VLM · Training-free
- **[Investigating VLM Hallucination from a Cognitive Psychology Perspective: A First Step Toward Interpretation with Intriguing Observations](https://arxiv.org/abs/2507.03123)** · arXiv · VLM · Training-free · 💻[code](https://github.com/liutaocode/TTS-arxiv-daily)
- **[Visual Evidence Prompting Mitigates Hallucinations in Large Vision-Language Models](https://doi.org/10.18653/v1/2025.acl-long.205)** · ACL 2025 · VLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[Visual Attention Never Fades: Selective Progressive Attention ReCalibration for Detailed Image Captioning in Multimodal Large Language Models](https://proceedings.mlr.press/v267/jung25c.html)** · ICML 2025 · VLM · Training-free · 💻[code](https://github.com/mingi000508/SPARC)
...
- **[VADE: Visual Attention Guided Hallucination Detection and Elimination](https://doi.org/10.18653/v1/2025.findings-acl.773)** · ACL 2025 · VLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[Toward Robust Hyper-Detailed Image Captioning: A Multiagent Approach and Dual Evaluation Metrics for Factuality and Coverage](https://proceedings.mlr.press/v267/lee25aj.html)** · ICML 2025 · VLM · Training-free · 💻[code](https://github.com/adobe-research/CapMAS)
...
- **[SECOND: Mitigating Perceptual Hallucination in Vision-Language Models via Selective and Contrastive Decoding](https://proceedings.mlr.press/v267/park25c.html)** · ICML 2025 · VLM · Training-free · 💻[code](https://github.com/mindverse/Second-Me)
- **[Retrieval Visual Contrastive Decoding to Mitigate Object Hallucinations in Large Vision-Language Models](https://doi.org/10.18653/v1/2025.findings-acl.430)** · ACL 2025 · VLM · Training-free · 💻[code](https://github.com/JiHoonLee9898/RVCD)
- **📋 [Reefknot: A Comprehensive Benchmark for Relation Hallucination Evaluation, Analysis and Mitigation in Multimodal Large Language Models](https://doi.org/10.18653/v1/2025.findings-acl.322)** · ACL 2025 · VLM · Training-free · 💻[code](https://github.com/JackChen-seu/Reefknot)
- **[Mixture of Decoding: An Attention-Inspired Adaptive Decoding Strategy to Mitigate Hallucinations in Large Vision-Language Models](https://doi.org/10.18653/v1/2025.findings-acl.448)** · ACL 2025 · VLM · Training-free · 💻[code](https://github.com/xlchen0205/MoD)
...
- **[Mitigating Object Hallucination in Large Vision-Language Models via Image-Grounded Guidance](https://proceedings.mlr.press/v267/zhao25j.html)** · ICML 2025 · VLM · Training-free · 💻[code](https://github.com/Linxi-ZHAO/MARINE)
- **[Mitigating Hallucination in Multimodal Large Language Model via Hallucination-targeted Direct Preference Optimization](https://doi.org/10.18653/v1/2025.findings-acl.850)** · ACL 2025 · VLM · Training-based · 💻[code](https://github.com/elpaco-escience/scikit-talk)
...
- **[MHALO: Evaluating MLLMs as Fine-grained Hallucination Detectors](https://doi.org/10.18653/v1/2025.findings-acl.478)** · ACL 2025 · VLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[Look Twice Before You Answer: Memory-Space Visual Retracing for Hallucination Mitigation in Multimodal Large Language Models](https://proceedings.mlr.press/v267/zou25e.html)** · ICML 2025 · VLM · Training-free · 💻[code](https://github.com/1zhou-Wang/MemVR)
...
- **[Insight Over Sight: Exploring the Vision-Knowledge Conflicts in Multimodal LLMs](https://doi.org/10.18653/v1/2025.acl-long.872)** · ACL 2025 · VLM · Training-free · 💻[code](https://github.com/xyliu-cs/ConflictVIS)
- **[Focus on What Matters: Enhancing Medical Vision-Language Models with Automatic Attention Alignment Tuning](https://doi.org/10.18653/v1/2025.acl-long.460)** · ACL 2025 · VLM · Training-based · 💻[code](https://github.com/Aofei-Chang/A3Tune)
- **[Don't Miss the Forest for the Trees: Attentional Vision Calibration for Large Vision Language Models](https://doi.org/10.18653/v1/2025.findings-acl.99)** · ACL 2025 · VLM · Training-free · 💻[code](https://github.com/sangminwoo/AvisC)
...
- **[Can Hallucination Correction Improve Video-Language Alignment?](https://doi.org/10.18653/v1/2025.findings-acl.1314)** · ACL 2025 · VLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[CLAIM: Mitigating Multilingual Object Hallucination in Large Vision-Language Models with Cross-Lingual Attention Intervention](https://doi.org/10.18653/v1/2025.acl-long.640)** · ACL 2025 · VLM · Training-free · 💻[code](https://github.com/BambooFury/Auto-Claim)
...
- **[Activation Steering Decoding: Mitigating Hallucination in Large Vision-Language Models through Bidirectional Hidden State Intervention](https://doi.org/10.18653/v1/2025.acl-long.634)** · ACL 2025 · VLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
...
- **[When Semantics Mislead Vision: Mitigating Large Multimodal Models Hallucinations in Scene Text Spotting and Understanding](https://arxiv.org/abs/2506.05551)** · arXiv · VLM · Training-free · 💻[code](https://github.com/shuyansy/MLLM-Semantic-Hallucination)
- **[VidHalluc: Evaluating Temporal Hallucinations in Multimodal Large Language Models for Video Understanding](https://openaccess.thecvf.com/content/CVPR2025/html/Li_VidHalluc_Evaluating_Temporal_Hallucinations_in_Multimodal_Large_Language_Models_for_CVPR_2025_paper.html)** · CVPR 2025 · VLM · Training-free · 💻[code](https://github.com/CyL97/VidHalluc)
- **[VASparse: Towards Efficient Visual Hallucination Mitigation via Visual-Aware Token Sparsification](https://openaccess.thecvf.com/content/CVPR2025/html/Zhuang_VASparse_Towards_Efficient_Visual_Hallucination_Mitigation_via_Visual-Aware_Token_Sparsification_CVPR_2025_paper.html)** · CVPR 2025 · VLM · Training-free · 💻[code](https://github.com/mengchuang123/VASparse-github)
...
- **📋 [PhD: A ChatGPT-Prompted Visual Hallucination Evaluation Dataset](https://openaccess.thecvf.com/content/CVPR2025/html/Liu_PhD_A_ChatGPT-Prompted_Visual_Hallucination_Evaluation_Dataset_CVPR_2025_paper.html)** · CVPR 2025 · VLM · Training-free · 💻[code](https://github.com/GoogleCloudPlatform/tensorflow-without-a-phd)
- **[Octopus: Alleviating Hallucination via Dynamic Contrastive Decoding](https://openaccess.thecvf.com/content/CVPR2025/html/Suo_Octopus_Alleviating_Hallucination_via_Dynamic_Contrastive_Decoding_CVPR_2025_paper.html)** · CVPR 2025 · VLM · Training-free · 💻[code](https://github.com/LijunZhang01/Octopus)
- **[ODE: Open-Set Evaluation of Hallucinations in Multimodal Large Language Models](https://openaccess.thecvf.com/content/CVPR2025/html/Tu_ODE_Open-Set_Evaluation_of_Hallucinations_in_Multimodal_Large_Language_Models_CVPR_2025_paper.html)** · CVPR 2025 · VLM · Training-free · 💻[code](https://github.com/msurtsukov/neural-ode)
- **[Nullu: Mitigating Object Hallucinations in Large Vision-Language Models via HalluSpace Projection](https://openaccess.thecvf.com/content/CVPR2025/html/Yang_Nullu_Mitigating_Object_Hallucinations_in_Large_Vision-Language_Models_via_HalluSpace_CVPR_2025_paper.html)** · CVPR 2025 · VLM · Training-free · 💻[code](https://github.com/Ziwei-Zheng/Nullu)
- **[Mitigating Object Hallucinations in Large Vision-Language Models with Assembly of Global and Local Attention](https://openaccess.thecvf.com/content/CVPR2025/html/An_Mitigating_Object_Hallucinations_in_Large_Vision-Language_Models_with_Assembly_of_CVPR_2025_paper.html)** · CVPR 2025 · VLM · Training-free · 💻[code](https://github.com/Lackel/AGLA)
- **[Mitigating Hallucinations in Multimodal Spatial Relations through Constraint-Aware Prompting](https://doi.org/10.18653/v1/2025.findings-naacl.192)** · NAACL 2025 · VLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[Mitigating Hallucinations in Multi-modal Large Language Models via Image Token Attention-Guided Decoding](https://doi.org/10.18653/v1/2025.naacl-long.75)** · NAACL 2025 · VLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[Mitigating Hallucinations in Large Vision-Language Models via Summary-Guided Decoding](https://doi.org/10.18653/v1/2025.findings-naacl.235)** · NAACL 2025 · VLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[Mitigating Hallucinations in Large Vision-Language Models via DPO: On-Policy Data Hold the Key](https://openaccess.thecvf.com/content/CVPR2025/html/Yang_Mitigating_Hallucinations_in_Large_Vision-Language_Models_via_DPO_On-Policy_Data_CVPR_2025_paper.html)** · CVPR 2025 · VLM · Training-based · 💻[code](https://github.com/zhyang2226/OPA-DPO)
- **[MASH-VLM: Mitigating Action-Scene Hallucination in Video-LLMs through Disentangled Spatial-Temporal Representations](https://openaccess.thecvf.com/content/CVPR2025/html/Bae_MASH-VLM_Mitigating_Action-Scene_Hallucination_in_Video-LLMs_through_Disentangled_Spatial-Temporal_Representations_CVPR_2025_paper.html)** · CVPR 2025 · VLM · Training-free · 💻[code](https://github.com/LGAI-Research/MASH-VLM)
- **[ICT: Image-Object Cross-Level Trusted Intervention for Mitigating Object Hallucination in Large Vision-Language Models](https://openaccess.thecvf.com/content/CVPR2025/html/Chen_ICT_Image-Object_Cross-Level_Trusted_Intervention_for_Mitigating_Object_Hallucination_in_CVPR_2025_paper.html)** · CVPR 2025 · VLM · Training-free · 💻[code](https://github.com/USC-ICT/ICT-FaceKit)
- **[IBD: Alleviating Hallucinations in Large Vision-Language Models via Image-Biased Decoding](https://openaccess.thecvf.com/content/CVPR2025W/TMM-OpenWorld/html/Zhu_IBD_Alleviating_Hallucinations_in_Large_Vision-Language_Models_via_Image-Biased_Decoding_CVPRW_2025_paper.html)** · CVPRW 2025 · VLM · Training-free · 💻[code](https://github.com/AstraZeneca/ibd-interpret)
- **[HalLoc: Token-level Localization of Hallucinations for Vision Language Models](https://openaccess.thecvf.com/content/CVPR2025/html/Park_HalLoc_Token-level_Localization_of_Hallucinations_for_Vision_Language_Models_CVPR_2025_paper.html)** · CVPR 2025 · VLM · Training-free · 💻[code](https://github.com/canonizer/halloc)
- **[Evaluating and Mitigating Object Hallucination in Large Vision-Language Models: Can They Still See Removed Objects?](https://doi.org/10.18653/v1/2025.naacl-long.349)** · NAACL 2025 · VLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[Devils in Middle Layers of Large Vision-Language Models: Interpreting, Detecting and Mitigating Object Hallucinations via Attention Lens](https://openaccess.thecvf.com/content/CVPR2025/html/Jiang_Devils_in_Middle_Layers_of_Large_Vision-Language_Models_Interpreting_Detecting_CVPR_2025_paper.html)** · CVPR 2025 · VLM · Training-free · 💻[code](https://github.com/ZhangqiJiang07/middle_layers_indicating_hallucinations)
- **[ClearSight: Visual Signal Enhancement for Object Hallucination Mitigation in Multimodal Large Language Models](https://openaccess.thecvf.com/content/CVPR2025/html/Yin_ClearSight_Visual_Signal_Enhancement_for_Object_Hallucination_Mitigation_in_Multimodal_CVPR_2025_paper.html)** · CVPR 2025 · VLM · Training-free · 💻[code](https://github.com/ustc-hyin/ClearSight)
- **[Black-Box Visual Prompt Engineering for Mitigating Object Hallucination in Large Vision Language Models](https://doi.org/10.18653/v1/2025.naacl-short.45)** · NAACL 2025 · VLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
...
- **[Causal-LLaVA: Causal Disentanglement for Mitigating Hallucination in Multimodal Large Language Models](https://arxiv.org/abs/2505.19474)** · arXiv · VLM · Training-free · 💻[code](https://github.com/IgniSavium/Causal-LLaVA)
...
- **[Critique Before Thinking: Mitigating Hallucination through Rationale-Augmented Instruction Tuning](https://arxiv.org/abs/2505.07172)** · arXiv · VLM · Training-based
...
- **[TARAC: Mitigating Hallucination in LVLMs via Temporal Attention Real-time Accumulative Connection](https://arxiv.org/abs/2504.04099)** · arXiv · VLM · Training-free · 💻[code](https://github.com/artemisYo/tarac)
- **[Visual Description Grounding Reduces Hallucinations and Boosts Reasoning in LVLMs](https://openreview.net/forum?id=3PRvlT8b1R)** · ICLR 2025 · VLM · Training-free · 💻[code](https://github.com/Sreyan88/VDGD)
- **[Understanding and Mitigating Hallucination in Large Vision-Language Models via Modular Attribution and Intervention](https://openreview.net/forum?id=Bjq4W7P2Us)** · ICLR 2025 · VLM · Training-free · 💻[code](https://github.com/TianyunYoung/Hallucination-Attribution)
- **[Self-Introspective Decoding: Alleviating Hallucinations for Large Vision-Language Models](https://openreview.net/forum?id=rsZwwjYHuD)** · ICLR 2025 · VLM · Training-based
- **[Self-Correcting Decoding with Generative Feedback for Mitigating Hallucinations in Large Vision-Language Models](https://openreview.net/forum?id=tTBXePRKSx)** · ICLR 2025 · VLM · Training-free · 💻[code](https://github.com/zhangce01/DeGF)
...
- **[Reducing Hallucinations in Vision-Language Models via Latent Space Steering](https://openreview.net/forum?id=LBl7Hez0fF)** · ICLR 2025 · VLM · Training-free · 💻[code](https://github.com/shengliu66/VTI)
...
- **[PerturboLLaVA: Reducing Multimodal Hallucinations with Perturbative Visual Training](https://openreview.net/forum?id=j4LITBSUjs)** · ICLR 2025 · VLM · Training-free · 💻[code](https://github.com/aim-uofa/PerturboLLaVA)
...
- **[Mitigating Modality Prior-Induced Hallucinations in Multimodal Large Language Models via Deciphering Attention Causality](https://openreview.net/forum?id=AV7OXVlAyi)** · ICLR 2025 · VLM · Training-free · 💻[code](https://github.com/The-Martyr/CausalMM)
...
- **[MLLMs Know Where to Look: Training-free Perception of Small Visual Details with Multimodal LLMs](https://openreview.net/forum?id=DgaY5mDdmT)** · ICLR 2025 · VLM · Training-free · 💻[code](https://github.com/saccharomycetes/mllms_know)
- **[MLLM can see? Dynamic Correction Decoding for Hallucination Mitigation](https://openreview.net/forum?id=4z3IguA4Zg)** · ICLR 2025 · VLM · Training-free · 💻[code](https://github.com/zjunlp/DeCo)
- **[Intervening Anchor Token: Decoding Strategy in Alleviating Hallucinations for MLLMs](https://openreview.net/forum?id=zGb4WgCW5i)** · ICLR 2025 · VLM · Training-free · 💻[code](https://github.com/Everlyn-Labs/ANTRP)
- **[Interpreting and Editing Vision-Language Representations to Mitigate Hallucinations](https://openreview.net/forum?id=94kQgWXojH)** · ICLR 2025 · VLM · Training-based · 💻[code](https://github.com/nickjiang2378/vlm-hallucinations)
...
- **[Do You Keep an Eye on What I Ask? Mitigating Multimodal Hallucination via Attention-Guided Ensemble Decoding](https://openreview.net/forum?id=ziw5bzg2NO)** · ICLR 2025 · VLM · Training-free · 💻[code](https://github.com/yjch00/ED)
- **[Damo: Decoding by Accumulating Activations Momentum for Mitigating Hallucinations in Vision-Language Models](https://openreview.net/forum?id=JUr0YOMvZA)** · ICLR 2025 · VLM · Training-free · 💻[code](https://github.com/AlibabaResearch/DAMO-ConvAI)
- **[UniVRSE: Unified Vision-conditioned Response Semantic Entropy for Hallucination Detection in Medical Vision-Language Models](https://arxiv.org/abs/2503.20504)** · arXiv · VLM · Training-free · 💻[code](https://github.com/libitx/univrse-js)
- **📋 [Exploring Hallucination of Large Multimodal Models in Video Understanding: Benchmark, Analysis and Mitigation](https://arxiv.org/abs/2503.19622)** · arXiv · VLM · Training-based · 💻[code](https://github.com/Hongcheng-Gao/HAVEN)
...
- **[TruthPrInt: Mitigating LVLM Object Hallucination Via Latent Truthful-Guided Pre-Intervention](https://arxiv.org/abs/2503.10602)** · arXiv · VLM · Training-free · 💻[code](https://github.com/jinhaoduan/TruthPrInt)
...
- **[Hallucinatory Image Tokens: A Training-free EAZY Approach on Detecting and Mitigating Object Hallucinations in LVLMs](https://arxiv.org/abs/2503.07772)** · arXiv · VLM · Training-free · 💻[code](https://github.com/Xuchen-Li/cv-arxiv-daily)
- **[TPC: Cross-Temporal Prediction Connection for Vision-Language Model Hallucination Reduction](https://arxiv.org/abs/2503.04457)** · arXiv · VLM · Training-free · 💻[code](https://github.com/EmmaRocheteau/TPC-LoS-prediction)
- **[MedHEval: Benchmarking Hallucinations and Mitigation Strategies in Medical Large Vision-Language Models](https://arxiv.org/abs/2503.02157)** · arXiv · VLM · Training-free · 💻[code](https://github.com/Aofei-Chang/MedHEval)
...
- **[The Role of Background Information in Reducing Object Hallucination in Vision-Language Models: Insights from Cutoff API Prompting](https://arxiv.org/abs/2502.15389)** · arXiv · VLM · Training-free · 💻[code](https://github.com/MTomita143/Bachelor-Thesis)
...
- **[SegSub: Evaluating Robustness to Knowledge Conflicts and Hallucinations in Vision-Language Models](https://arxiv.org/abs/2502.14908)** · arXiv · VLM · Training-free · 💻[code](https://github.com/CASOS-IDeaS-CMU/SegSub)
...
- **[Mitigating Object Hallucinations in Large Vision-Language Models via Attention Calibration](https://arxiv.org/abs/2502.01969)** · arXiv · VLM · Training-free · 💻[code](https://github.com/johnnyzyn/attention-calibration)
...
- **[MINT: Mitigating Hallucinations in Large Vision-Language Models via Token Reduction](https://arxiv.org/abs/2502.00717)** · arXiv · VLM · Training-free · 💻[code](https://github.com/mint-lang/mint)
- **[MoLE: Decoding by Mixture of Layer Experts Alleviates Hallucination in Large Vision-Language Models](https://doi.org/10.1609/aaai.v39i18.34056)** · AAAI 2025 · VLM · Training-free · 💻[code](https://github.com/tw93/Mole)
- **[Mitigating Hallucinations in Large Vision-Language Models by Adaptively Constraining Information Flow](https://doi.org/10.1609/aaai.v39i22.34512)** · AAAI 2025 · VLM · Training-free · 💻[code](https://github.com/jiaqi5598/AdaVIB)
- **📋 [MHBench: Demystifying Motion Hallucination in VideoLLMs](https://doi.org/10.1609/aaai.v39i4.32463)** · AAAI 2025 · VLM · Training-free · 💻[code](https://github.com/xzhouzeng/MHBench)
...
- **[Detecting and Mitigating Hallucination in Large Vision Language Models via Fine-Grained AI Feedback](https://doi.org/10.1609/aaai.v39i24.34744)** · AAAI 2025 · VLM · Training-based · 💻[code](https://github.com/Mr-Loevan/HSA-DPO)
- **[ConVis: Contrastive Decoding with Hallucination Visualization for Mitigating Hallucinations in Multimodal Large Language Models](https://doi.org/10.1609/aaai.v39i6.32689)** · AAAI 2025 · VLM · Training-free · 💻[code](https://github.com/yejipark-m/ConVis)
...
- **[Poison as Cure: Visual Noise for Mitigating Object Hallucinations in LVMs](https://arxiv.org/abs/2501.19164)** · arXiv · VLM · Training-free · 💻[code](https://github.com/KejiaZhang-Robust/VAP)
- **[Evaluating Hallucination in Large Vision-Language Models based on Context-Aware Object Similarities](https://arxiv.org/abs/2501.15046)** · arXiv · VLM · Training-free · 💻[code](https://github.com/Dhanasekar-S/Evaluating-Multimodal-Hallucinations)
- **📋 [Measuring and Mitigating Hallucinations in Vision-Language Dataset Generation for Remote Sensing](https://arxiv.org/abs/2501.14905)** · arXiv · VLM · Training-free
- **[PAINT: Paying Attention to INformed Tokens to Mitigate Hallucination in Large Vision-Language Model](https://arxiv.org/abs/2501.12206)** · arXiv · VLM · Training-free · 💻[code](https://github.com/hasanar1f/PAINT)
- **[Question-to-Question Retrieval for Hallucination-Free Knowledge Access: An Approach for Wikipedia and Wikidata Question Answering](https://arxiv.org/abs/2501.11301)** · arXiv · VLM · Training-free
...
- **[What&apos;s in Common? Multimodal Models Hallucinate When Reasoning Across Scenes](http://papers.nips.cc/paper_files/paper/2025/hash/3e5b0db387078ac4968fd536d3c3a019-Abstract-Datasets_and_Benchmarks_Track.html)** · Unlabeled · VLM · Training-free
- **[Seeing is Believing? Mitigating OCR Hallucinations in Multimodal Large Language Models](http://papers.nips.cc/paper_files/paper/2025/hash/6b628a3d7cb8055eb6fd2dd48c586347-Abstract-Conference.html)** · Unlabeled · VLM · Training-free
- **[RAR: Reversing Visual Attention Re-sinking for Unlocking Potential in Multimodal Large Language Models]()** · Unlabeled · VLM · Training-free · 💻[code](https://github.com/43081j/rar.js)
- **[Mitigating Hallucination for Large Vision Language Model by Inter-Modality Correlation Calibration Decoding]()** · Unlabeled · VLM · Training-free · 💻[code](https://github.com/lijm48/IMCCD)
- **📋 [MedHallTune: An Instruction-Tuning Benchmark for Mitigating Medical Hallucination in Vision-Language Models](https://doi.org/10.1109/tmi.2026.3719326)** · Other · VLM · Training-free · 💻[code](https://github.com/russellyq/MedHallTune)
- **[Generate, but Verify: Reducing Hallucination in Vision-Language Models with Retrospective Resampling](http://papers.nips.cc/paper_files/paper/2025/hash/5eff08bd064f0cdd92182cdf6fd06b99-Abstract-Conference.html)** · Unlabeled · VLM · Training-free · 💻[code](https://github.com/tsunghan-wu/reverse_vlm)
...
- **[Unified Triplet-Level Hallucination Evaluation for Large Vision-Language Models](https://openreview.net/forum?id=iNywrSPpvc)** · TMLR 2025 · VLM · Training-free · 💻[code](https://github.com/wujunjie1998/Tri-HE)
- **[Tackling Hallucination from Conditional Models for Medical Image Reconstruction with DynamicDPS](https://doi.org/10.1007/978-3-032-04965-0_56)** · MICCAI 2025 · VLM · Training-based · 💻[code](https://github.com/edshkim98/RFADMM)
- **[Synthetic Data in AI: Performance Gains versus Hallucination Risk](https://doi.org/10.47852/bonviewaia52026620)** · Artificial Intelligence and Applications 2025 · VLM · Training-free
...
- **📋 [ReSelfVerMM: mitigating hallucination in multimodal LLMs through dataset reconstruction and self-verification](https://doi.org/10.1117/12.3072360)** · Second International Conference on Image Processing and Artificial Intelligence (ICIPAI 2025) 2025 · VLM · Training-free
- **[Prescribing the Right Remedy: Mitigating Hallucinations in Large Vision-Language Models via Targeted Instruction Tuning](https://doi.org/10.1016/j.ins.2025.122361)** · Inf. Sci. 2025 · VLM · Training-based · 💻[code](https://github.com/isruihu/DFTG)
...
- **[Mirage in the Eyes: Hallucination Attack on Multi-modal Large Language Models with Only Attention Sink](https://www.usenix.org/conference/usenixsecurity25/presentation/wang-yining)** · USENIX Security Symposium 2025 · VLM · Training-free · 💻[code](https://github.com/thiyangt/elephants)
- **[MetaToken: Detecting Hallucination in Image Descriptions by Meta Classification](https://doi.org/10.5220/0013165700003912)** · VISIGRAPP (2) - VISAPP 2025 · VLM · Training-free · 💻[code](https://github.com/ConstellationCrypto/metatoken-contracts)
- **📋 [Hallucination-Aware Multimodal Benchmark for Gastrointestinal Image Analysis with Large Vision-Language Models](https://doi.org/10.1007/978-3-032-05127-1_23)** · MICCAI 2025 · VLM · Training-free · 💻[code](https://github.com/bhattarailab/Hallucination-Aware-VLM)
...
- **[DA-DPO: Cost-efficient Difficulty-aware Preference Optimization for Reducing MLLM Hallucinations](https://openreview.net/forum?id=M52CgPcgGx)** · TMLR 2025 · VLM · Training-based · 💻[code](https://github.com/Artanic30/DA-DPO)
...
- **[Beyond Logit Lens: Contextual Embeddings for Robust Hallucination Detection &amp; Grounding in VLMs](https://doi.org/10.18653/v1/2025.naacl-long.488)** · Comput. Linguistics 2025 · VLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
...
<details>
<summary>📅 2024 · 118 papers</summary>
...
- **[Seeing the Image: Prioritizing Visual Correlation by Contrastive Alignment](http://papers.nips.cc/paper_files/paper/2024/hash/37294f033582ac0064bf90fa557c2573-Abstract-Conference.html)** · NeurIPS 2024 · VLM · Training-free · 💻[code](https://github.com/foundation-multimodal-models/CAL)
- **[Multi-Object Hallucination in Vision Language Models](http://papers.nips.cc/paper_files/paper/2024/hash/4ea4a1ea4d9ff273688c8e92bd087112-Abstract-Conference.html)** · NeurIPS 2024 · VLM · Training-free · 💻[code](https://github.com/sled-group/moh)
- **[Mitigating Object Hallucination via Concentric Causal Attention](http://papers.nips.cc/paper_files/paper/2024/hash/a76ed4a8ef522c823d73925e7fff16d4-Abstract-Conference.html)** · NeurIPS 2024 · VLM · Training-free · 💻[code](https://github.com/xing0047/cca-llava)
- **[Hallo3D: Multi-Modal Hallucination Detection and Mitigation for Consistent 3D Content Generation](http://papers.nips.cc/paper_files/paper/2024/hash/d75660d6eb0ce31360c768fef85301dd-Abstract-Conference.html)** · NeurIPS 2024 · VLM · Training-free · 💻[code](https://github.com/wafer-bob/Hallo3D)
- **[CODE: Contrasting Self-generated Description to Combat Hallucination in Large Multi-modal Models](http://papers.nips.cc/paper_files/paper/2024/hash/f1592b0d4ab737e18bb1899484d28d96-Abstract-Conference.html)** · NeurIPS 2024 · VLM · Training-free · 💻[code](https://github.com/Dod-o/Statistical-Learning-Method_Code)
...
- **[VidHal: Benchmarking Temporal Hallucinations in Vision LLMs](https://arxiv.org/abs/2411.16771)** · arXiv · VLM · Training-free · 💻[code](https://github.com/Lookuz/VidHal)
- **[VaLiD: Mitigating the Hallucination of Large Vision Language Models by Visual Layer Fusion Contrastive Decoding](https://arxiv.org/abs/2411.15839)** · arXiv · VLM · Training-free · 💻[code](https://github.com/RicardoLuL/VaLiD_LVLMs_hallucinations)
- **[CATCH: Complementary Adaptive Token-level Contrastive Decoding to Mitigate Hallucinations in LVLMs](https://arxiv.org/abs/2411.12713)** · arXiv · VLM · Training-free · 💻[code](https://github.com/JaguarJack/catch-admin)
- **[VL-Uncertainty: Detecting Hallucination in Large Vision-Language Model via Uncertainty Estimation](https://arxiv.org/abs/2411.11919)** · arXiv · VLM · Training-free · 💻[code](https://github.com/Ruiyang-061X/VL-Uncertainty)
- **📋 [ViBe: A Text-to-Video Benchmark for Evaluating Hallucination in Large Multimodal Models](https://arxiv.org/abs/2411.10867)** · arXiv · VLM · Training-free · 💻[code](https://github.com/mkocabas/VIBE)
- **[Thinking Before Looking: Improving Multimodal LLM Reasoning via Mitigating Visual Hallucination](https://arxiv.org/abs/2411.12591)** · arXiv · VLM · Training-free · 💻[code](https://github.com/Terry-Xu-666/visual_inference_chain)
...
- **[What if...?: Thinking Counterfactual Keywords Helps to Mitigate Hallucination in Large Multi-modal Models](https://doi.org/10.18653/v1/2024.findings-emnlp.626)** · EMNLP 2024 · VLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[VGA: Vision GUI Assistant - Minimizing Hallucinations through Image-Centric Fine-Tuning](https://doi.org/10.18653/v1/2024.findings-emnlp.68)** · EMNLP 2024 · VLM · Training-free · 💻[code](https://github.com/Linziyang1999/VGA-visual-GUI-assistant)
- **[V-DPO: Mitigating Hallucination in Large Vision Language Models via Vision-Guided Direct Preference Optimization](https://doi.org/10.18653/v1/2024.findings-emnlp.775)** · EMNLP 2024 · VLM · Training-based · 💻[code](https://github.com/YuxiXie/V-DPOhttps)
- **[Reference-free Hallucination Detection for Large Vision-Language Models](https://doi.org/10.18653/v1/2024.findings-emnlp.262)** · EMNLP 2024 · VLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[Investigating and Mitigating Object Hallucinations in Pretrained Vision-Language (CLIP) Models](https://doi.org/10.18653/v1/2024.emnlp-main.1016)** · EMNLP 2024 · VLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[HELPD: Mitigating Hallucination of LVLMs by Hierarchical Feedback Learning with Vision-enhanced Penalty Decoding](https://doi.org/10.18653/v1/2024.emnlp-main.105)** · EMNLP 2024 · VLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[Game on Tree: Visual Hallucination Mitigation via Coarse-to-Fine View Tree and Game Theory](https://doi.org/10.18653/v1/2024.emnlp-main.998)** · EMNLP 2024 · VLM · Training-free · 💻[code](https://github.com/mengchuang123/GTHM)
- **[FaithScore: Fine-grained Evaluations of Hallucinations in Large Vision-Language Models](https://doi.org/10.18653/v1/2024.findings-emnlp.290)** · EMNLP 2024 · VLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[EFUF: Efficient Fine-Grained Unlearning Framework for Mitigating Hallucinations in Multimodal Large Language Models](https://doi.org/10.18653/v1/2024.emnlp-main.67)** · EMNLP 2024 · VLM · Training-based · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[Does Object Grounding Really Reduce Hallucination of Large Vision-Language Models?](https://doi.org/10.18653/v1/2024.emnlp-main.159)** · EMNLP 2024 · VLM · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[DAMRO: Dive into the Attention Mechanism of LVLM to Reduce Object Hallucination](https://doi.org/10.18653/v1/2024.emnlp-main.439)** · EMNLP 2024 · VLM · Training-free · 💻[code](https://github.com/coder-gx/DAMRO)
- **[AutoHallusion: Automatic Generation of Hallucination Benchmarks for Vision-Language Models](https://doi.org/10.18653/v1/2024.findings-emnlp.493)** · EMNLP 2024 · VLM · Training-free · 💻[code](https://github.com/wuxiyang1996/AutoHallusion)
- **[EF-LLM: Energy Forecasting LLM with AI-assisted Automation, Enhanced Sparse Prediction, Hallucination Detection](https://arxiv.org/abs/2411.00852)** · arXiv · VLM · Training-based · 💻[code](https://github.com/yinuotxie/Efficient-LLM-Inferencing-on-GPUs)
- **📚 [A Survey of Hallucination in Large Visual Language Models](https://arxiv.org/abs/2410.15359)** · arXiv · VLM · Training-free · 💻[code](https://github.com/rolandosegundo/tv2)
...
- **[Automatically Generating Visual Hallucination Test Cases for Multimodal Large Language Models](https://arxiv.org/abs/2410.11242)** · arXiv · VLM · Training-free · 💻[code](https://github.com/lycheeefish/VHExpansion)
- **[LongHalQA: Long-Context Hallucination Evaluation for MultiModal Large Language Models](https://arxiv.org/abs/2410.09962)** · arXiv · VLM · Training-free · 💻[code](https://github.com/hanqiu-hq/LongHalQA)
- **📋 [Collu-Bench: A Benchmark for Predicting Language Model Hallucinations in Code](https://arxiv.org/abs/2410.09997)** · arXiv · VLM · Training-free · 💻[code](https://github.com/PavlovaElina/collu-bench_pipeline)
- **[Unraveling Cross-Modality Knowledge Conflict in Large Vision-Language Models](https://arxiv.org/abs/2410.03659)** · arXiv · VLM · Training-free · 💻[code](https://github.com/luka-group/vlm-knowledge-conflict)
- **[Tackling Structural Hallucination in Image Translation with Local Diffusion](https://doi.org/10.1007/978-3-031-73004-7_6)** · ECCV 2024 · VLM · Training-free · 💻[code](https://github.com/edshkim98/LocalDiffusion-Hallucination)
- **[Reflective Instruction Tuning: Mitigating Hallucinations in Large Vision-Language Models](https://doi.org/10.1007/978-3-031-73113-6_12)** · ECCV 2024 · VLM · Training-based · 💻[code](https://github.com/zjr2000/REVERIE)
...
- **[Paying More Attention to Image: A Training-Free Method for Alleviating Hallucination in LVLMs](https://doi.org/10.1007/978-3-031-73010-8_8)** · ECCV 2024 · VLM · Training-free · 💻[code](https://github.com/LALBJ/PAI)
- **📋 [HaloQuest: A Visual Hallucination Dataset for Advancing Multimodal Reasoning](https://doi.org/10.1007/978-3-031-72980-5_17)** · ECCV 2024 · VLM · Training-free · 💻[code](https://github.com/ZhecanJamesWang/HaloQuest)
- **[Hallu-PI: Evaluating Hallucination in Multi-modal Large Language Models within Perturbed Inputs](https://doi.org/10.1145/3664647.3681251)** · ACM MM 2024 · VLM · Training-free · 💻[code](https://github.com/NJUNLP/Hallu-PI)
- **[Hal-Eval: A Universal and Fine-grained Hallucination Evaluation Framework for Large Vision Language Models](https://doi.org/10.1145/3664647.3680576)** · ACM MM 2024 · VLM · Training-free · 💻[code](https://github.com/WisdomShell/hal-eval)
...
- **[Contrastive Region Guidance: Improving Grounding in Vision-Language Models without Training](https://doi.org/10.1007/978-3-031-72986-7_12)** · ECCV 2024 · VLM · Training-free · 💻[code](https://github.com/meetdavidwan/crg)
...
- **[BEAF: Observing BEfore-AFter Changes to Evaluate Hallucination in Vision-Language Models](https://doi.org/10.1007/978-3-031-73247-8_14)** · ECCV 2024 · VLM · Training-free · 💻[code](https://github.com/kaist-ami/BEAF)
- **[AIGCs Confuse AI Too: Investigating and Explaining Synthetic Image-induced Hallucinations in Large Vision-Language Models](https://doi.org/10.1145/3664647.3681467)** · ACM MM 2024 · VLM · Training-free · 💻[code](https://github.com/LucusFigoGao/AIGCs_Confuse_AI_Too)
- **[EventHallusion: Diagnosing Event Hallucinations in Video LLMs](https://arxiv.org/abs/2409.16597)** · arXiv · VLM · Training-free · 💻[code](https://github.com/Stevetich/EventHallusion)
- **[Long-horizon Embodied Planning with Implicit Logical Inference and Hallucination Mitigation](https://arxiv.org/abs/2409.15658)** · arXiv · VLM · Training-free
- **[FIHA: Autonomous Hallucination Evaluation in Vision-Language Models with Davidson Scene Graphs](https://arxiv.org/abs/2409.13612)** · arXiv · VLM · Training-free · 💻[code](https://github.com/zeropaper/visual-fiha)
- **[Understanding Multimodal Hallucination with Parameter-Free Representation Alignment](https://arxiv.org/abs/2409.01151)** · arXiv · VLM · Training-free · 💻[code](https://github.com/yellow-binary-tree/Pfram)
...
- **[Piculet: Specialized Models-Guided Hallucination Decrease for MultiModal Large Language Models](https://arxiv.org/abs/2408.01003)** · arXiv · VLM · Training-free · 💻[code](https://github.com/UnicomAI/piculet)
- **[Interpreting and Mitigating Hallucination in MLLMs through Multi-agent Debate](https://arxiv.org/abs/2407.20505)** · arXiv · VLM · Training-free · 💻[code](https://github.com/mltooling/ci-test)
- **[VACoDe: Visual Augmented Contrastive Decoding](https://arxiv.org/abs/2408.05337)** · arXiv · VLM · Training-free · 💻[code](https://github.com/2022-rescue-macbook/VACode)
...
- **[MedVH: Towards Systematic Evaluation of Hallucination for Large Vision Language Models in the Medical Context](https://arxiv.org/abs/2407.02730)** · arXiv · VLM · Training-free · 💻[code](https://github.com/dongzizhu/MedVH)
- **[Visual Hallucinations of Multi-modal Large Language Models](https://doi.org/10.18653/v1/2024.findings-acl.573)** · ACL 2024 · VLM · Training-free · 💻[code](https://github.com/wenhuang2000/VHTest)
- **[Unified Hallucination Detection for Multimodal Large Language Models](https://doi.org/10.18653/v1/2024.acl-long.178)** · ACL 2024 · VLM · Training-free · 💻[code](https://github.com/zjunlp/NLPCC2024_RegulatingLLM)
- **[Mitigating Hallucinations in Large Vision-Language Models with Instruction Contrastive Decoding](https://doi.org/10.18653/v1/2024.findings-acl.937)** · ACL 2024 · VLM · Training-free · 💻[code](https://github.com/wangqiannudt/nerf-arxiv-daily)
- **[Mitigating Hallucinations in Large Vision-Language Models (LVLMs) via Language-Contrastive Decoding (LCD)](https://doi.org/10.18653/v1/2024.findings-acl.359)** · ACL 2024 · VLM · Training-free · 💻[code](https://github.com/avshalomman/lcd)
- **[Logical Closed Loop: Uncovering Object Hallucinations in Large Vision-Language Models](https://doi.org/10.18653/v1/2024.findings-acl.414)** · ACL 2024 · VLM · Training-free · 💻[code](https://github.com/CRIPAC-DIG/LogicCheckGPT)
- **[Less is More: Mitigating Multimodal Hallucination from an EOS Decision Perspective](https://doi.org/10.18653/v1/2024.acl-long.633)** · ACL 2024 · VLM · Training-based · 💻[code](https://github.com/yuezih/less-is-more)
- **[Investigating and Mitigating the Multimodal Hallucination Snowballing in Large Vision-Language Models](https://doi.org/10.18653/v1/2024.acl-long.648)** · ACL 2024 · VLM · Training-free · 💻[code](https://github.com/whongzhong/MMHalSnowball)
- **[HALC: Object Hallucination Reduction via Adaptive Focal-Contrast Decoding](https://proceedings.mlr.press/v235/chen24bi.html)** · ICML 2024 · VLM · Training-free · 💻[code](https://github.com/BillChan226/HALC)
- **[Evaluating and Analyzing Relationship Hallucinations in Large Vision-Language Models](https://proceedings.mlr.press/v235/wu24l.html)** · ICML 2024 · VLM · Training-free · 💻[code](https://github.com/mrwu-mac/R-Bench)
- **[VideoHallucer: Evaluating Intrinsic and Extrinsic Hallucinations in Large Video-Language Models](https://arxiv.org/abs/2406.16338)** · arXiv · VLM · Training-free · 💻[code](https://github.com/patrick-tssn/VideoHallucer)
- **[Measuring the Measurers: Quality Evaluation of Hallucination Benchmarks for Large Vision-Language Models](https://arxiv.org/abs/2406.17115)** · arXiv · VLM · Training-free · 💻[code](https://github.com/HQHBench/HQHBench)
...
- **[Hallucination Mitigation Prompts Long-term Video Understanding](https://arxiv.org/abs/2406.11333)** · arXiv · VLM · Training-free · 💻[code](https://github.com/lntzm/CVPR24Track-LongVideo)
- **[Detecting and Evaluating Medical Hallucinations in Large Vision Language Models](https://arxiv.org/abs/2406.10185)** · arXiv · VLM · Training-free · 💻[code](https://github.com/ydk122024/Med-HallMark)
- **[Volcano: Mitigating Multimodal Hallucination through Self-Feedback Guided Revision](https://doi.org/10.18653/v1/2024.naacl-long.23)** · NAACL 2024 · VLM · Training-free · 💻[code](https://github.com/kaistAI/Volcanogithub.com)
- **[Vista-llama: Reducing Hallucination in Video Language Models via Equal Distance to Visual Tokens](https://doi.org/10.1109/CVPR52733.2024.01249)** · CVPR 2024 · VLM · Training-free · 💻[code](https://github.com/JINXXIAN/Vista-LLaMA)
- **📋 [THRONE: An Object-Based Hallucination Benchmark for the Free-Form Generations of Large Vision-Language Models](https://doi.org/10.1109/CVPR52733.2024.02571)** · CVPR 2024 · VLM · Training-free · 💻[code](https://github.com/throneproj/Throne)
- **[OPERA: Alleviating Hallucination in Multi-Modal Large Language Models via Over-Trust Penalty and Retrospection-Allocation](https://doi.org/10.1109/CVPR52733.2024.01274)** · CVPR 2024 · VLM · Training-free · 💻[code](https://github.com/shikiw/OPERA)
...
- **[Mitigating Object Hallucinations in Large Vision-Language Models through Visual Contrastive Decoding](https://doi.org/10.1109/CVPR52733.2024.01316)** · CVPR 2024 · VLM · Training-free · 💻[code](https://github.com/DAMO-NLP-SG/VCD)
- **[Hallucination Augmented Contrastive Learning for Multimodal Large Language Model](https://doi.org/10.1109/CVPR52733.2024.02553)** · CVPR 2024 · VLM · Training-free · 💻[code](https://github.com/HACL-Codebase/HACL-Codebase)
- **[HalluciDoctor: Mitigating Hallucinatory Toxicity in Visual Instruction Data](https://doi.org/10.1109/CVPR52733.2024.01230)** · CVPR 2024 · VLM · Training-free · 💻[code](https://github.com/Yuqifan1117/HalluciDoctor)
- **[NoiseBoost: Alleviating Hallucination with Noise Perturbation for Multimodal Large Language Models](https://arxiv.org/abs/2405.20081)** · arXiv · VLM · Training-based · 💻[code](https://github.com/KaiWU5/NoiseBoost)
- **[RITUAL: Random Image Transformations as a Universal Anti-hallucination Lever in Large Vision Language Models](https://arxiv.org/abs/2405.17821)** · arXiv · VLM · Training-free · 💻[code](https://github.com/rust-qt/ritual)
...
- **📚 [Hallucination of Multimodal Large Language Models: A Survey](https://arxiv.org/abs/2404.18930)** · arXiv · VLM · Training-free · 💻[code](https://github.com/showlab/Awesome-MLLM-Hallucination)
- **[A robust and scalable framework for hallucination detection in virtual tissue staining and digital pathology](https://arxiv.org/abs/2404.18458)** · arXiv · VLM · Training-free
- **[Mitigating Hallucination in Large Multi-Modal Models via Robust Instruction Tuning](https://openreview.net/forum?id=J44HfH4JCg)** · ICLR 2024 · VLM · Training-based · 💻[code](https://github.com/FuxiaoLiu/LRV-Instruction)
- **[Analyzing and Mitigating Object Hallucination in Large Vision-Language Models](https://openreview.net/forum?id=oZDJKTlOUe)** · ICLR 2024 · VLM · Training-free · 💻[code](https://github.com/YiyangZhou/LURE)
...
- **[ESREAL: Exploiting Semantic Reconstruction to Mitigate Hallucinations in Vision-Language Models](https://arxiv.org/abs/2403.16167)** · arXiv · VLM · Training-based · 💻[code](https://github.com/kmy17518/ESREAL)
- **[Pensieve: Retrospect-then-Compare Mitigates Visual Hallucination](https://arxiv.org/abs/2403.14401)** · arXiv · VLM · Training-free · 💻[code](https://github.com/DingchenYang99/Pensieve)
...
- **📚 [A Survey on Hallucination in Large Vision-Language Models](https://arxiv.org/abs/2402.00253)** · arXiv · VLM · Training-free
- **[Mitigating Large Vision-Language Model Hallucination at Post-hoc via Multi-agent System](https://doi.org/10.1609/aaaiss.v4i1.31780)** · AAAI Fall Symposia 2024 · VLM · Training-free
...
- **[Delve into Visual Contrastive Decoding for Hallucination Mitigation of Large Vision-Language Models](https://doi.org/10.1007/978-3-032-31441-3_12)** · Other · VLM · Training-free · 💻[code](https://github.com/YiLunLee/VCD_Analysis)
...
- **[Mitigating Fine-Grained Hallucination by Fine-Tuning Large Vision-Language Models with Caption Rewrites](https://doi.org/10.1007/978-3-031-53302-0_3)** · MMM 2024 · VLM · Training-based · 💻[code](https://github.com/Anonymousanoy/FOHE)
- **[LLMs Can Check Their Own Results to Mitigate Hallucinations in Traffic Understanding Tasks](https://doi.org/10.1007/978-3-031-80889-0_8)** · ICTSS 2024 · VLM · Training-free
- **📋 [Hallucination Benchmark in Medical Visual Question Answering](https://openreview.net/forum?id=vxlXqOj4zv)** · Tiny Papers @ ICLR 2024 · VLM · Training-free
- **[Gemini Goes to Med School: Exploring the Capabilities of Multimodal Large Language Models on Medical Challenge Problems &amp; Hallucinations](https://doi.org/10.18653/v1/2024.clinicalnlp-1.3)** · 6th Clinical Natural Language Processing Workshop 2024 · VLM · Training-free · 💻[code](https://github.com/promptslab/RosettaEval)
- **[Gemini Goes to Med School: Exploring the Capabilities of Multimodal Large Language Models on Medical Challenge Problems & Hallucinations](https://doi.org/10.18653/v1/2024.clinicalnlp-1.3)** · ClinicalNLP@NAACL 2024 · VLM · Training-free · 💻[code](https://github.com/promptslab/RosettaEval)
- **[DENEB: A Hallucination-Robust Automatic Evaluation Metric for Image Captioning](https://doi.org/10.1007/978-981-96-0908-6_10)** · ACCV 2024 · VLM · Training-free · 💻[code](https://github.com/Ka2ukiMatsuda/DENEB)
- **[A Unified Hallucination Mitigation Framework for Large Vision-Language Models](https://openreview.net/forum?id=ZVDWzgk6L6)** · TMLR 2024 · VLM · Training-free · 💻[code](https://github.com/KeeganBarbee/VQA_Hist_Hallucination_Mitigation)
...
- **📋 [Negative Object Presence Evaluation (NOPE) to Measure Object Hallucination in Vision-Language Models](https://arxiv.org/abs/2310.05338)** · arXiv · VLM · Training-free
- **[HallE-Control: Controlling Object Hallucination in Large Multimodal Models](https://arxiv.org/abs/2310.01779)** · arXiv · VLM · Training-free · 💻[code](https://github.com/bronyayang/HallE_Control)
...
- **[Slower visual perception and alpha oscillation as a potential neural markers of visual hallucination in Parkinson’s Disease](https://doi.org/10.1167/jov.22.14.3867)** · Other · VLM · Training-free

</details>

<details>
<summary>📅 2021 · 1 papers</summary>

- **[HalentNet: Multimodal Trajectory Forecasting with Hallucinative Intents](https://openreview.net/forum?id=9GBZBPn0Jx)** · ICLR 2021 · VLM · Training-free · 💻[code](https://github.com/Vision-CAIR/HalentNet)
...
<details>
<summary>📅 2026 · 31 papers</summary>
...
- **📋 [HalluAudio: A Comprehensive Benchmark for Hallucination Detection in Large Audio-Language Models](https://aclanthology.org/2026.acl-long.1797/)** · ACL 2026 · MLLM(Omni) · Training-free · 💻[code](https://github.com/Feiyuzhao25/halluaudio)
- **[Detecting Hallucinations in SpeechLLMs at Inference Time Using Attention Maps](https://aclanthology.org/2026.findings-acl.2147/)** · ACL 2026 · MLLM(Omni) · Training-free
- **[AHA: Aligning Large Audio-Language Models for Reasoning Hallucinations via Counterfactual Hard Negatives](https://aclanthology.org/2026.findings-acl.1464/)** · ACL 2026 · MLLM(Omni) · Training-free · 💻[code](https://github.com/LLM-VLM-GSL/AHA)
- **📋 [HALAS: A Human-Annotated Dataset of Hallucinations of Modern ASR Systems](https://arxiv.org/abs/2606.23048)** · arXiv · MLLM(Omni) · Training-free · 💻[code](https://github.com/DSP-AGH/HALAS)
...
- **[Whisper Hallucination Detection and Mitigation via Hidden Representation Steering and Sparse AutoEncoders](https://arxiv.org/abs/2606.07473)** · arXiv · MLLM(Omni) · Training-free
- **[OmniHalluc-L: Counterfactual Benchmarking and Modality-Perturbation Reliability Calibration for Long-Form Omni Hallucination](https://arxiv.org/abs/2606.03614)** · arXiv · MLLM(Omni) · Training-free · 💻[code](https://github.com/ZexDong/omnihallucL-mprc)
- **[TriDF: Evaluating Perception, Detection, and Hallucination for Interpretable DeepFake Detection](https://openaccess.thecvf.com/content/CVPR2026/html/Jiang-Lin_TriDF_Evaluating_Perception_Detection_and_Hallucination_for_Interpretable_DeepFake_Detection_CVPR_2026_paper.html)** · CVPR 2026 · MLLM(Omni) · Training-free · 💻[code](https://github.com/j1anglin/TriDF)
- **[SVHalluc: Benchmarking Speech-Vision Hallucination in Audio-Visual Large Language Models](https://openaccess.thecvf.com/content/CVPR2026/html/Zhang_SVHalluc_Benchmarking_Speech-Vision_Hallucination_in_Audio-Visual_Large_Language_Models_CVPR_2026_paper.html)** · CVPR 2026 · MLLM(Omni) · Training-free · 💻[code](https://github.com/kaist-ami/SVHalluc)
- **[MoD-DPO: Towards Mitigating Cross-modal Hallucinations in Omni LLMs using Modality Decoupled Preference Optimization](https://openaccess.thecvf.com/content/CVPR2026/html/Chaubey_MoD-DPO_Towards_Mitigating_Cross-modal_Hallucinations_in_Omni_LLMs_using_Modality_CVPR_2026_paper.html)** · CVPR 2026 · MLLM(Omni) · Training-based · 💻[code](https://github.com/maroviher/DPO_RT5572_LinuxSTA_2.6.1.3_20121022_mod)
- **[MAD: Modality-Adaptive Decoding for Mitigating Cross-Modal Hallucinations in Multimodal Large Language Models](https://openaccess.thecvf.com/content/CVPR2026/html/Chung_MAD_Modality-Adaptive_Decoding_for_Mitigating_Cross-Modal_Hallucinations_in_Multimodal_Large_CVPR_2026_paper.html)** · CVPR 2026 · MLLM(Omni) · Training-free · 💻[code](https://github.com/top-yun/MAD)
- **[TIGER: Traceable Inference with Graph-Based Evidence Routing for Mitigating Hallucinations in Multimodal Generation](https://arxiv.org/abs/2606.00232)** · arXiv · MLLM(Omni) · Training-free · 💻[code](https://github.com/googlearchive/tiger)
- **[Score-Control for Hallucination Reduction in Diffusion Models](https://arxiv.org/abs/2606.00377)** · arXiv · MLLM(Omni) · Training-free · 💻[code](https://github.com/bhosalems/VSM)
- **[Mitigating Multimodal LLMs Hallucinations via Relevance Propagation at Inference Time](https://arxiv.org/abs/2605.01766)** · arXiv · MLLM(Omni) · Training-free · 💻[code](https://github.com/ItaiAllouche/lime)
- **[Noise-Aware In-Context Learning for Hallucination Mitigation in ALLMs](https://arxiv.org/abs/2604.09021)** · arXiv · MLLM(Omni) · Training-free
- **[From Hallucination to Articulation: Language Model-Driven Losses for Ultra Low-Bitrate Neural Speech Coding](https://doi.org/10.1109/icassp55912.2026.11462750)** · ICASSP 2026 · MLLM(Omni) · Training-free · 💻[code](https://github.com/stet-stet/lmloss-icassp2026)
...
- **[PASE: Leveraging the Phonological Prior of WavLM for Low-Hallucination Generative Speech Enhancement](https://doi.org/10.1609/aaai.v40i39.40562)** · AAAI 2026 · MLLM(Omni) · Training-based · 💻[code](https://github.com/santi-pdp/pase)
...
- **[Listen like a Teacher: Mitigating Whisper Hallucinations Using Adaptive Layer Attention and Knowledge Distillation](https://doi.org/10.1609/aaai.v40i39.40614)** · AAAI 2026 · MLLM(Omni) · Training-free
- **[EchoBat: Echo-Vision Enhancement and Echo-Layered Sampling for Video LLMs Hallucination Mitigation](https://doi.org/10.1609/aaai.v40i42.40875)** · AAAI 2026 · MLLM(Omni) · Training-based · 💻[code](https://github.com/Jemoctopus/echobat)

</details>

<details>
<summary>📅 2025 · 18 papers</summary>
...
- **[Eliminating stability hallucinations in llm-based tts models via attention guidance](https://arxiv.org/abs/2509.19852)** · arXiv · MLLM(Omni) · Training-free · 💻[code](https://github.com/iszhanjiawei/TTS_arxiv_daily)
...
- **[Calm-Whisper: Reduce Whisper Hallucination On Non-Speech By Calming Crazy Heads Down](https://doi.org/10.21437/Interspeech.2025-201)** · INTERSPEECH 2025 · MLLM(Omni) · Training-free · 💻[code](https://github.com/sanchit-gandhi/whisper-calm)
- **[Towards Hallucination-Free Music: A Reinforcement Learning Preference Optimization Framework for Reliable Song Generation](https://arxiv.org/abs/2508.05011)** · arXiv · MLLM(Omni) · Training-based
- **[Lost in Transcription, Found in Distribution Shift: Demystifying Hallucination in Speech Foundation Models](https://doi.org/10.18653/v1/2025.findings-acl.1190)** · ACL 2025 · MLLM(Omni) · Training-free · 💻[code](https://github.com/elpaco-escience/scikit-talk)
- **[AVCD: Mitigating Hallucinations in Audio-Visual Large Language Models through Contrastive Decoding](https://arxiv.org/abs/2505.20862)** · arXiv · MLLM(Omni) · Training-free · 💻[code](https://github.com/kaistmm/AVCD)
...
- **📋 [AVHBench: A Cross-Modal Hallucination Benchmark for Audio-Visual Large Language Models](https://openreview.net/forum?id=jTEKTdI3K9)** · ICLR 2025 · MLLM(Omni) · Training-free · 💻[code](https://github.com/kaist-ami/AVHBench)
- **[Reducing Object Hallucination in Large Audio-Language Models via Audio-Aware Decoding](https://doi.org/10.1109/ASRU65441.2025.11434595)** · ASRU 2025 · MLLM(Omni) · Training-free · 💻[code](https://github.com/GillbertHsu/Audio-Aware-Decoding)
- **[Fewer Hallucinations, More Verification: A Three-Stage LLM-Based Framework for ASR Error Correction](https://doi.org/10.1109/ASRU65441.2025.11434775)** · ASRU 2025 · MLLM(Omni) · Training-based · 💻[code](https://github.com/teamtee/LLM-ASR-Error-Correction)

</details>

<details>
<summary>📅 2024 · 7 papers</summary>
...
- **[Phoneme Hallucinator: One-Shot Voice Conversion via Set Expansion](https://doi.org/10.1609/aaai.v38i13.29411)** · AAAI 2024 · MLLM(Omni) · Training-free
...
<details>
<summary>📅 2023 · 1 papers</summary>

- **[Halluaudio: Hallucinate Frequency as Concepts For Few-Shot Audio Classification](https://doi.org/10.1109/ICASSP49357.2023.10095663)** · ICASSP 2023 · MLLM(Omni) · Training-free · 💻[code](https://github.com/Feiyuzhao25/halluaudio)
