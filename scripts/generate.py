...
def ccf_of(venue):
    """Resolve the CCF 2026 rating (A/B/C) for a venue string; '' if unrated."""
...
def write_readme(papers, stats, lang):
    ...
    L.append("</p>")
    L.append("")
    # Prominent "visit the website" call-to-action (centered badge button + callout).
    L.append("<p align='center'>")
    L.append("  <a href='https://guangtaolyu.github.io/awesome-hallucination-atlas/'>")
    L.append("    <img alt='Live Website' src='https://img.shields.io/static/v1?label=Live%20Website&message=Visit%20Now&color=8b7cf6&style=for-the-badge' />")
    L.append("  </a>")
    L.append("</p>")
    L.append("")
    ...
    L.append("")
    L.append("> " + _("CCF ratings follow the **CCF Recommended International Conference / Journal Directory (2026)** for officially published papers; "
                       "`Not in CCF` covers arXiv preprints, unresolved venues, and venues outside the CCF list.",
                      "依据 **CCF 推荐国际学术会议 / 期刊目录（2026）** 对正式发表的论文标注评级；"
...
@article{lyu2026hallu_pade,
  ...
  year={2026}
    ...
    L.append(_("A record of how this atlas has grown in the community:",
               "本图谱在社区中的增长记录："))
    L.append("")
    L.append('<a href="https://www.star-history.com/?repos=GuangtaoLyu%2Fawesome-hallucination-atlas&type=date&legend=top-left">')
    L.append('  <picture>')
    L.append('    <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/chart?repos=GuangtaoLyu/awesome-hallucination-atlas&type=date&theme=dark&legend=top-left&sealed_token=es4O-8rwqglOmnZDjxaqaRD-Ucj7DRdPVwK8M-Q3DFyjCaJd_lqSECa1wcEFD6xTtJsuU_wc8vS4IOM8cc10PMTV8r_I5CX3j1zoaifBJhbYcwconoGqMT8wSFdOhwLGQIejqcG7fAUtXusYAEmAxTBQgdMFqU1CchsMrhaPgcwbPq4vSpaaDMALHIKg" />')
    L.append('    <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/chart?repos=GuangtaoLyu/awesome-hallucination-atlas&type=date&legend=top-left&sealed_token=es4O-8rwqglOmnZDjxaqaRD-Ucj7DRdPVwK8M-Q3DFyjCaJd_lqSECa1wcEFD6xTtJsuU_wc8vS4IOM8cc10PMTV8r_I5CX3j1zoaifBJhbYcwconoGqMT8wSFdOhwLGQIejqcG7fAUtXusYAEmAxTBQgdMFqU1CchsMrhaPgcwbPq4vSpaaDMALHIKg" />')
    L.append('    <img alt="Star History Chart" src="https://api.star-history.com/chart?repos=GuangtaoLyu/awesome-hallucination-atlas&type=date&legend=top-left&sealed_token=es4O-8rwqglOmnZDjxaqaRD-Ucj7DRdPVwK8M-Q3DFyjCaJd_lqSECa1wcEFD6xTtJsuU_wc8vS4IOM8cc10PMTV8r_I5CX3j1zoaifBJhbYcwconoGqMT8wSFdOhwLGQIejqcG7fAUtXusYAEmAxTBQgdMFqU1CchsMrhaPgcwbPq4vSpaaDMALHIKg" />')
    L.append('  </picture>')
    L.append('</a>')
    L.append("")
